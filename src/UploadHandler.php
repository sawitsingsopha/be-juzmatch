...
class UploadHandler
{
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        ...
        // https://storage.googleapis.com/juzmatch_1/
    ...
    protected function get_file_objects($iteration_method = 'get_file_object') {
        $upload_dir = $this->get_upload_path();
        // $upload_dir = "https://storage.googleapis.com/juzmatch_1/";
        if (!is_dir($upload_dir)) {
            return array();
        }
        return array_values(
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,$index = null, $content_range = null) {
        ...
        // exists: true
        // extension: "png"
        // name: "___layer002.png"
        // size: 206388
        // thumbnailUrl: "/juzmatch-backend/api/jupload?rnd=54036014&csrf_name=csrf61604b37ad176&csrf_value=3506dded0910b66065c1844bec190262&id=x_image&table=article_banner&session=RWPVrzxH1pbngZKEERY_WENJXVe84137uEegXEu6p2E.&x_image=___layer002.png&version=thumbnail&download=1"
        // type: "image/png"
        // url: "/juzmatch-backend/api/jupload?rnd=54036014&csrf_name=csrf61604b37ad176&csrf_value=3506dded0910b66065c1844bec190262&id=x_image&table=article_banner&session=RWPVrzxH1pbngZKEERY_WENJXVe84137uEegXEu6p2E.&x_image=___layer002.png&download=1"



        // deleteType: "POST"
        // deleteUrl: "https://storage.googleapis.com/juzmatch_1/cicle-pic.png&_method=DELETE"
        // error: "Failed to resize image (original, thumbnail)"
        // exists: true
        // extension: "png"
        // name: "https://storage.googleapis.com/juzmatch_1/cicle-pic.png"
        // size: 2481
        // thumbnailUrl: "https://storage.googleapis.com/juzmatch_1/cicle-pic.png&version=thumbnail&download=1"
        // type: "image/png"
        // url: "https://storage.googleapis.com/juzmatch_1/cicle-pic.png&download=1"
    ...
    public function get($print_response = true) {
        ...
        // /juzmatch-backend/api/jupload?
        // rnd=57227451&
        // csrf_name=csrf616079aff1c85&
        // csrf_value=f9be3fde85138b2a23a3943e247173a3&
        // id=x_image
        // &table=article_banner&
        // session=RWPVrzxH1pbngZKEERY_WENJXVe84137uEegXEu6p2E.
        // &x_image=card-img-buyerVisitProp.png&download=1
        ...
        //             [0] => stdClass Object
        //                 (
        //                     [name] => card-img-buyerVisitProp.png
        //                     [size] => 386
        //                     [url] => /juzmatch-backend/api/jupload?rnd=57227451&csrf_name=csrf616079aff1c85&csrf_value=f9be3fde85138b2a23a3943e247173a3&id=x_image&table=article_banner&session=RWPVrzxH1pbngZKEERY_WENJXVe84137uEegXEu6p2E.&x_image=card-img-buyerVisitProp.png&download=1
        //                     [deleteUrl] => /juzmatch-backend/api/jupload?rnd=57227451&csrf_name=csrf616079aff1c85&csrf_value=f9be3fde85138b2a23a3943e247173a3&id=x_image&table=article_banner&session=RWPVrzxH1pbngZKEERY_WENJXVe84137uEegXEu6p2E.&x_image=card-img-buyerVisitProp.png&_method=DELETE
        //                     [deleteType] => POST
        //                     [extension] => png
        //                     [exists] => 
        //                 )
