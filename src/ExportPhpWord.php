...
class ExportPhpWord extends ExportBase
{
    ...
    public function __construct(&$tbl, $style = "")
    {
        ...
        $this->PhpWord->getCompatibility()->setOoxmlVersion($tbl->ExportWordVersion);
        $this->Section = $this->PhpWord->createSection(["PaperSize" => $tbl->ExportWordPageSize, "orientation" => $tbl->ExportWordPageOrientation]); // Note: Set paper size first
