...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'C0gUnrGviKCYNxq1', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/juzmatch.css", // Project stylesheet file name
    "USE_COMPRESSED_STYLESHEET" => false, // Compressed stylesheet
    ...
    "BODY_CLASS" => "hold-transition layout-navbar-fixed",
    ...
    "SESSION_TIMEOUT" => 120, // Session timeout time (minutes)
    ...
    "PUSH_SERVER_PUBLIC_KEY" => "BO8nOPUcQdN9x6gAFqVk2LHLXxwoizM0uR6nACJEDiqN9L5B3uluPtu9MW6oOIXSsO02-8YQz0UnC-pDXN1TuMw", // Public Key
    "PUSH_SERVER_PRIVATE_KEY" => "GlHa5g6hm0SnjTcyyIpN-irvuC4F41G1jxfBuSWNjag", // Private Key
    // Subscription table for Push Notification
    "SUBSCRIPTION_DBID" => "DB", // Subscription DBID
    "SUBSCRIPTION_TABLE" => "`subdistrict`", // Subscription table
    "SUBSCRIPTION_TABLE_NAME" => "subdistrict", // Subscription table name
    "SUBSCRIPTION_TABLE_VAR" => "subdistrict", // Subscription table var
    "SUBSCRIPTION_FIELD_NAME_ID" => "", // Subscription Id field name
    "SUBSCRIPTION_FIELD_NAME_USER" => "", // Subscription User field name
    "SUBSCRIPTION_FIELD_NAME_ENDPOINT" => "", // Subscription Endpoint field name
    "SUBSCRIPTION_FIELD_NAME_PUBLIC_KEY" => "", // Subscription Public Key field name
    "SUBSCRIPTION_FIELD_NAME_AUTH_TOKEN" => "", // Subscription Auth Token field name
    "SUBSCRIPTION_FIELD_NAME_CONTENT_ENCODING" => "", // Subscription Content Encoding field name

    // Security
    "CSRF_PREFIX" => "csrf",
    "ENCRYPTION_ENABLED" => false, // Encryption enabled
    "ADMIN_USER_NAME" => "admin", // Administrator user name
    "ADMIN_PASSWORD" => "admin@2021", // Administrator password
    ...
    "USER_TABLE_DBID" => "DB",
    "USER_TABLE" => "`users`",
    "USER_NAME_FILTER" => "(`user_name` = '%u')",
    "USER_ID_FILTER" => "(`users_id` = %u)",
    ...
    "USER_PROFILE_RETRY_LOCKOUT" => 120,
    ...
    // Email
    "SENDER_EMAIL" => "sawit204@gmail.com", // Sender email address
    "RECIPIENT_EMAIL" => "sawit204@gmail.com", // Recipient email address
    ...
    */
    ...
    "AUTO_HIDE_PAGE_SIZE_SELECTOR" => true,
...
$CaptchaClass = "ReCaptcha"; // Override default CAPTCHA class
