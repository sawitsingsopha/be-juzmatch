...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "18.7.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "juzmatch"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{92B999EB-369F-4874-8848-2BC343EBF36E}"); // Project ID
