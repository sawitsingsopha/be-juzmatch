...
loadjs.ready(["wrapper", "head"], function () {
    ...
    fdoc_juzmatch1add.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
<span id="el_doc_juzmatch1_status">
    <select
        ...
        data-select2-id="fdoc_juzmatch1add_x_status"
        data-table="doc_juzmatch1"
        data-field="x_status"
...
<script>
loadjs.ready("fdoc_juzmatch1add", function() {
    var options = { name: "x_status", selectId: "fdoc_juzmatch1add_x_status" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fdoc_juzmatch1add.lists.status.lookupOptions.length) {
        options.data = { id: "x_status", form: "fdoc_juzmatch1add" };
    } else {
        options.ajax = { id: "x_status", form: "fdoc_juzmatch1add", limit: ew.LOOKUP_PAGE_SIZE };
    }
