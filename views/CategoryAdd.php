...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fcategoryadd = new ew.Form("fcategoryadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fcategoryadd;
    ...
    fcategoryadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fcategoryadd.lists.isactive = <?= $Page->isactive->toClientList($Page) ?>;
