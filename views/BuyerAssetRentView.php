...
var fbuyer_asset_rentview;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fbuyer_asset_rentview = new ew.Form("fbuyer_asset_rentview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fbuyer_asset_rentview;
    loadjs.done("fbuyer_asset_rentview");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fbuyer_asset_rentview" id="fbuyer_asset_rentview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->asset_id->Visible) { // asset_id ?>
    <tr id="r_asset_id"<?= $Page->asset_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_asset_id"><?= $Page->asset_id->caption() ?></span></td>
...
<?php if ($Page->member_id->Visible) { // member_id ?>
    <tr id="r_member_id"<?= $Page->member_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_member_id"><?= $Page->member_id->caption() ?></span></td>
...
<?php if ($Page->one_time_status->Visible) { // one_time_status ?>
    <tr id="r_one_time_status"<?= $Page->one_time_status->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_one_time_status"><?= $Page->one_time_status->caption() ?></span></td>
...
<?php if ($Page->half_price_1->Visible) { // half_price_1 ?>
    <tr id="r_half_price_1"<?= $Page->half_price_1->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_half_price_1"><?= $Page->half_price_1->caption() ?></span></td>
...
<?php if ($Page->status_pay_half_price_1->Visible) { // status_pay_half_price_1 ?>
    <tr id="r_status_pay_half_price_1"<?= $Page->status_pay_half_price_1->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_status_pay_half_price_1"><?= $Page->status_pay_half_price_1->caption() ?></span></td>
...
<?php if ($Page->pay_number_half_price_1->Visible) { // pay_number_half_price_1 ?>
    <tr id="r_pay_number_half_price_1"<?= $Page->pay_number_half_price_1->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_pay_number_half_price_1"><?= $Page->pay_number_half_price_1->caption() ?></span></td>
...
<?php if ($Page->date_pay_half_price_1->Visible) { // date_pay_half_price_1 ?>
    <tr id="r_date_pay_half_price_1"<?= $Page->date_pay_half_price_1->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_date_pay_half_price_1"><?= $Page->date_pay_half_price_1->caption() ?></span></td>
...
<?php if ($Page->due_date_pay_half_price_1->Visible) { // due_date_pay_half_price_1 ?>
    <tr id="r_due_date_pay_half_price_1"<?= $Page->due_date_pay_half_price_1->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_due_date_pay_half_price_1"><?= $Page->due_date_pay_half_price_1->caption() ?></span></td>
...
<?php if ($Page->half_price_2->Visible) { // half_price_2 ?>
    <tr id="r_half_price_2"<?= $Page->half_price_2->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_half_price_2"><?= $Page->half_price_2->caption() ?></span></td>
...
<?php if ($Page->status_pay_half_price_2->Visible) { // status_pay_half_price_2 ?>
    <tr id="r_status_pay_half_price_2"<?= $Page->status_pay_half_price_2->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_status_pay_half_price_2"><?= $Page->status_pay_half_price_2->caption() ?></span></td>
...
<?php if ($Page->pay_number_half_price_2->Visible) { // pay_number_half_price_2 ?>
    <tr id="r_pay_number_half_price_2"<?= $Page->pay_number_half_price_2->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_pay_number_half_price_2"><?= $Page->pay_number_half_price_2->caption() ?></span></td>
...
<?php if ($Page->date_pay_half_price_2->Visible) { // date_pay_half_price_2 ?>
    <tr id="r_date_pay_half_price_2"<?= $Page->date_pay_half_price_2->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_date_pay_half_price_2"><?= $Page->date_pay_half_price_2->caption() ?></span></td>
...
<?php if ($Page->due_date_pay_half_price_2->Visible) { // due_date_pay_half_price_2 ?>
    <tr id="r_due_date_pay_half_price_2"<?= $Page->due_date_pay_half_price_2->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_due_date_pay_half_price_2"><?= $Page->due_date_pay_half_price_2->caption() ?></span></td>
...
<?php if ($Page->cdate->Visible) { // cdate ?>
    <tr id="r_cdate"<?= $Page->cdate->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_buyer_asset_rent_cdate"><?= $Page->cdate->caption() ?></span></td>
        <td data-name="cdate"<?= $Page->cdate->cellAttributes() ?>>
<span id="el_buyer_asset_rent_cdate">
