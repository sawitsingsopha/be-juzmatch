...
// Page object
$SaveLogSearchNonmemberAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { save_log_search_nonmember: currentTable } });
var currentForm, currentPageID;
var fsave_log_search_nonmemberadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fsave_log_search_nonmemberadd = new ew.Form("fsave_log_search_nonmemberadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fsave_log_search_nonmemberadd;

    // Add fields
    var fields = currentTable.fields;
    fsave_log_search_nonmemberadd.addFields([
    ...
    // Form_CustomValidate
    fsave_log_search_nonmemberadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fsave_log_search_nonmemberadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fsave_log_search_nonmemberadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fsave_log_search_nonmemberadd" id="fsave_log_search_nonmemberadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fsave_log_search_nonmemberadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsave_log_search_nonmemberadd", "x_cdate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
