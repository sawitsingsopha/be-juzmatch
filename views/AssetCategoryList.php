...
var fasset_categorylist;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fasset_categorylist = new ew.Form("fasset_categorylist", "list");
    currentPageID = ew.PAGE_ID = "list";
    currentForm = fasset_categorylist;
    fasset_categorylist.formKeyCountName = "<?= $Page->FormKeyCountName ?>";
    loadjs.done("fasset_categorylist");
});
</script>
<script>
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> asset_category">
<form name="fasset_categorylist" id="fasset_categorylist" class="ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<table id="tbl_asset_categorylist" class="table table-bordered table-hover table-sm ew-table"><!-- .ew-table -->
<thead>
...
<?php if ($Page->category_id->Visible) { // category_id ?>
        <th data-name="category_id" class="<?= $Page->category_id->headerCellClass() ?>"><div id="elh_asset_category_category_id" class="asset_category_category_id"><?= $Page->renderFieldHeader($Page->category_id) ?></div></th>
<?php } ?>
<?php
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge([
            ...
            "id" => "r" . $Page->RowCount . "_asset_category",
