...
var fpeak_receiptadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpeak_receiptadd = new ew.Form("fpeak_receiptadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fpeak_receiptadd;

    // Add fields
    var fields = currentTable.fields;
    fpeak_receiptadd.addFields([
    ...
    // Form_CustomValidate
    fpeak_receiptadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpeak_receiptadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fpeak_receiptadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fpeak_receiptadd" id="fpeak_receiptadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpeak_receiptadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_receiptadd", "x_create_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpeak_receiptadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_receiptadd", "x_request_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpeak_receiptadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_receiptadd", "x_issueddate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpeak_receiptadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_receiptadd", "x_duedate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpeak_receiptadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_receiptadd", "x_paymentdate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
