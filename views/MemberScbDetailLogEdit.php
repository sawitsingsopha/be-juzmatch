...
// Page object
$MemberScbDetailLogEdit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { member_scb_detail_log: currentTable } });
var currentForm, currentPageID;
var fmember_scb_detail_logedit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmember_scb_detail_logedit = new ew.Form("fmember_scb_detail_logedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fmember_scb_detail_logedit;

    // Add fields
    var fields = currentTable.fields;
    fmember_scb_detail_logedit.addFields([
        ["member_scb_detail_log_id", [fields.member_scb_detail_log_id.visible && fields.member_scb_detail_log_id.required ? ew.Validators.required(fields.member_scb_detail_log_id.caption) : null], fields.member_scb_detail_log_id.isInvalid],
    ...
    // Form_CustomValidate
    fmember_scb_detail_logedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmember_scb_detail_logedit.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fmember_scb_detail_logedit");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fmember_scb_detail_logedit" id="fmember_scb_detail_logedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->member_scb_detail_log_id->Visible) { // member_scb_detail_log_id ?>
    <div id="r_member_scb_detail_log_id"<?= $Page->member_scb_detail_log_id->rowAttributes() ?>>
        <label id="elh_member_scb_detail_log_member_scb_detail_log_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->member_scb_detail_log_id->caption() ?><?= $Page->member_scb_detail_log_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->member_scb_detail_log_id->cellAttributes() ?>>
<span id="el_member_scb_detail_log_member_scb_detail_log_id">
<span<?= $Page->member_scb_detail_log_id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->member_scb_detail_log_id->getDisplayValue($Page->member_scb_detail_log_id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="member_scb_detail_log" data-field="x_member_scb_detail_log_id" data-hidden="1" name="x_member_scb_detail_log_id" id="x_member_scb_detail_log_id" value="<?= HtmlEncode($Page->member_scb_detail_log_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fmember_scb_detail_logedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmember_scb_detail_logedit", "x_pay_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fmember_scb_detail_logedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmember_scb_detail_logedit", "x_cdate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
