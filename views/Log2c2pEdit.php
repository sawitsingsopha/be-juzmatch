...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    flog_2c2pedit = new ew.Form("flog_2c2pedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = flog_2c2pedit;

    // Add fields
    var fields = currentTable.fields;
    flog_2c2pedit.addFields([
        ["log_2c2p_id", [fields.log_2c2p_id.visible && fields.log_2c2p_id.required ? ew.Validators.required(fields.log_2c2p_id.caption) : null], fields.log_2c2p_id.isInvalid],
    ...
    // Form_CustomValidate
    flog_2c2pedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flog_2c2pedit.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("flog_2c2pedit");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="flog_2c2pedit" id="flog_2c2pedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->log_2c2p_id->Visible) { // log_2c2p_id ?>
    <div id="r_log_2c2p_id"<?= $Page->log_2c2p_id->rowAttributes() ?>>
        <label id="elh_log_2c2p_log_2c2p_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->log_2c2p_id->caption() ?><?= $Page->log_2c2p_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->log_2c2p_id->cellAttributes() ?>>
<span id="el_log_2c2p_log_2c2p_id">
<span<?= $Page->log_2c2p_id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->log_2c2p_id->getDisplayValue($Page->log_2c2p_id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="log_2c2p" data-field="x_log_2c2p_id" data-hidden="1" name="x_log_2c2p_id" id="x_log_2c2p_id" value="<?= HtmlEncode($Page->log_2c2p_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["flog_2c2pedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_2c2pedit", "x_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
