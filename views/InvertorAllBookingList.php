...
var finvertor_all_bookinglist;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    finvertor_all_bookinglist = new ew.Form("finvertor_all_bookinglist", "list");
    currentPageID = ew.PAGE_ID = "list";
    currentForm = finvertor_all_bookinglist;
    finvertor_all_bookinglist.formKeyCountName = "<?= $Page->FormKeyCountName ?>";
    loadjs.done("finvertor_all_bookinglist");
});
var finvertor_all_bookingsrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object for search
    finvertor_all_bookingsrch = new ew.Form("finvertor_all_bookingsrch", "list");
    currentSearchForm = finvertor_all_bookingsrch;

    // Add fields
    var fields = currentTable.fields;
    finvertor_all_bookingsrch.addFields([
    ...
    // Validate form
    finvertor_all_bookingsrch.validate = function () {
    ...
    // Form_CustomValidate
    finvertor_all_bookingsrch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    finvertor_all_bookingsrch.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    finvertor_all_bookingsrch.lists.asset_id = <?= $Page->asset_id->toClientList($Page) ?>;
    finvertor_all_bookingsrch.lists.member_id = <?= $Page->member_id->toClientList($Page) ?>;
    finvertor_all_bookingsrch.lists.status_expire = <?= $Page->status_expire->toClientList($Page) ?>;
    finvertor_all_bookingsrch.lists.payment_status = <?= $Page->payment_status->toClientList($Page) ?>;

    // Filters
    finvertor_all_bookingsrch.filterList = <?= $Page->getFilterList() ?>;
    loadjs.done("finvertor_all_bookingsrch");
});
</script>
<script>
...
<form name="finvertor_all_bookingsrch" id="finvertor_all_bookingsrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
<div id="finvertor_all_bookingsrch_search_panel" class="mb-2 mb-sm-0 <?= $Page->SearchPanelClass ?>"><!-- .ew-search-panel -->
...
<input type="hidden" name="z_asset_id" id="z_asset_id" value="=">
        ...
        <div id="el_invertor_all_booking_asset_id" class="ew-search-field">
    <select
        id="x_asset_id"
        name="x_asset_id"
        class="form-select ew-select<?= $Page->asset_id->isInvalidClass() ?>"
        data-select2-id="finvertor_all_bookingsrch_x_asset_id"
...
<script>
loadjs.ready("finvertor_all_bookingsrch", function() {
    var options = { name: "x_asset_id", selectId: "finvertor_all_bookingsrch_x_asset_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (finvertor_all_bookingsrch.lists.asset_id.lookupOptions.length) {
        options.data = { id: "x_asset_id", form: "finvertor_all_bookingsrch" };
    } else {
        options.ajax = { id: "x_asset_id", form: "finvertor_all_bookingsrch", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
    options = Object.assign({}, ew.selectOptions, options, ew.vars.tables.invertor_all_booking.fields.asset_id.selectOptions);
...
<input type="hidden" name="z_member_id" id="z_member_id" value="=">
        ...
        <div id="el_invertor_all_booking_member_id" class="ew-search-field">
    <select
        id="x_member_id"
        name="x_member_id"
        class="form-control ew-select<?= $Page->member_id->isInvalidClass() ?>"
        data-select2-id="finvertor_all_bookingsrch_x_member_id"
        data-table="invertor_all_booking"
...
<script>
loadjs.ready("finvertor_all_bookingsrch", function() {
    var options = { name: "x_member_id", selectId: "finvertor_all_bookingsrch_x_member_id" };
    if (finvertor_all_bookingsrch.lists.member_id.lookupOptions.length) {
        options.data = { id: "x_member_id", form: "finvertor_all_bookingsrch" };
    } else {
        options.ajax = { id: "x_member_id", form: "finvertor_all_bookingsrch", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options = Object.assign({}, ew.modalLookupOptions, options, ew.vars.tables.invertor_all_booking.fields.member_id.modalLookupOptions);
...
<input type="hidden" name="z_date_booking" id="z_date_booking" value="BETWEEN">
        ...
        <div id="el_invertor_all_booking_date_booking" class="ew-search-field">
<input type="<?= $Page->date_booking->getInputTextType() ?>" name="x_date_booking" id="x_date_booking" data-table="invertor_all_booking" data-field="x_date_booking" value="<?= $Page->date_booking->EditValue ?>" placeholder="<?= HtmlEncode($Page->date_booking->getPlaceHolder()) ?>"<?= $Page->date_booking->editAttributes() ?>>
...
<script>
loadjs.ready(["finvertor_all_bookingsrch", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("finvertor_all_bookingsrch", "x_date_booking", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</div>
        ...
        <div id="el2_invertor_all_booking_date_booking" class="ew-search-field2">
<input type="<?= $Page->date_booking->getInputTextType() ?>" name="y_date_booking" id="y_date_booking" data-table="invertor_all_booking" data-field="x_date_booking" value="<?= $Page->date_booking->EditValue2 ?>" placeholder="<?= HtmlEncode($Page->date_booking->getPlaceHolder()) ?>"<?= $Page->date_booking->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->date_booking->getErrorMessage(false) ?></div>
<?php if (!$Page->date_booking->ReadOnly && !$Page->date_booking->Disabled && !isset($Page->date_booking->EditAttrs["readonly"]) && !isset($Page->date_booking->EditAttrs["disabled"])) { ?>
<script>
loadjs.ready(["finvertor_all_bookingsrch", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("finvertor_all_bookingsrch", "y_date_booking", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</div>
...
<input type="hidden" name="z_status_expire" id="z_status_expire" value="=">
        ...
        <div id="el_invertor_all_booking_status_expire" class="ew-search-field">
...
<input type="hidden" name="z_status_expire_reason" id="z_status_expire_reason" value="LIKE">
        ...
        <div id="el_invertor_all_booking_status_expire_reason" class="ew-search-field">
...
<input type="hidden" name="z_payment_status" id="z_payment_status" value="=">
        ...
        <div id="el_invertor_all_booking_payment_status" class="ew-search-field">
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> invertor_all_booking">
<form name="finvertor_all_bookinglist" id="finvertor_all_bookinglist" class="ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="invertor_all_booking">
<div id="gmp_invertor_all_booking" class="<?= ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit()) { ?>
<table id="tbl_invertor_all_bookinglist" class="table table-bordered table-hover table-sm ew-table"><!-- .ew-table -->
<thead>
...
?>
<?php if ($Page->asset_id->Visible) { // asset_id ?>
        <th data-name="asset_id" class="<?= $Page->asset_id->headerCellClass() ?>"><div id="elh_invertor_all_booking_asset_id" class="invertor_all_booking_asset_id"><?= $Page->renderFieldHeader($Page->asset_id) ?></div></th>
<?php } ?>
<?php if ($Page->member_id->Visible) { // member_id ?>
        <th data-name="member_id" class="<?= $Page->member_id->headerCellClass() ?>"><div id="elh_invertor_all_booking_member_id" class="invertor_all_booking_member_id"><?= $Page->renderFieldHeader($Page->member_id) ?></div></th>
<?php } ?>
<?php if ($Page->date_booking->Visible) { // date_booking ?>
        <th data-name="date_booking" class="<?= $Page->date_booking->headerCellClass() ?>"><div id="elh_invertor_all_booking_date_booking" class="invertor_all_booking_date_booking"><?= $Page->renderFieldHeader($Page->date_booking) ?></div></th>
<?php } ?>
<?php if ($Page->status_expire->Visible) { // status_expire ?>
        <th data-name="status_expire" class="<?= $Page->status_expire->headerCellClass() ?>"><div id="elh_invertor_all_booking_status_expire" class="invertor_all_booking_status_expire"><?= $Page->renderFieldHeader($Page->status_expire) ?></div></th>
<?php } ?>
<?php if ($Page->status_expire_reason->Visible) { // status_expire_reason ?>
        <th data-name="status_expire_reason" class="<?= $Page->status_expire_reason->headerCellClass() ?>"><div id="elh_invertor_all_booking_status_expire_reason" class="invertor_all_booking_status_expire_reason"><?= $Page->renderFieldHeader($Page->status_expire_reason) ?></div></th>
<?php } ?>
<?php if ($Page->payment_status->Visible) { // payment_status ?>
        <th data-name="payment_status" class="<?= $Page->payment_status->headerCellClass() ?>"><div id="elh_invertor_all_booking_payment_status" class="invertor_all_booking_payment_status"><?= $Page->renderFieldHeader($Page->payment_status) ?></div></th>
<?php } ?>
<?php
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge([
            ...
            "id" => "r" . $Page->RowCount . "_invertor_all_booking",
...
<span id="el<?= $Page->RowCount ?>_invertor_all_booking_asset_id" class="el_invertor_all_booking_asset_id">
...
<span id="el<?= $Page->RowCount ?>_invertor_all_booking_member_id" class="el_invertor_all_booking_member_id">
...
<span id="el<?= $Page->RowCount ?>_invertor_all_booking_date_booking" class="el_invertor_all_booking_date_booking">
...
<span id="el<?= $Page->RowCount ?>_invertor_all_booking_status_expire" class="el_invertor_all_booking_status_expire">
...
<span id="el<?= $Page->RowCount ?>_invertor_all_booking_status_expire_reason" class="el_invertor_all_booking_status_expire_reason">
...
<span id="el<?= $Page->RowCount ?>_invertor_all_booking_payment_status" class="el_invertor_all_booking_payment_status">
...
loadjs.ready("fixedheadertable", function () {
    ew.fixedHeaderTable({
        delay: 0,
        container: "gmp_invertor_all_booking",
        width: "100%",
        height: "500px"
    });
});
