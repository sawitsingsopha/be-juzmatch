...
// Page object
$BuyerAssetRentAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { buyer_asset_rent: currentTable } });
var currentForm, currentPageID;
var fbuyer_asset_rentadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fbuyer_asset_rentadd = new ew.Form("fbuyer_asset_rentadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fbuyer_asset_rentadd;

    // Add fields
    var fields = currentTable.fields;
    fbuyer_asset_rentadd.addFields([
    ...
    // Form_CustomValidate
    fbuyer_asset_rentadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fbuyer_asset_rentadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fbuyer_asset_rentadd.lists.asset_id = <?= $Page->asset_id->toClientList($Page) ?>;
    fbuyer_asset_rentadd.lists.member_id = <?= $Page->member_id->toClientList($Page) ?>;
    fbuyer_asset_rentadd.lists.one_time_status = <?= $Page->one_time_status->toClientList($Page) ?>;
    fbuyer_asset_rentadd.lists.status_pay_half_price_1 = <?= $Page->status_pay_half_price_1->toClientList($Page) ?>;
    fbuyer_asset_rentadd.lists.status_pay_half_price_2 = <?= $Page->status_pay_half_price_2->toClientList($Page) ?>;
    loadjs.done("fbuyer_asset_rentadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fbuyer_asset_rentadd" id="fbuyer_asset_rentadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_buyer_asset_rent_asset_id">
    <select
        ...
        data-select2-id="fbuyer_asset_rentadd_x_asset_id"
...
<script>
loadjs.ready("fbuyer_asset_rentadd", function() {
    var options = { name: "x_asset_id", selectId: "fbuyer_asset_rentadd_x_asset_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fbuyer_asset_rentadd.lists.asset_id.lookupOptions.length) {
        options.data = { id: "x_asset_id", form: "fbuyer_asset_rentadd" };
    } else {
        options.ajax = { id: "x_asset_id", form: "fbuyer_asset_rentadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_buyer_asset_rent_member_id">
    <select
        ...
        data-select2-id="fbuyer_asset_rentadd_x_member_id"
        data-table="buyer_asset_rent"
...
<script>
loadjs.ready("fbuyer_asset_rentadd", function() {
    var options = { name: "x_member_id", selectId: "fbuyer_asset_rentadd_x_member_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fbuyer_asset_rentadd.lists.member_id.lookupOptions.length) {
        options.data = { id: "x_member_id", form: "fbuyer_asset_rentadd" };
    } else {
        options.ajax = { id: "x_member_id", form: "fbuyer_asset_rentadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
    options = Object.assign({}, ew.selectOptions, options, ew.vars.tables.buyer_asset_rent.fields.member_id.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<div class="form-check form-switch d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->one_time_status->isInvalidClass() ?>" data-table="buyer_asset_rent" data-field="x_one_time_status" name="x_one_time_status[]" id="x_one_time_status_534306" value="1"<?= ConvertToBool($Page->one_time_status->CurrentValue) ? " checked" : "" ?><?= $Page->one_time_status->editAttributes() ?> aria-describedby="x_one_time_status_help">
...
<span id="el_buyer_asset_rent_status_pay_half_price_1">
    <select
        ...
        data-select2-id="fbuyer_asset_rentadd_x_status_pay_half_price_1"
        data-table="buyer_asset_rent"
...
<script>
loadjs.ready("fbuyer_asset_rentadd", function() {
    var options = { name: "x_status_pay_half_price_1", selectId: "fbuyer_asset_rentadd_x_status_pay_half_price_1" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fbuyer_asset_rentadd.lists.status_pay_half_price_1.lookupOptions.length) {
        options.data = { id: "x_status_pay_half_price_1", form: "fbuyer_asset_rentadd" };
    } else {
        options.ajax = { id: "x_status_pay_half_price_1", form: "fbuyer_asset_rentadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<script>
loadjs.ready(["fbuyer_asset_rentadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fbuyer_asset_rentadd", "x_date_pay_half_price_1", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fbuyer_asset_rentadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fbuyer_asset_rentadd", "x_due_date_pay_half_price_1", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_buyer_asset_rent_status_pay_half_price_2">
    <select
        ...
        data-select2-id="fbuyer_asset_rentadd_x_status_pay_half_price_2"
        data-table="buyer_asset_rent"
...
<script>
loadjs.ready("fbuyer_asset_rentadd", function() {
    var options = { name: "x_status_pay_half_price_2", selectId: "fbuyer_asset_rentadd_x_status_pay_half_price_2" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fbuyer_asset_rentadd.lists.status_pay_half_price_2.lookupOptions.length) {
        options.data = { id: "x_status_pay_half_price_2", form: "fbuyer_asset_rentadd" };
    } else {
        options.ajax = { id: "x_status_pay_half_price_2", form: "fbuyer_asset_rentadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
loadjs.ready(["fbuyer_asset_rentadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fbuyer_asset_rentadd", "x_date_pay_half_price_2", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fbuyer_asset_rentadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fbuyer_asset_rentadd", "x_due_date_pay_half_price_2", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
