...
<div class="row <?=$class_hs_btn?>"><!-- buttons .row -->
    ...
    <a class="btn btn-default ew-btn" name="postdoc" id="postdoc" onclick="postdoc(3,<?=$Page->id->CurrentValue?>)" type="button">ส่งไป Creden eSign</a>
    </div><!-- /buttons offset -->
    </div><!-- /buttons .row -->
...
<div class="row"><!-- buttons .row -->
    <div class="<?= $Page->OffsetColumnClass ?>"><!-- buttons offset -->
        ...
        <a class="btn btn-default ew-btn" name="canceldoc" id="canceldoc" type="button" onclick="canceldoc(3,<?=$Page->id->CurrentValue?>)">ยกเลิกเอกสารนี้</a>
    </div><!-- /buttons offset -->
</div>
<?php
}
...
loadjs.ready("load", function () {
    ...
    $("#download_simpledoc").click(function () {
        ...
        $('label.error').remove();
        $("#fdoc_juzmatch3edit").valid();

        // //used
        // var myForm = document.getElementById("fdoc_juzmatch3edit");
...
<script>
    ...
    function download_simpledoc(type,doc_id){
        ...
        let validator = $("#fdoc_juzmatch3edit").validate({
    ...
    function postdoc(type,doc_id){
        ...
        let validator = $("#fdoc_juzmatch3edit").validate({
            ...
            rules : {
                ...
                x_company_seal_email: "required",
                x_total: "required",
                x_total_txt: "required",
                x_next_pay_date: "required",
                x_next_pay_date_txt: "required",
                x_service_price: "required",
                x_service_price_txt: "required",
                x_provide_service_date: "required",
