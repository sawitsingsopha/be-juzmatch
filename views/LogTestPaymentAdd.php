...
// Page object
$LogTestPaymentAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { log_test_payment: currentTable } });
var currentForm, currentPageID;
var flog_test_paymentadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    flog_test_paymentadd = new ew.Form("flog_test_paymentadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = flog_test_paymentadd;

    // Add fields
    var fields = currentTable.fields;
    flog_test_paymentadd.addFields([
    ...
    // Form_CustomValidate
    flog_test_paymentadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flog_test_paymentadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("flog_test_paymentadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="flog_test_paymentadd" id="flog_test_paymentadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["flog_test_paymentadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_test_paymentadd", "x_date_booking", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["flog_test_paymentadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_test_paymentadd", "x_date_payment", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["flog_test_paymentadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_test_paymentadd", "x_due_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["flog_test_paymentadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_test_paymentadd", "x_transaction_datetime", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["flog_test_paymentadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_test_paymentadd", "x_cdate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["flog_test_paymentadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_test_paymentadd", "x_udate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
