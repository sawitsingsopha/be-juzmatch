...
var fpeak_req_logview;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpeak_req_logview = new ew.Form("fpeak_req_logview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fpeak_req_logview;
    loadjs.done("fpeak_req_logview");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fpeak_req_logview" id="fpeak_req_logview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_peak_req_log_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->req_date->Visible) { // req_date ?>
    <tr id="r_req_date"<?= $Page->req_date->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_peak_req_log_req_date"><?= $Page->req_date->caption() ?></span></td>
...
<?php if ($Page->req_config->Visible) { // req_config ?>
    <tr id="r_req_config"<?= $Page->req_config->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_peak_req_log_req_config"><?= $Page->req_config->caption() ?></span></td>
...
<?php if ($Page->req_response->Visible) { // req_response ?>
    <tr id="r_req_response"<?= $Page->req_response->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_peak_req_log_req_response"><?= $Page->req_response->caption() ?></span></td>
...
<?php if ($Page->error_message->Visible) { // error_message ?>
    <tr id="r_error_message"<?= $Page->error_message->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_peak_req_log_error_message"><?= $Page->error_message->caption() ?></span></td>
