...
// Page object
$AllAssetConfigSchedulePreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { all_asset_config_schedule: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<?php $Page->showPageHeader(); ?>
<?php if ($Page->TotalRecords > 0) { ?>
<div class="card ew-grid all_asset_config_schedule"><!-- .card -->
