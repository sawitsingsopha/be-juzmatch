...
// Page object
$BuyerAllBookingAssetEdit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { buyer_all_booking_asset: currentTable } });
var currentForm, currentPageID;
var fbuyer_all_booking_assetedit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fbuyer_all_booking_assetedit = new ew.Form("fbuyer_all_booking_assetedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fbuyer_all_booking_assetedit;

    // Add fields
    var fields = currentTable.fields;
    fbuyer_all_booking_assetedit.addFields([
        ...
        ["booking_price", [fields.booking_price.visible && fields.booking_price.required ? ew.Validators.required(fields.booking_price.caption) : null], fields.booking_price.isInvalid],
    ...
    // Form_CustomValidate
    fbuyer_all_booking_assetedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fbuyer_all_booking_assetedit.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fbuyer_all_booking_assetedit.lists.status_expire = <?= $Page->status_expire->toClientList($Page) ?>;
    loadjs.done("fbuyer_all_booking_assetedit");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fbuyer_all_booking_assetedit" id="fbuyer_all_booking_assetedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->asset_id->Visible) { // asset_id ?>
    <div id="r_asset_id"<?= $Page->asset_id->rowAttributes() ?>>
        <label id="elh_buyer_all_booking_asset_asset_id" for="x_asset_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->asset_id->caption() ?><?= $Page->asset_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="buyer_all_booking_asset" data-field="x_asset_id" data-hidden="1" name="x_asset_id" id="x_asset_id" value="<?= HtmlEncode($Page->asset_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->member_id->Visible) { // member_id ?>
    <div id="r_member_id"<?= $Page->member_id->rowAttributes() ?>>
        <label id="elh_buyer_all_booking_asset_member_id" for="x_member_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->member_id->caption() ?><?= $Page->member_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="buyer_all_booking_asset" data-field="x_member_id" data-hidden="1" name="x_member_id" id="x_member_id" value="<?= HtmlEncode($Page->member_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->booking_price->Visible) { // booking_price ?>
    <div id="r_booking_price"<?= $Page->booking_price->rowAttributes() ?>>
        <label id="elh_buyer_all_booking_asset_booking_price" for="x_booking_price" class="<?= $Page->LeftColumnClass ?>"><?= $Page->booking_price->caption() ?><?= $Page->booking_price->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->booking_price->getDisplayValue($Page->booking_price->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="buyer_all_booking_asset" data-field="x_booking_price" data-hidden="1" name="x_booking_price" id="x_booking_price" value="<?= HtmlEncode($Page->booking_price->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->pay_number->Visible) { // pay_number ?>
    <div id="r_pay_number"<?= $Page->pay_number->rowAttributes() ?>>
        <label id="elh_buyer_all_booking_asset_pay_number" for="x_pay_number" class="<?= $Page->LeftColumnClass ?>"><?= $Page->pay_number->caption() ?><?= $Page->pay_number->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="buyer_all_booking_asset" data-field="x_pay_number" data-hidden="1" name="x_pay_number" id="x_pay_number" value="<?= HtmlEncode($Page->pay_number->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->status_payment->Visible) { // status_payment ?>
    <div id="r_status_payment"<?= $Page->status_payment->rowAttributes() ?>>
        <label id="elh_buyer_all_booking_asset_status_payment" for="x_status_payment" class="<?= $Page->LeftColumnClass ?>"><?= $Page->status_payment->caption() ?><?= $Page->status_payment->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="buyer_all_booking_asset" data-field="x_status_payment" data-hidden="1" name="x_status_payment" id="x_status_payment" value="<?= HtmlEncode($Page->status_payment->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->date_booking->Visible) { // date_booking ?>
    <div id="r_date_booking"<?= $Page->date_booking->rowAttributes() ?>>
        <label id="elh_buyer_all_booking_asset_date_booking" for="x_date_booking" class="<?= $Page->LeftColumnClass ?>"><?= $Page->date_booking->caption() ?><?= $Page->date_booking->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="buyer_all_booking_asset" data-field="x_date_booking" data-hidden="1" name="x_date_booking" id="x_date_booking" value="<?= HtmlEncode($Page->date_booking->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->date_payment->Visible) { // date_payment ?>
    <div id="r_date_payment"<?= $Page->date_payment->rowAttributes() ?>>
        <label id="elh_buyer_all_booking_asset_date_payment" for="x_date_payment" class="<?= $Page->LeftColumnClass ?>"><?= $Page->date_payment->caption() ?><?= $Page->date_payment->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="buyer_all_booking_asset" data-field="x_date_payment" data-hidden="1" name="x_date_payment" id="x_date_payment" value="<?= HtmlEncode($Page->date_payment->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->due_date->Visible) { // due_date ?>
    <div id="r_due_date"<?= $Page->due_date->rowAttributes() ?>>
        <label id="elh_buyer_all_booking_asset_due_date" for="x_due_date" class="<?= $Page->LeftColumnClass ?>"><?= $Page->due_date->caption() ?><?= $Page->due_date->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->due_date->cellAttributes() ?>>
<span id="el_buyer_all_booking_asset_due_date">
<input type="<?= $Page->due_date->getInputTextType() ?>" name="x_due_date" id="x_due_date" data-table="buyer_all_booking_asset" data-field="x_due_date" value="<?= $Page->due_date->EditValue ?>" placeholder="<?= HtmlEncode($Page->due_date->getPlaceHolder()) ?>"<?= $Page->due_date->editAttributes() ?> aria-describedby="x_due_date_help">
...
<script>
loadjs.ready(["fbuyer_all_booking_assetedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fbuyer_all_booking_assetedit", "x_due_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->status_expire->Visible) { // status_expire ?>
    <div id="r_status_expire"<?= $Page->status_expire->rowAttributes() ?>>
        <label id="elh_buyer_all_booking_asset_status_expire" class="<?= $Page->LeftColumnClass ?>"><?= $Page->status_expire->caption() ?><?= $Page->status_expire->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->status_expire_reason->Visible) { // status_expire_reason ?>
    <div id="r_status_expire_reason"<?= $Page->status_expire_reason->rowAttributes() ?>>
        <label id="elh_buyer_all_booking_asset_status_expire_reason" for="x_status_expire_reason" class="<?= $Page->LeftColumnClass ?>"><?= $Page->status_expire_reason->caption() ?><?= $Page->status_expire_reason->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php } ?>
    ...
    <input type="hidden" data-table="buyer_all_booking_asset" data-field="x_buyer_booking_asset_id" data-hidden="1" name="x_buyer_booking_asset_id" id="x_buyer_booking_asset_id" value="<?= HtmlEncode($Page->buyer_booking_asset_id->CurrentValue) ?>">
<?php
    if (in_array("buyer_all_asset_rent", explode(",", $Page->getCurrentDetailTable())) && $buyer_all_asset_rent->DetailEdit) {
?>
...
<?php } ?>
<?php
    if (in_array("all_buyer_config_asset_schedule", explode(",", $Page->getCurrentDetailTable())) && $all_buyer_config_asset_schedule->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("doc_juzmatch1", explode(",", $Page->getCurrentDetailTable())) && $doc_juzmatch1->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("doc_juzmatch3", explode(",", $Page->getCurrentDetailTable())) && $doc_juzmatch3->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
