...
// Page object
$PeakReceiptProductAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { peak_receipt_product: currentTable } });
var currentForm, currentPageID;
var fpeak_receipt_productadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpeak_receipt_productadd = new ew.Form("fpeak_receipt_productadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fpeak_receipt_productadd;

    // Add fields
    var fields = currentTable.fields;
    fpeak_receipt_productadd.addFields([
    ...
    // Form_CustomValidate
    fpeak_receipt_productadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpeak_receipt_productadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fpeak_receipt_productadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fpeak_receipt_productadd" id="fpeak_receipt_productadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
