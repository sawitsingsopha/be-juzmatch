...
// Page object
$LogNotificationAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { log_notification: currentTable } });
var currentForm, currentPageID;
var flog_notificationadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    flog_notificationadd = new ew.Form("flog_notificationadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = flog_notificationadd;

    // Add fields
    var fields = currentTable.fields;
    flog_notificationadd.addFields([
    ...
    // Form_CustomValidate
    flog_notificationadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flog_notificationadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("flog_notificationadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="flog_notificationadd" id="flog_notificationadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["flog_notificationadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_notificationadd", "x_cdate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
