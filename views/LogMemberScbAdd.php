...
// Page object
$LogMemberScbAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { log_member_scb: currentTable } });
var currentForm, currentPageID;
var flog_member_scbadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    flog_member_scbadd = new ew.Form("flog_member_scbadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = flog_member_scbadd;

    // Add fields
    var fields = currentTable.fields;
    flog_member_scbadd.addFields([
    ...
    // Form_CustomValidate
    flog_member_scbadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flog_member_scbadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("flog_member_scbadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="flog_member_scbadd" id="flog_member_scbadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["flog_member_scbadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_member_scbadd", "x_cdate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["flog_member_scbadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_member_scbadd", "x_decision_timestamp", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["flog_member_scbadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_member_scbadd", "x_submissionDate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
