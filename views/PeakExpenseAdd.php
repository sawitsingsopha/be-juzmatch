...
var fpeak_expenseadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpeak_expenseadd = new ew.Form("fpeak_expenseadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fpeak_expenseadd;

    // Add fields
    var fields = currentTable.fields;
    fpeak_expenseadd.addFields([
    ...
    // Form_CustomValidate
    fpeak_expenseadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpeak_expenseadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fpeak_expenseadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fpeak_expenseadd" id="fpeak_expenseadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpeak_expenseadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_expenseadd", "x_issuedDate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpeak_expenseadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_expenseadd", "x_dueDate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpeak_expenseadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_expenseadd", "x_paymentDate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpeak_expenseadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_expenseadd", "x_cdate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpeak_expenseadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_expenseadd", "x_udate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpeak_expenseadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_expenseadd", "x_sync_detail_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
