...
// Page object
$BuyerAssetRentPreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { buyer_asset_rent: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<?php $Page->showPageHeader(); ?>
<?php if ($Page->TotalRecords > 0) { ?>
<div class="card ew-grid buyer_asset_rent"><!-- .card -->
...
<?php if ($Page->pay_number_half_price_1->Visible) { // pay_number_half_price_1 ?>
    <?php if ($Page->SortUrl($Page->pay_number_half_price_1) == "") { ?>
        <th class="<?= $Page->pay_number_half_price_1->headerCellClass() ?>"><?= $Page->pay_number_half_price_1->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->pay_number_half_price_1->headerCellClass() ?>"><div role="button" data-sort="<?= HtmlEncode($Page->pay_number_half_price_1->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->pay_number_half_price_1->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->pay_number_half_price_1->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->pay_number_half_price_1->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
<?php if ($Page->date_pay_half_price_1->Visible) { // date_pay_half_price_1 ?>
    <?php if ($Page->SortUrl($Page->date_pay_half_price_1) == "") { ?>
        <th class="<?= $Page->date_pay_half_price_1->headerCellClass() ?>"><?= $Page->date_pay_half_price_1->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->date_pay_half_price_1->headerCellClass() ?>"><div role="button" data-sort="<?= HtmlEncode($Page->date_pay_half_price_1->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->date_pay_half_price_1->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->date_pay_half_price_1->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->date_pay_half_price_1->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
...
<?php if ($Page->pay_number_half_price_2->Visible) { // pay_number_half_price_2 ?>
    <?php if ($Page->SortUrl($Page->pay_number_half_price_2) == "") { ?>
        <th class="<?= $Page->pay_number_half_price_2->headerCellClass() ?>"><?= $Page->pay_number_half_price_2->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->pay_number_half_price_2->headerCellClass() ?>"><div role="button" data-sort="<?= HtmlEncode($Page->pay_number_half_price_2->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->pay_number_half_price_2->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->pay_number_half_price_2->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->pay_number_half_price_2->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
<?php if ($Page->date_pay_half_price_2->Visible) { // date_pay_half_price_2 ?>
    <?php if ($Page->SortUrl($Page->date_pay_half_price_2) == "") { ?>
        <th class="<?= $Page->date_pay_half_price_2->headerCellClass() ?>"><?= $Page->date_pay_half_price_2->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->date_pay_half_price_2->headerCellClass() ?>"><div role="button" data-sort="<?= HtmlEncode($Page->date_pay_half_price_2->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->date_pay_half_price_2->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->date_pay_half_price_2->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->date_pay_half_price_2->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
