...
// Page object
$AllBuyerAssetSchedulePreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { all_buyer_asset_schedule: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<?php $Page->showPageHeader(); ?>
<?php if ($Page->TotalRecords > 0) { ?>
<div class="card ew-grid all_buyer_asset_schedule"><!-- .card -->
...
<?php if ($Page->interest->Visible) { // interest ?>
    <?php if ($Page->SortUrl($Page->interest) == "") { ?>
        <th class="<?= $Page->interest->headerCellClass() ?>"><?= $Page->interest->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->interest->headerCellClass() ?>"><div role="button" data-sort="<?= HtmlEncode($Page->interest->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->interest->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->interest->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->interest->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
<?php if ($Page->principal->Visible) { // principal ?>
    <?php if ($Page->SortUrl($Page->principal) == "") { ?>
        <th class="<?= $Page->principal->headerCellClass() ?>"><?= $Page->principal->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->principal->headerCellClass() ?>"><div role="button" data-sort="<?= HtmlEncode($Page->principal->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->principal->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->principal->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->principal->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
<?php if ($Page->remaining_principal->Visible) { // remaining_principal ?>
    <?php if ($Page->SortUrl($Page->remaining_principal) == "") { ?>
        <th class="<?= $Page->remaining_principal->headerCellClass() ?>"><?= $Page->remaining_principal->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->remaining_principal->headerCellClass() ?>"><div role="button" data-sort="<?= HtmlEncode($Page->remaining_principal->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->remaining_principal->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->remaining_principal->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->remaining_principal->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
...
<?php if ($Page->principal->Visible) { // principal ?>
        <!-- principal -->
        <td<?= $Page->principal->cellAttributes() ?>>
...
<?php if ($Page->remaining_principal->Visible) { // remaining_principal ?>
        <!-- remaining_principal -->
        <td<?= $Page->remaining_principal->cellAttributes() ?>>
