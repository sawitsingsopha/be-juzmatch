...
// Page object
$DocJuzmatch3Add = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { doc_juzmatch3: currentTable } });
var currentForm, currentPageID;
var fdoc_juzmatch3add;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fdoc_juzmatch3add = new ew.Form("fdoc_juzmatch3add", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fdoc_juzmatch3add;

    // Add fields
    var fields = currentTable.fields;
    fdoc_juzmatch3add.addFields([
    ...
    // Form_CustomValidate
    fdoc_juzmatch3add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdoc_juzmatch3add.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fdoc_juzmatch3add.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("fdoc_juzmatch3add");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fdoc_juzmatch3add" id="fdoc_juzmatch3add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fdoc_juzmatch3add", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoc_juzmatch3add", "x_start_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdoc_juzmatch3add", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoc_juzmatch3add", "x_end_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdoc_juzmatch3add", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoc_juzmatch3add", "x_appoint_agent_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdoc_juzmatch3add", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoc_juzmatch3add", "x_next_pay_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdoc_juzmatch3add", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoc_juzmatch3add", "x_provide_service_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_doc_juzmatch3_status">
    <select
        ...
        data-select2-id="fdoc_juzmatch3add_x_status"
...
<script>
loadjs.ready("fdoc_juzmatch3add", function() {
    var options = { name: "x_status", selectId: "fdoc_juzmatch3add_x_status" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fdoc_juzmatch3add.lists.status.lookupOptions.length) {
        options.data = { id: "x_status", form: "fdoc_juzmatch3add" };
    } else {
        options.ajax = { id: "x_status", form: "fdoc_juzmatch3add", limit: ew.LOOKUP_PAGE_SIZE };
    }
