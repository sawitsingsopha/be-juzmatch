...
var fpeak_req_logadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpeak_req_logadd = new ew.Form("fpeak_req_logadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fpeak_req_logadd;

    // Add fields
    var fields = currentTable.fields;
    fpeak_req_logadd.addFields([
    ...
    // Form_CustomValidate
    fpeak_req_logadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpeak_req_logadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fpeak_req_logadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fpeak_req_logadd" id="fpeak_req_logadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpeak_req_logadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpeak_req_logadd", "x_req_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
