...
<?php if ($Page->attach_file->Visible) { // attach_file ?>
    <tr id="r_attach_file"<?= $Page->attach_file->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_doc_juzmatch1_attach_file"><?= $Page->attach_file->caption() ?></span></td>
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status"<?= $Page->status->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_doc_juzmatch1_status"><?= $Page->status->caption() ?></span></td>
