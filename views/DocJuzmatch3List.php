...
<?php if ($Page->attach_file->Visible) { // attach_file ?>
        <th data-name="attach_file" class="<?= $Page->attach_file->headerCellClass() ?>"><div id="elh_doc_juzmatch3_attach_file" class="doc_juzmatch3_attach_file"><?= $Page->renderFieldHeader($Page->attach_file) ?></div></th>
<?php } ?>
<?php if ($Page->status->Visible) { // status ?>
        <th data-name="status" class="<?= $Page->status->headerCellClass() ?>"><div id="elh_doc_juzmatch3_status" class="doc_juzmatch3_status"><?= $Page->renderFieldHeader($Page->status) ?></div></th>
<?php } ?>
