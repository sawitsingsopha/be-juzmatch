...
// Page object
$LogSendEmailAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { log_send_email: currentTable } });
var currentForm, currentPageID;
var flog_send_emailadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    flog_send_emailadd = new ew.Form("flog_send_emailadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = flog_send_emailadd;

    // Add fields
    var fields = currentTable.fields;
    flog_send_emailadd.addFields([
    ...
    // Form_CustomValidate
    flog_send_emailadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flog_send_emailadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("flog_send_emailadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="flog_send_emailadd" id="flog_send_emailadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["flog_send_emailadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("flog_send_emailadd", "x_cdate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
