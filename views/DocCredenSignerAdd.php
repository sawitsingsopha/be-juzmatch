...
// Page object
$DocCredenSignerAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { doc_creden_signer: currentTable } });
var currentForm, currentPageID;
var fdoc_creden_signeradd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fdoc_creden_signeradd = new ew.Form("fdoc_creden_signeradd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fdoc_creden_signeradd;

    // Add fields
    var fields = currentTable.fields;
    fdoc_creden_signeradd.addFields([
    ...
    // Form_CustomValidate
    fdoc_creden_signeradd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdoc_creden_signeradd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fdoc_creden_signeradd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fdoc_creden_signeradd" id="fdoc_creden_signeradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fdoc_creden_signeradd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoc_creden_signeradd", "x_cdate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdoc_creden_signeradd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoc_creden_signeradd", "x_udate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
