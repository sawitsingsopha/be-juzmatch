...
// Page object
$AllBuyerConfigAssetScheduleView = &$Page;
?>
...
var fall_buyer_config_asset_scheduleview;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fall_buyer_config_asset_scheduleview = new ew.Form("fall_buyer_config_asset_scheduleview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fall_buyer_config_asset_scheduleview;
    loadjs.done("fall_buyer_config_asset_scheduleview");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fall_buyer_config_asset_scheduleview" id="fall_buyer_config_asset_scheduleview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->member_id->Visible) { // member_id ?>
    <tr id="r_member_id"<?= $Page->member_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_member_id"><?= $Page->member_id->caption() ?></span></td>
...
<?php if ($Page->asset_id->Visible) { // asset_id ?>
    <tr id="r_asset_id"<?= $Page->asset_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_asset_id"><?= $Page->asset_id->caption() ?></span></td>
...
<?php if ($Page->installment_all->Visible) { // installment_all ?>
    <tr id="r_installment_all"<?= $Page->installment_all->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_installment_all"><?= $Page->installment_all->caption() ?></span></td>
...
<?php if ($Page->asset_price->Visible) { // asset_price ?>
    <tr id="r_asset_price"<?= $Page->asset_price->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_asset_price"><?= $Page->asset_price->caption() ?></span></td>
...
<?php if ($Page->booking_price->Visible) { // booking_price ?>
    <tr id="r_booking_price"<?= $Page->booking_price->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_booking_price"><?= $Page->booking_price->caption() ?></span></td>
...
<?php if ($Page->down_price->Visible) { // down_price ?>
    <tr id="r_down_price"<?= $Page->down_price->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_down_price"><?= $Page->down_price->caption() ?></span></td>
...
<?php if ($Page->installment_price_per->Visible) { // installment_price_per ?>
    <tr id="r_installment_price_per"<?= $Page->installment_price_per->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_installment_price_per"><?= $Page->installment_price_per->caption() ?></span></td>
...
<?php if ($Page->annual_interest->Visible) { // annual_interest ?>
    <tr id="r_annual_interest"<?= $Page->annual_interest->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_annual_interest"><?= $Page->annual_interest->caption() ?></span></td>
...
<?php if ($Page->number_days_pay_first_month->Visible) { // number_days_pay_first_month ?>
    <tr id="r_number_days_pay_first_month"<?= $Page->number_days_pay_first_month->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_number_days_pay_first_month"><?= $Page->number_days_pay_first_month->caption() ?></span></td>
...
<?php if ($Page->number_days_in_first_month->Visible) { // number_days_in_first_month ?>
    <tr id="r_number_days_in_first_month"<?= $Page->number_days_in_first_month->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_number_days_in_first_month"><?= $Page->number_days_in_first_month->caption() ?></span></td>
...
<?php if ($Page->move_in_on_20th->Visible) { // move_in_on_20th ?>
    <tr id="r_move_in_on_20th"<?= $Page->move_in_on_20th->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_move_in_on_20th"><?= $Page->move_in_on_20th->caption() ?></span></td>
...
<?php if ($Page->date_start_installment->Visible) { // date_start_installment ?>
    <tr id="r_date_start_installment"<?= $Page->date_start_installment->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_date_start_installment"><?= $Page->date_start_installment->caption() ?></span></td>
...
<?php if ($Page->cdate->Visible) { // cdate ?>
    <tr id="r_cdate"<?= $Page->cdate->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_buyer_config_asset_schedule_cdate"><?= $Page->cdate->caption() ?></span></td>
...
<?php
    if (in_array("all_buyer_asset_schedule", explode(",", $Page->getCurrentDetailTable())) && $all_buyer_asset_schedule->DetailView) {
?>
