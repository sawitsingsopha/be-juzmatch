...
<div class="row <?=$class_hs_btn?>"><!-- buttons .row -->
    ...
    <a class="btn btn-primary ew-btn" name="download_simpledoc" id="download_simpledoc" onclick="download_simpledoc(1,<?=$Page->id->CurrentValue?>)"  type="button">ดาวน์โหลดตัวอย่างเอกสาร</a>
    <a class="btn btn-default ew-btn" name="postdoc" id="postdoc" onclick="postdoc(1,<?=$Page->id->CurrentValue?>)" type="button">ส่งไป Creden eSign</a>
    </div><!-- /buttons offset -->
    </div><!-- /buttons .row -->
...
<div class="row"><!-- buttons .row -->
    <div class="<?= $Page->OffsetColumnClass ?>"><!-- buttons offset -->
        ...
        <a class="btn btn-default ew-btn" name="canceldoc" id="canceldoc" type="button" onclick="canceldoc(1,<?=$Page->id->CurrentValue?>)">ยกเลิกเอกสารนี้</a>
    </div><!-- /buttons offset -->
</div>
<?php
}
