...
var flog_member_scbview;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    flog_member_scbview = new ew.Form("flog_member_scbview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = flog_member_scbview;
    loadjs.done("flog_member_scbview");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="flog_member_scbview" id="flog_member_scbview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->log_member_scb_id->Visible) { // log_member_scb_id ?>
    <tr id="r_log_member_scb_id"<?= $Page->log_member_scb_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_log_member_scb_id"><?= $Page->log_member_scb_id->caption() ?></span></td>
...
<?php if ($Page->reference_id->Visible) { // reference_id ?>
    <tr id="r_reference_id"<?= $Page->reference_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_reference_id"><?= $Page->reference_id->caption() ?></span></td>
...
<?php if ($Page->reference_url->Visible) { // reference_url ?>
    <tr id="r_reference_url"<?= $Page->reference_url->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_reference_url"><?= $Page->reference_url->caption() ?></span></td>
...
<?php if ($Page->member_id->Visible) { // member_id ?>
    <tr id="r_member_id"<?= $Page->member_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_member_id"><?= $Page->member_id->caption() ?></span></td>
...
<?php if ($Page->refreshtoken->Visible) { // refreshtoken ?>
    <tr id="r_refreshtoken"<?= $Page->refreshtoken->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_refreshtoken"><?= $Page->refreshtoken->caption() ?></span></td>
...
<?php if ($Page->auth_code->Visible) { // auth_code ?>
    <tr id="r_auth_code"<?= $Page->auth_code->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_auth_code"><?= $Page->auth_code->caption() ?></span></td>
...
<?php if ($Page->_token->Visible) { // token ?>
    <tr id="r__token"<?= $Page->_token->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb__token"><?= $Page->_token->caption() ?></span></td>
...
<?php if ($Page->state->Visible) { // state ?>
    <tr id="r_state"<?= $Page->state->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_state"><?= $Page->state->caption() ?></span></td>
...
<?php if ($Page->cdate->Visible) { // cdate ?>
    <tr id="r_cdate"<?= $Page->cdate->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_cdate"><?= $Page->cdate->caption() ?></span></td>
...
<?php if ($Page->cuser->Visible) { // cuser ?>
    <tr id="r_cuser"<?= $Page->cuser->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_cuser"><?= $Page->cuser->caption() ?></span></td>
...
<?php if ($Page->cip->Visible) { // cip ?>
    <tr id="r_cip"<?= $Page->cip->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_cip"><?= $Page->cip->caption() ?></span></td>
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status"<?= $Page->status->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_status"><?= $Page->status->caption() ?></span></td>
...
<?php if ($Page->at_expire_in->Visible) { // at_expire_in ?>
    <tr id="r_at_expire_in"<?= $Page->at_expire_in->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_at_expire_in"><?= $Page->at_expire_in->caption() ?></span></td>
...
<?php if ($Page->rt_expire_in->Visible) { // rt_expire_in ?>
    <tr id="r_rt_expire_in"<?= $Page->rt_expire_in->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_rt_expire_in"><?= $Page->rt_expire_in->caption() ?></span></td>
...
<?php if ($Page->asset_id->Visible) { // asset_id ?>
    <tr id="r_asset_id"<?= $Page->asset_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_asset_id"><?= $Page->asset_id->caption() ?></span></td>
...
<?php if ($Page->decision_status->Visible) { // decision_status ?>
    <tr id="r_decision_status"<?= $Page->decision_status->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_decision_status"><?= $Page->decision_status->caption() ?></span></td>
...
<?php if ($Page->decision_timestamp->Visible) { // decision_timestamp ?>
    <tr id="r_decision_timestamp"<?= $Page->decision_timestamp->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_decision_timestamp"><?= $Page->decision_timestamp->caption() ?></span></td>
...
<?php if ($Page->deposit_amount->Visible) { // deposit_amount ?>
    <tr id="r_deposit_amount"<?= $Page->deposit_amount->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_deposit_amount"><?= $Page->deposit_amount->caption() ?></span></td>
...
<?php if ($Page->due_date->Visible) { // due_date ?>
    <tr id="r_due_date"<?= $Page->due_date->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_due_date"><?= $Page->due_date->caption() ?></span></td>
...
<?php if ($Page->rental_fee->Visible) { // rental_fee ?>
    <tr id="r_rental_fee"<?= $Page->rental_fee->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_rental_fee"><?= $Page->rental_fee->caption() ?></span></td>
...
<?php if ($Page->fullName->Visible) { // fullName ?>
    <tr id="r_fullName"<?= $Page->fullName->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_fullName"><?= $Page->fullName->caption() ?></span></td>
...
<?php if ($Page->age->Visible) { // age ?>
    <tr id="r_age"<?= $Page->age->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_age"><?= $Page->age->caption() ?></span></td>
...
<?php if ($Page->maritalStatus->Visible) { // maritalStatus ?>
    <tr id="r_maritalStatus"<?= $Page->maritalStatus->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_maritalStatus"><?= $Page->maritalStatus->caption() ?></span></td>
...
<?php if ($Page->noOfChildren->Visible) { // noOfChildren ?>
    <tr id="r_noOfChildren"<?= $Page->noOfChildren->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_noOfChildren"><?= $Page->noOfChildren->caption() ?></span></td>
...
<?php if ($Page->educationLevel->Visible) { // educationLevel ?>
    <tr id="r_educationLevel"<?= $Page->educationLevel->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_educationLevel"><?= $Page->educationLevel->caption() ?></span></td>
...
<?php if ($Page->workplace->Visible) { // workplace ?>
    <tr id="r_workplace"<?= $Page->workplace->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_workplace"><?= $Page->workplace->caption() ?></span></td>
...
<?php if ($Page->occupation->Visible) { // occupation ?>
    <tr id="r_occupation"<?= $Page->occupation->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_occupation"><?= $Page->occupation->caption() ?></span></td>
...
<?php if ($Page->jobPosition->Visible) { // jobPosition ?>
    <tr id="r_jobPosition"<?= $Page->jobPosition->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_jobPosition"><?= $Page->jobPosition->caption() ?></span></td>
...
<?php if ($Page->submissionDate->Visible) { // submissionDate ?>
    <tr id="r_submissionDate"<?= $Page->submissionDate->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_submissionDate"><?= $Page->submissionDate->caption() ?></span></td>
...
<?php if ($Page->bankruptcy_tendency->Visible) { // bankruptcy_tendency ?>
    <tr id="r_bankruptcy_tendency"<?= $Page->bankruptcy_tendency->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_bankruptcy_tendency"><?= $Page->bankruptcy_tendency->caption() ?></span></td>
...
<?php if ($Page->blacklist_tendency->Visible) { // blacklist_tendency ?>
    <tr id="r_blacklist_tendency"<?= $Page->blacklist_tendency->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_blacklist_tendency"><?= $Page->blacklist_tendency->caption() ?></span></td>
...
<?php if ($Page->money_laundering_tendency->Visible) { // money_laundering_tendency ?>
    <tr id="r_money_laundering_tendency"<?= $Page->money_laundering_tendency->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_money_laundering_tendency"><?= $Page->money_laundering_tendency->caption() ?></span></td>
...
<?php if ($Page->mobile_fraud_behavior->Visible) { // mobile_fraud_behavior ?>
    <tr id="r_mobile_fraud_behavior"<?= $Page->mobile_fraud_behavior->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_mobile_fraud_behavior"><?= $Page->mobile_fraud_behavior->caption() ?></span></td>
...
<?php if ($Page->face_similarity_score->Visible) { // face_similarity_score ?>
    <tr id="r_face_similarity_score"<?= $Page->face_similarity_score->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_face_similarity_score"><?= $Page->face_similarity_score->caption() ?></span></td>
...
<?php if ($Page->identification_verification_matched_flag->Visible) { // identification_verification_matched_flag ?>
    <tr id="r_identification_verification_matched_flag"<?= $Page->identification_verification_matched_flag->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_identification_verification_matched_flag"><?= $Page->identification_verification_matched_flag->caption() ?></span></td>
...
<?php if ($Page->bankstatement_confident_score->Visible) { // bankstatement_confident_score ?>
    <tr id="r_bankstatement_confident_score"<?= $Page->bankstatement_confident_score->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_bankstatement_confident_score"><?= $Page->bankstatement_confident_score->caption() ?></span></td>
...
<?php if ($Page->estimated_monthly_income->Visible) { // estimated_monthly_income ?>
    <tr id="r_estimated_monthly_income"<?= $Page->estimated_monthly_income->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_estimated_monthly_income"><?= $Page->estimated_monthly_income->caption() ?></span></td>
...
<?php if ($Page->estimated_monthly_debt->Visible) { // estimated_monthly_debt ?>
    <tr id="r_estimated_monthly_debt"<?= $Page->estimated_monthly_debt->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_estimated_monthly_debt"><?= $Page->estimated_monthly_debt->caption() ?></span></td>
...
<?php if ($Page->income_stability->Visible) { // income_stability ?>
    <tr id="r_income_stability"<?= $Page->income_stability->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_income_stability"><?= $Page->income_stability->caption() ?></span></td>
...
<?php if ($Page->customer_grade->Visible) { // customer_grade ?>
    <tr id="r_customer_grade"<?= $Page->customer_grade->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_customer_grade"><?= $Page->customer_grade->caption() ?></span></td>
...
<?php if ($Page->color_sign->Visible) { // color_sign ?>
    <tr id="r_color_sign"<?= $Page->color_sign->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_color_sign"><?= $Page->color_sign->caption() ?></span></td>
...
<?php if ($Page->rental_period->Visible) { // rental_period ?>
    <tr id="r_rental_period"<?= $Page->rental_period->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_log_member_scb_rental_period"><?= $Page->rental_period->caption() ?></span></td>
