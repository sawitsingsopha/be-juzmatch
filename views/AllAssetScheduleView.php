...
var fall_asset_scheduleview;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fall_asset_scheduleview = new ew.Form("fall_asset_scheduleview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fall_asset_scheduleview;
    loadjs.done("fall_asset_scheduleview");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fall_asset_scheduleview" id="fall_asset_scheduleview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->asset_id->Visible) { // asset_id ?>
    <tr id="r_asset_id"<?= $Page->asset_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_asset_schedule_asset_id"><?= $Page->asset_id->caption() ?></span></td>
...
<?php if ($Page->member_id->Visible) { // member_id ?>
    <tr id="r_member_id"<?= $Page->member_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_asset_schedule_member_id"><?= $Page->member_id->caption() ?></span></td>
...
<?php if ($Page->installment_all->Visible) { // installment_all ?>
    <tr id="r_installment_all"<?= $Page->installment_all->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_asset_schedule_installment_all"><?= $Page->installment_all->caption() ?></span></td>
...
<?php if ($Page->num_installment->Visible) { // num_installment ?>
    <tr id="r_num_installment"<?= $Page->num_installment->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_asset_schedule_num_installment"><?= $Page->num_installment->caption() ?></span></td>
...
<?php if ($Page->receive_per_installment_invertor->Visible) { // receive_per_installment_invertor ?>
    <tr id="r_receive_per_installment_invertor"<?= $Page->receive_per_installment_invertor->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_asset_schedule_receive_per_installment_invertor"><?= $Page->receive_per_installment_invertor->caption() ?></span></td>
...
<?php if ($Page->expired_date->Visible) { // expired_date ?>
    <tr id="r_expired_date"<?= $Page->expired_date->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_asset_schedule_expired_date"><?= $Page->expired_date->caption() ?></span></td>
...
<?php if ($Page->date_payment->Visible) { // date_payment ?>
    <tr id="r_date_payment"<?= $Page->date_payment->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_asset_schedule_date_payment"><?= $Page->date_payment->caption() ?></span></td>
...
<?php if ($Page->status_payment->Visible) { // status_payment ?>
    <tr id="r_status_payment"<?= $Page->status_payment->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_asset_schedule_status_payment"><?= $Page->status_payment->caption() ?></span></td>
...
<?php if ($Page->cdate->Visible) { // cdate ?>
    <tr id="r_cdate"<?= $Page->cdate->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_all_asset_schedule_cdate"><?= $Page->cdate->caption() ?></span></td>
        <td data-name="cdate"<?= $Page->cdate->cellAttributes() ?>>
<span id="el_all_asset_schedule_cdate">
