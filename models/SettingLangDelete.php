 ...
 * Page class
 */
class SettingLangDelete extends SettingLang
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SettingLangDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("settinglanglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("settinglanglist"); // Return to list
                return;
            }
        }
