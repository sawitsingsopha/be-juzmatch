...
/**
 * Table class for appointment
 */
class Appointment extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->status->Lookup = new Lookup('status', 'appointment', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("appointmentlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "appointmentview") {
            return $Language->phrase("View");
        } elseif ($pageName == "appointmentedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "appointmentadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("appointmentview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("appointmentview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "appointmentadd?" . $this->getUrlParm($parm);
        } else {
            $url = "appointmentadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("appointmentedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("appointmentadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("appointmentdelete", $this->getUrlParm());
    }
