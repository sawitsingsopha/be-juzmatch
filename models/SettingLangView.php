 ...
 * Page class
 */
class SettingLangView extends SettingLang
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SettingLangView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("setting_lang_id") ?? Route("setting_lang_id")) !== null) {
            $this->RecKey["setting_lang_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("setting_lang_id") ?? Route("setting_lang_id")) !== null) {
                ...
                $this->RecKey["setting_lang_id"] = $this->setting_lang_id->QueryStringValue;
            } elseif (Post("setting_lang_id") !== null) {
                $this->setting_lang_id->setFormValue(Post("setting_lang_id"));
                $this->RecKey["setting_lang_id"] = $this->setting_lang_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->setting_lang_id->setQueryStringValue($keyValue);
                $this->RecKey["setting_lang_id"] = $this->setting_lang_id->QueryStringValue;
            } else {
                $returnUrl = "settinglanglist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "settinglanglist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "settinglanglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
