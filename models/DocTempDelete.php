 ...
 * Page class
 */
class DocTempDelete extends DocTemp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocTempDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("doctemplist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("doctemplist"); // Return to list
                return;
            }
        }
