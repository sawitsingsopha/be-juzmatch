...
/**
 * Table class for seller_verify
 */
class SellerVerify extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'seller_verify';
        $this->TableName = 'seller_verify';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`seller_verify`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // seller_verify_id
        $this->seller_verify_id = new DbField(
            'seller_verify',
            'seller_verify',
            'x_seller_verify_id',
            'seller_verify_id',
        ...
        $this->seller_verify_id->InputTextType = "text";
        $this->seller_verify_id->IsAutoIncrement = true; // Autoincrement field
        $this->seller_verify_id->IsPrimaryKey = true; // Primary key field
        $this->seller_verify_id->Sortable = false; // Allow sort
        $this->seller_verify_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['seller_verify_id'] = &$this->seller_verify_id;
        ...
        $this->category_id->Lookup = new Lookup('category_id', 'category', false, 'category_id', ["category_name","","",""], [], [], [], [], [], [], '', '', "`category_name`");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`seller_verify`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->seller_verify_id->setDbValue($conn->lastInsertId());
            $rs['seller_verify_id'] = $this->seller_verify_id->DbValue;
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('seller_verify_id', $rs)) {
                AddFilter($where, QuotedName('seller_verify_id', $this->Dbid) . '=' . QuotedValue($rs['seller_verify_id'], $this->seller_verify_id->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->seller_verify_id->DbValue = $row['seller_verify_id'];
    ...
    {
        return "`seller_verify_id` = @seller_verify_id@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->seller_verify_id->CurrentValue : $this->seller_verify_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->seller_verify_id->CurrentValue = $keys[0];
            } else {
                $this->seller_verify_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('seller_verify_id', $row) ? $row['seller_verify_id'] : null;
        } else {
            $val = $this->seller_verify_id->OldValue !== null ? $this->seller_verify_id->OldValue : $this->seller_verify_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@seller_verify_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("sellerverifylist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "sellerverifyedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "sellerverifyadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "SellerVerifyView";
            case Config("API_ADD_ACTION"):
                return "SellerVerifyAdd";
            case Config("API_EDIT_ACTION"):
                return "SellerVerifyEdit";
            case Config("API_DELETE_ACTION"):
                return "SellerVerifyDelete";
            case Config("API_LIST_ACTION"):
                return "SellerVerifyList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("sellerverifyview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("sellerverifyview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "sellerverifyadd?" . $this->getUrlParm($parm);
        } else {
            $url = "sellerverifyadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("sellerverifyedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("sellerverifyadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("sellerverifydelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "\"seller_verify_id\":" . JsonEncode($this->seller_verify_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->seller_verify_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->seller_verify_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("seller_verify_id") ?? Route("seller_verify_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->seller_verify_id->CurrentValue = $key;
            } else {
                $this->seller_verify_id->OldValue = $key;
            }
    ...
    public function renderListRow()
    {
        ...
        // seller_verify_id
        $this->seller_verify_id->ViewValue = $this->seller_verify_id->CurrentValue;
        $this->seller_verify_id->ViewCustomAttributes = "";
        ...
        // seller_verify_id
        $this->seller_verify_id->LinkCustomAttributes = "";
        $this->seller_verify_id->HrefValue = "";
        $this->seller_verify_id->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // seller_verify_id
        $this->seller_verify_id->setupEditAttributes();
        $this->seller_verify_id->EditCustomAttributes = "";
        $this->seller_verify_id->EditValue = $this->seller_verify_id->CurrentValue;
        $this->seller_verify_id->ViewCustomAttributes = "";
