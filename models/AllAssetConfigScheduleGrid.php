 ...
 * Page class
 */
class AllAssetConfigScheduleGrid extends AllAssetConfigSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AllAssetConfigScheduleGrid";
    ...
    public $FormName = "fall_asset_config_schedulegrid";
