 ...
 * Page class
 */
class SaveInterestView extends SaveInterest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SaveInterestView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("save_interest_id") ?? Route("save_interest_id")) !== null) {
            $this->RecKey["save_interest_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        $this->save_interest_id->setVisibility();
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("save_interest_id") ?? Route("save_interest_id")) !== null) {
                ...
                $this->RecKey["save_interest_id"] = $this->save_interest_id->QueryStringValue;
            } elseif (Post("save_interest_id") !== null) {
                $this->save_interest_id->setFormValue(Post("save_interest_id"));
                $this->RecKey["save_interest_id"] = $this->save_interest_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->save_interest_id->setQueryStringValue($keyValue);
                $this->RecKey["save_interest_id"] = $this->save_interest_id->QueryStringValue;
            } else {
                $returnUrl = "saveinterestlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "saveinterestlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "saveinterestlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
