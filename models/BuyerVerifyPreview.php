 ...
 * Page class
 */
class BuyerVerifyPreview extends BuyerVerify
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerVerifyPreview";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("buyerverifylist"), "", $this->TableVar, true);
        $pageId = "preview";
