    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("users_id") ?? Route("users_id")) !== null) {
                ...
                $this->RecKey["users_id"] = $this->users_id->QueryStringValue;
            } elseif (Post("users_id") !== null) {
                $this->users_id->setFormValue(Post("users_id"));
                $this->RecKey["users_id"] = $this->users_id->FormValue;
