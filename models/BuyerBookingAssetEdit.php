 ...
 * Page class
 */
class BuyerBookingAssetEdit extends BuyerBookingAsset
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerBookingAssetEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("buyerbookingassetlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "buyerbookingassetlist") {
