...
/**
 * Table class for article_banner
 */
class ArticleBanner extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'article_banner';
        $this->TableName = 'article_banner';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`article_banner`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // article_banner_id
        $this->article_banner_id = new DbField(
            'article_banner',
            'article_banner',
            'x_article_banner_id',
            'article_banner_id',
        ...
        $this->article_banner_id->InputTextType = "text";
        $this->article_banner_id->IsAutoIncrement = true; // Autoincrement field
        $this->article_banner_id->IsPrimaryKey = true; // Primary key field
        $this->article_banner_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['article_banner_id'] = &$this->article_banner_id;

        // article_title
        $this->article_title = new DbField(
            'article_banner',
            'article_banner',
            'x_article_title',
            'article_title',
        ...
        $this->article_title->InputTextType = "text";
        $this->article_title->Nullable = false; // NOT NULL field
        $this->article_title->Required = true; // Required field
        $this->Fields['article_title'] = &$this->article_title;
        ...
        $this->active_status->Lookup = new Lookup('active_status', 'article_banner', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`article_banner`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->article_banner_id->setDbValue($conn->lastInsertId());
            $rs['article_banner_id'] = $this->article_banner_id->DbValue;
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('article_banner_id', $rs)) {
                AddFilter($where, QuotedName('article_banner_id', $this->Dbid) . '=' . QuotedValue($rs['article_banner_id'], $this->article_banner_id->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->article_banner_id->DbValue = $row['article_banner_id'];
        $this->article_title->DbValue = $row['article_title'];
    ...
    {
        return "`article_banner_id` = @article_banner_id@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->article_banner_id->CurrentValue : $this->article_banner_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->article_banner_id->CurrentValue = $keys[0];
            } else {
                $this->article_banner_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('article_banner_id', $row) ? $row['article_banner_id'] : null;
        } else {
            $val = $this->article_banner_id->OldValue !== null ? $this->article_banner_id->OldValue : $this->article_banner_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@article_banner_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("articlebannerlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "articlebanneredit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "articlebanneradd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "ArticleBannerAdd";
            case Config("API_EDIT_ACTION"):
                return "ArticleBannerEdit";
            case Config("API_DELETE_ACTION"):
                return "ArticleBannerDelete";
            case Config("API_LIST_ACTION"):
                return "ArticleBannerList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("articlebannerview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("articlebannerview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "articlebanneradd?" . $this->getUrlParm($parm);
        } else {
            $url = "articlebanneradd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("articlebanneredit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("articlebanneradd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("articlebannerdelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "\"article_banner_id\":" . JsonEncode($this->article_banner_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->article_banner_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->article_banner_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("article_banner_id") ?? Route("article_banner_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->article_banner_id->CurrentValue = $key;
            } else {
                $this->article_banner_id->OldValue = $key;
            }
    ...
    public function renderListRow()
    {
        ...
        // article_banner_id
        $this->article_banner_id->LinkCustomAttributes = "";
        $this->article_banner_id->HrefValue = "";
        $this->article_banner_id->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // article_banner_id
        $this->article_banner_id->setupEditAttributes();
        $this->article_banner_id->EditCustomAttributes = "";
        $this->article_banner_id->EditValue = $this->article_banner_id->CurrentValue;
        $this->article_banner_id->ViewCustomAttributes = "";
        ...
        $this->article_title->EditValue = $this->article_title->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->article_title);
                    ...
                    $doc->exportCaption($this->article_banner_id);
                    $doc->exportCaption($this->article_title);
                    $doc->exportCaption($this->image);
                    $doc->exportCaption($this->order_by);
                    $doc->exportCaption($this->active_status);
    ...
    public function getFileData($fldparm, $key, $resize, $width = 0, $height = 0, $plugins = [])
    {
        ...
        if (count($ar) == 1) {
            $this->article_banner_id->CurrentValue = $ar[0];
        } else {
