 ...
 * Page class
 */
class AllAssetScheduleAdd extends AllAssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AllAssetScheduleAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "allassetscheduleview") {
    ...
    public function pageDataRendering(&$header)
    {
        ...
        // $member_id = @$_GET['fk_member_id'];

        // $sql_installment_latest = "SELECT asset_schedule_id,COUNT(num_installment)+1 as num_installment_latest FROM `asset_schedule` WHERE member_id = ".$member_id." AND asset_id = ".$asset_id;
        // $res_installment_latest = ExecuteRow($sql_installment_latest);

        // $installment_latest = $res_installment_latest['num_installment_latest'];

        // // Set installment_latest
        // $this->num_installment->setDbValue($installment_latest);

        // ///////////////////////////////////////////////////////

        // $sql_installment_price = "SELECT * FROM `asset_config_schedule` WHERE member_id = ".$member_id." AND asset_id =".$asset_id;
        // $res_installment_price = ExecuteRow($sql_installment_price);

        // $installment_price = $res_installment_price['installment_price_per'];

        // // Set installment_price
        // $this->installment_per_price->setDbValue($installment_price);
    }
