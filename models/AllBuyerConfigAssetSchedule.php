...
/**
 * Table class for all_buyer_config_asset_schedule
 */
class AllBuyerConfigAssetSchedule extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'all_buyer_config_asset_schedule';
        $this->TableName = 'all_buyer_config_asset_schedule';
        ...
        $this->move_in_on_20th->Lookup = new Lookup('move_in_on_20th', 'all_buyer_config_asset_schedule', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->status_approve->Lookup = new Lookup('status_approve', 'all_buyer_config_asset_schedule', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    public function getDetailUrl()
    {
        ...
        if ($detailUrl == "") {
            $detailUrl = "allbuyerconfigassetschedulelist";
        }
        return $detailUrl;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("allbuyerconfigassetschedulelist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "allbuyerconfigassetscheduleedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "allbuyerconfigassetscheduleadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AllBuyerConfigAssetScheduleView";
            case Config("API_ADD_ACTION"):
                return "AllBuyerConfigAssetScheduleAdd";
            case Config("API_EDIT_ACTION"):
                return "AllBuyerConfigAssetScheduleEdit";
            case Config("API_DELETE_ACTION"):
                return "AllBuyerConfigAssetScheduleDelete";
            case Config("API_LIST_ACTION"):
                return "AllBuyerConfigAssetScheduleList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("allbuyerconfigassetscheduleview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("allbuyerconfigassetscheduleview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "allbuyerconfigassetscheduleadd?" . $this->getUrlParm($parm);
        } else {
            $url = "allbuyerconfigassetscheduleadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("allbuyerconfigassetscheduleedit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("allbuyerconfigassetscheduleedit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("allbuyerconfigassetscheduleadd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("allbuyerconfigassetscheduleadd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("allbuyerconfigassetscheduledelete", $this->getUrlParm());
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->annual_interest);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->annual_interest);
    ...
    public function rowInserting($rsold, &$rsnew)
    {
        ...
        // [booking_price] => 5000 
        // [down_price] => 123456 
        // [installment_price_per] => 12500 
        // [annual_interest] => 4.5 
        // [number_days_pay_first_month] => 0 
        // [number_days_in_first_month] => 31 
        // date_start_installment

        $asset_id = $rsnew['asset_id'];
        $member_id = $rsnew['member_id'];

        $sql_check_scb = "SELECT * FROM `member_scb` WHERE member_id = ".$member_id." AND asset_id = ".$asset_id." ORDER BY member_scb_id DESC LIMIT 0,1";
        $rs_check = ExecuteRow($sql_check_scb);

        if (count($rs_check) <= 0) {
            return true;
        } else {
            $down_price = $rsnew['down_price'];
            $installment_price_per = $rsnew['installment_price_per'];
            $installment_all = $rsnew['installment_all'];
            $date_start_installment = $rsnew['date_start_installment'];
            ...
            // Update member scb
            $update_schedule = "UPDATE `member_scb` SET `udate`='".$udate."', `uuser`= ".$uuser.", `uip`='".$uip."', `decision_status`='".$decision_status."', `decision_timestamp`='".$udate."', `deposit_amount`= ".$down_price.", `due_date`= '".$date_start_installment."', `rental_fee`= ".$installment_price_per.", `rental_period` = ".$installment_all." WHERE member_id = ".$member_id." AND asset_id = ".$asset_id."";
            ExecuteStatement($update_schedule);
    ...
    public function rowUpdating($rsold, &$rsnew)
    {
        ...
        if (count($rs_check) <= 0) {
            ...
            $down_price = $rsold['down_price'];
            $installment_price_per = $rsold['installment_price_per'];
            $installment_all = $rsold['installment_all'];
            $date_start_installment = $rsold['date_start_installment'];
