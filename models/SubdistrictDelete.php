 ...
 * Page class
 */
class SubdistrictDelete extends Subdistrict
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubdistrictDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("subdistrictlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("subdistrictlist"); // Return to list
                return;
            }
        }
