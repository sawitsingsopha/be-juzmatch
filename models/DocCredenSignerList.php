 ...
 * Page class
 */
class DocCredenSignerList extends DocCredenSigner
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocCredenSignerList";
    ...
    public $FormName = "fdoc_creden_signerlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "doccredensigneradd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "doccredensignerdelete";
        $this->MultiUpdateUrl = "doccredensignerupdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fdoc_creden_signersrch");
        }
        $filterList = Concat($filterList, $this->doc_creden_signer_id->AdvancedSearch->toJson(), ","); // Field doc_creden_signer_id
        $filterList = Concat($filterList, $this->doc_creden_id->AdvancedSearch->toJson(), ","); // Field doc_creden_id
        $filterList = Concat($filterList, $this->doc_creden_signer_no->AdvancedSearch->toJson(), ","); // Field doc_creden_signer_no
        $filterList = Concat($filterList, $this->doc_creden_signer_link->AdvancedSearch->toJson(), ","); // Field doc_creden_signer_link
        $filterList = Concat($filterList, $this->doc_creden_signer_session->AdvancedSearch->toJson(), ","); // Field doc_creden_signer_session
        $filterList = Concat($filterList, $this->doc_creden_signer_name->AdvancedSearch->toJson(), ","); // Field doc_creden_signer_name
        $filterList = Concat($filterList, $this->doc_creden_signer_email->AdvancedSearch->toJson(), ","); // Field doc_creden_signer_email
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fdoc_creden_signersrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field doc_creden_signer_id
        $this->doc_creden_signer_id->AdvancedSearch->SearchValue = @$filter["x_doc_creden_signer_id"];
        $this->doc_creden_signer_id->AdvancedSearch->SearchOperator = @$filter["z_doc_creden_signer_id"];
        $this->doc_creden_signer_id->AdvancedSearch->SearchCondition = @$filter["v_doc_creden_signer_id"];
        $this->doc_creden_signer_id->AdvancedSearch->SearchValue2 = @$filter["y_doc_creden_signer_id"];
        $this->doc_creden_signer_id->AdvancedSearch->SearchOperator2 = @$filter["w_doc_creden_signer_id"];
        $this->doc_creden_signer_id->AdvancedSearch->save();

        // Field doc_creden_id
        $this->doc_creden_id->AdvancedSearch->SearchValue = @$filter["x_doc_creden_id"];
        $this->doc_creden_id->AdvancedSearch->SearchOperator = @$filter["z_doc_creden_id"];
        $this->doc_creden_id->AdvancedSearch->SearchCondition = @$filter["v_doc_creden_id"];
        $this->doc_creden_id->AdvancedSearch->SearchValue2 = @$filter["y_doc_creden_id"];
        $this->doc_creden_id->AdvancedSearch->SearchOperator2 = @$filter["w_doc_creden_id"];
        $this->doc_creden_id->AdvancedSearch->save();

        // Field doc_creden_signer_no
        $this->doc_creden_signer_no->AdvancedSearch->SearchValue = @$filter["x_doc_creden_signer_no"];
        $this->doc_creden_signer_no->AdvancedSearch->SearchOperator = @$filter["z_doc_creden_signer_no"];
        $this->doc_creden_signer_no->AdvancedSearch->SearchCondition = @$filter["v_doc_creden_signer_no"];
        $this->doc_creden_signer_no->AdvancedSearch->SearchValue2 = @$filter["y_doc_creden_signer_no"];
        $this->doc_creden_signer_no->AdvancedSearch->SearchOperator2 = @$filter["w_doc_creden_signer_no"];
        $this->doc_creden_signer_no->AdvancedSearch->save();

        // Field doc_creden_signer_link
        $this->doc_creden_signer_link->AdvancedSearch->SearchValue = @$filter["x_doc_creden_signer_link"];
        $this->doc_creden_signer_link->AdvancedSearch->SearchOperator = @$filter["z_doc_creden_signer_link"];
        $this->doc_creden_signer_link->AdvancedSearch->SearchCondition = @$filter["v_doc_creden_signer_link"];
        $this->doc_creden_signer_link->AdvancedSearch->SearchValue2 = @$filter["y_doc_creden_signer_link"];
        $this->doc_creden_signer_link->AdvancedSearch->SearchOperator2 = @$filter["w_doc_creden_signer_link"];
        $this->doc_creden_signer_link->AdvancedSearch->save();

        // Field doc_creden_signer_session
        $this->doc_creden_signer_session->AdvancedSearch->SearchValue = @$filter["x_doc_creden_signer_session"];
        $this->doc_creden_signer_session->AdvancedSearch->SearchOperator = @$filter["z_doc_creden_signer_session"];
        $this->doc_creden_signer_session->AdvancedSearch->SearchCondition = @$filter["v_doc_creden_signer_session"];
        $this->doc_creden_signer_session->AdvancedSearch->SearchValue2 = @$filter["y_doc_creden_signer_session"];
        $this->doc_creden_signer_session->AdvancedSearch->SearchOperator2 = @$filter["w_doc_creden_signer_session"];
        $this->doc_creden_signer_session->AdvancedSearch->save();

        // Field doc_creden_signer_name
        $this->doc_creden_signer_name->AdvancedSearch->SearchValue = @$filter["x_doc_creden_signer_name"];
        $this->doc_creden_signer_name->AdvancedSearch->SearchOperator = @$filter["z_doc_creden_signer_name"];
        $this->doc_creden_signer_name->AdvancedSearch->SearchCondition = @$filter["v_doc_creden_signer_name"];
        $this->doc_creden_signer_name->AdvancedSearch->SearchValue2 = @$filter["y_doc_creden_signer_name"];
        $this->doc_creden_signer_name->AdvancedSearch->SearchOperator2 = @$filter["w_doc_creden_signer_name"];
        $this->doc_creden_signer_name->AdvancedSearch->save();

        // Field doc_creden_signer_email
        $this->doc_creden_signer_email->AdvancedSearch->SearchValue = @$filter["x_doc_creden_signer_email"];
        $this->doc_creden_signer_email->AdvancedSearch->SearchOperator = @$filter["z_doc_creden_signer_email"];
        $this->doc_creden_signer_email->AdvancedSearch->SearchCondition = @$filter["v_doc_creden_signer_email"];
        $this->doc_creden_signer_email->AdvancedSearch->SearchValue2 = @$filter["y_doc_creden_signer_email"];
        $this->doc_creden_signer_email->AdvancedSearch->SearchOperator2 = @$filter["w_doc_creden_signer_email"];
        $this->doc_creden_signer_email->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->doc_creden_signer_link;
        $searchFlds[] = &$this->doc_creden_signer_session;
        $searchFlds[] = &$this->doc_creden_signer_name;
        $searchFlds[] = &$this->doc_creden_signer_email;
        $searchFlds[] = &$this->cip;
        $searchFlds[] = &$this->uip;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->doc_creden_signer_id, $ctrl); // doc_creden_signer_id
            $this->updateSort($this->doc_creden_id, $ctrl); // doc_creden_id
            $this->updateSort($this->doc_creden_signer_no, $ctrl); // doc_creden_signer_no
            $this->updateSort($this->doc_creden_signer_link, $ctrl); // doc_creden_signer_link
            $this->updateSort($this->doc_creden_signer_session, $ctrl); // doc_creden_signer_session
            $this->updateSort($this->doc_creden_signer_name, $ctrl); // doc_creden_signer_name
            $this->updateSort($this->doc_creden_signer_email, $ctrl); // doc_creden_signer_email
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->doc_creden_signer_id->setSort("");
                $this->doc_creden_id->setSort("");
                $this->doc_creden_signer_no->setSort("");
                $this->doc_creden_signer_link->setSort("");
                $this->doc_creden_signer_session->setSort("");
                $this->doc_creden_signer_name->setSort("");
                $this->doc_creden_signer_email->setSort("");
                $this->status->setSort("");
                $this->cdate->setSort("");
                $this->cuser->setSort("");
                $this->cip->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fdoc_creden_signerlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fdoc_creden_signerlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->doc_creden_signer_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("doc_creden_signer_id", $this->createColumnOption("doc_creden_signer_id"));
            $option->add("doc_creden_id", $this->createColumnOption("doc_creden_id"));
            $option->add("doc_creden_signer_no", $this->createColumnOption("doc_creden_signer_no"));
            $option->add("doc_creden_signer_link", $this->createColumnOption("doc_creden_signer_link"));
            $option->add("doc_creden_signer_session", $this->createColumnOption("doc_creden_signer_session"));
            $option->add("doc_creden_signer_name", $this->createColumnOption("doc_creden_signer_name"));
            $option->add("doc_creden_signer_email", $this->createColumnOption("doc_creden_signer_email"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fdoc_creden_signersrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdoc_creden_signersrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fdoc_creden_signerlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fdoc_creden_signerlist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fdoc_creden_signersrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
