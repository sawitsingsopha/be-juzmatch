 ...
 * Page class
 */
class AssetSchedulePreview extends AssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetSchedulePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "inverter_asset") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=inverter_asset&" . GetForeignKeyUrl("fk_member_id", $this->member_id->QueryStringValue) . "&" . GetForeignKeyUrl("fk_asset_id", $this->asset_id->QueryStringValue) . "";
        }
        return $url;
    }
