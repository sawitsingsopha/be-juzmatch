 ...
 * Page class
 */
class MemberScbDetailLogDelete extends MemberScbDetailLog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MemberScbDetailLogDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("memberscbdetailloglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("memberscbdetailloglist"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['member_scb_detail_log_id'];
