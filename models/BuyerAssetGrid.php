 ...
 * Page class
 */
class BuyerAssetGrid extends BuyerAsset
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerAssetGrid";
    ...
    public $FormName = "fbuyer_assetgrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->buyer_booking_asset_id->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_due_date") && $CurrentForm->hasValue("o_due_date") && $this->due_date->CurrentValue != $this->due_date->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->due_date->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_due_date")) {
            $this->due_date->setOldValue($CurrentForm->getValue("o_due_date"));
        }
        ...
        if (!$this->buyer_booking_asset_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['buyer_booking_asset_id'];
