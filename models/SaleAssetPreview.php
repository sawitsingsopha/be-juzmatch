 ...
 * Page class
 */
class SaleAssetPreview extends SaleAsset
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SaleAssetPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "seller") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=seller&" . GetForeignKeyUrl("fk_member_id", $this->member_id->QueryStringValue) . "";
        }
        return $url;
    }
