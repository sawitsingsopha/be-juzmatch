...
class AddressGrid extends Address
{
    ...
    public function run()
    {
        ...
        $this->address_id->Visible = false;
        $this->address_type->Visible = false;
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_province_id") && $CurrentForm->hasValue("o_province_id") && $this->province_id->CurrentValue != $this->province_id->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_amphur_id") && $CurrentForm->hasValue("o_amphur_id") && $this->amphur_id->CurrentValue != $this->amphur_id->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_district_id") && $CurrentForm->hasValue("o_district_id") && $this->district_id->CurrentValue != $this->district_id->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_postcode") && $CurrentForm->hasValue("o_postcode") && $this->postcode->CurrentValue != $this->postcode->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->province_id->clearErrorMessage();
        $this->amphur_id->clearErrorMessage();
        $this->district_id->clearErrorMessage();
        $this->postcode->clearErrorMessage();
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->address_type->CurrentValue = null;
        $this->address_type->OldValue = $this->address_type->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_province_id")) {
            $this->province_id->setOldValue($CurrentForm->getValue("o_province_id"));
        }
        ...
        if ($CurrentForm->hasValue("o_amphur_id")) {
            $this->amphur_id->setOldValue($CurrentForm->getValue("o_amphur_id"));
        }
        ...
        if ($CurrentForm->hasValue("o_district_id")) {
            $this->district_id->setOldValue($CurrentForm->getValue("o_district_id"));
        }
        ...
        if ($CurrentForm->hasValue("o_postcode")) {
            $this->postcode->setOldValue($CurrentForm->getValue("o_postcode"));
        }
    ...
    protected function newRow()
    {
        ...
        $row['address_type'] = $this->address_type->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        // address_type
        $this->address_type->CellCssStyle = "white-space: nowrap;";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // amphur_id
            $this->amphur_id->setDbValueDef($rsnew, $this->amphur_id->CurrentValue, 0, $this->amphur_id->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // amphur_id
        $this->amphur_id->setDbValueDef($rsnew, $this->amphur_id->CurrentValue, 0, false);
