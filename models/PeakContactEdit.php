 ...
 * Page class
 */
class PeakContactEdit extends PeakContact
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakContactEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // create_date
            $this->create_date->setDbValueDef($rsnew, UnFormatDateTime($this->create_date->CurrentValue, $this->create_date->formatPattern()), null, $this->create_date->ReadOnly);

            // request_status
            $this->request_status->setDbValueDef($rsnew, $this->request_status->CurrentValue, null, $this->request_status->ReadOnly);

            // request_date
            $this->request_date->setDbValueDef($rsnew, UnFormatDateTime($this->request_date->CurrentValue, $this->request_date->formatPattern()), null, $this->request_date->ReadOnly);

            // request_message
            $this->request_message->setDbValueDef($rsnew, $this->request_message->CurrentValue, null, $this->request_message->ReadOnly);

            // contact_id
            $this->contact_id->setDbValueDef($rsnew, $this->contact_id->CurrentValue, null, $this->contact_id->ReadOnly);

            // contact_code
            $this->contact_code->setDbValueDef($rsnew, $this->contact_code->CurrentValue, null, $this->contact_code->ReadOnly);
            ...
            // contact_taxnumber
            $this->contact_taxnumber->setDbValueDef($rsnew, $this->contact_taxnumber->CurrentValue, null, $this->contact_taxnumber->ReadOnly);

            // contact_branchcode
            $this->contact_branchcode->setDbValueDef($rsnew, $this->contact_branchcode->CurrentValue, null, $this->contact_branchcode->ReadOnly);

            // contact_address
            $this->contact_address->setDbValueDef($rsnew, $this->contact_address->CurrentValue, null, $this->contact_address->ReadOnly);

            // contact_subdistrict
            $this->contact_subdistrict->setDbValueDef($rsnew, $this->contact_subdistrict->CurrentValue, null, $this->contact_subdistrict->ReadOnly);

            // contact_district
            $this->contact_district->setDbValueDef($rsnew, $this->contact_district->CurrentValue, null, $this->contact_district->ReadOnly);

            // contact_province
            $this->contact_province->setDbValueDef($rsnew, $this->contact_province->CurrentValue, null, $this->contact_province->ReadOnly);

            // contact_country
            $this->contact_country->setDbValueDef($rsnew, $this->contact_country->CurrentValue, null, $this->contact_country->ReadOnly);

            // contact_postcode
            $this->contact_postcode->setDbValueDef($rsnew, $this->contact_postcode->CurrentValue, null, $this->contact_postcode->ReadOnly);

            // contact_callcenternumber
            $this->contact_callcenternumber->setDbValueDef($rsnew, $this->contact_callcenternumber->CurrentValue, null, $this->contact_callcenternumber->ReadOnly);

            // contact_faxnumber
            $this->contact_faxnumber->setDbValueDef($rsnew, $this->contact_faxnumber->CurrentValue, null, $this->contact_faxnumber->ReadOnly);

            // contact_email
            $this->contact_email->setDbValueDef($rsnew, $this->contact_email->CurrentValue, null, $this->contact_email->ReadOnly);

            // contact_website
            $this->contact_website->setDbValueDef($rsnew, $this->contact_website->CurrentValue, null, $this->contact_website->ReadOnly);

            // contact_contactfirstname
            $this->contact_contactfirstname->setDbValueDef($rsnew, $this->contact_contactfirstname->CurrentValue, null, $this->contact_contactfirstname->ReadOnly);

            // contact_contactlastname
            $this->contact_contactlastname->setDbValueDef($rsnew, $this->contact_contactlastname->CurrentValue, null, $this->contact_contactlastname->ReadOnly);

            // contact_contactnickname
            $this->contact_contactnickname->setDbValueDef($rsnew, $this->contact_contactnickname->CurrentValue, null, $this->contact_contactnickname->ReadOnly);

            // contact_contactpostition
            $this->contact_contactpostition->setDbValueDef($rsnew, $this->contact_contactpostition->CurrentValue, null, $this->contact_contactpostition->ReadOnly);

            // contact_contactphonenumber
            $this->contact_contactphonenumber->setDbValueDef($rsnew, $this->contact_contactphonenumber->CurrentValue, null, $this->contact_contactphonenumber->ReadOnly);

            // contact_contactcontactemail
            $this->contact_contactcontactemail->setDbValueDef($rsnew, $this->contact_contactcontactemail->CurrentValue, null, $this->contact_contactcontactemail->ReadOnly);

            // contact_purchaseaccount
            $this->contact_purchaseaccount->setDbValueDef($rsnew, $this->contact_purchaseaccount->CurrentValue, null, $this->contact_purchaseaccount->ReadOnly);

            // contact_sellaccount
            $this->contact_sellaccount->setDbValueDef($rsnew, $this->contact_sellaccount->CurrentValue, null, $this->contact_sellaccount->ReadOnly);

            // member_id
            $this->member_id->setDbValueDef($rsnew, $this->member_id->CurrentValue, 0, $this->member_id->ReadOnly);
