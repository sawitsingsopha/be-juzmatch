 ...
 * Page class
 */
class AssetScheduleDelete extends AssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetScheduleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("assetschedulelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("assetschedulelist"); // Return to list
                return;
            }
        }
