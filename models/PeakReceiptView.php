 ...
 * Page class
 */
class PeakReceiptView extends PeakReceipt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakReceiptView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "peakreceiptlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "peakreceiptlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "peakreceiptlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
