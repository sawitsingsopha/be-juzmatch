 ...
 * Page class
 */
class AssetFacilitiesDelete extends AssetFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetFacilitiesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("assetfacilitieslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("assetfacilitieslist"); // Return to list
                return;
            }
        }
