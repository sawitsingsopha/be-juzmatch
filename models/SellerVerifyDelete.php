 ...
 * Page class
 */
class SellerVerifyDelete extends SellerVerify
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SellerVerifyDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("sellerverifylist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("sellerverifylist"); // Return to list
                return;
            }
        }
