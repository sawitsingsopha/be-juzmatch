...
/**
 * Table class for pipedrive_req_log
 */
class PipedriveReqLog extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pipedrive_req_log';
        $this->TableName = 'pipedrive_req_log';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`pipedrive_req_log`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`pipedrive_req_log`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("pipedrivereqloglist");
    }
    ...
    {
        global $Language;
        if ($pageName == "pipedrivereqlogview") {
            return $Language->phrase("View");
        } elseif ($pageName == "pipedrivereqlogedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "pipedrivereqlogadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PipedriveReqLogView";
            case Config("API_ADD_ACTION"):
                return "PipedriveReqLogAdd";
            case Config("API_EDIT_ACTION"):
                return "PipedriveReqLogEdit";
            case Config("API_DELETE_ACTION"):
                return "PipedriveReqLogDelete";
            case Config("API_LIST_ACTION"):
                return "PipedriveReqLogList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("pipedrivereqlogview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("pipedrivereqlogview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "pipedrivereqlogadd?" . $this->getUrlParm($parm);
        } else {
            $url = "pipedrivereqlogadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pipedrivereqlogedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pipedrivereqlogadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("pipedrivereqlogdelete", $this->getUrlParm());
    }
