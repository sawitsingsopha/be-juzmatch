 ...
 * Page class
 */
class CredenLogDelete extends CredenLog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CredenLogDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("credenloglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("credenloglist"); // Return to list
                return;
            }
        }
