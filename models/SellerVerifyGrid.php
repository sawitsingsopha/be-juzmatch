 ...
 * Page class
 */
class SellerVerifyGrid extends SellerVerify
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SellerVerifyGrid";
    ...
    public $FormName = "fseller_verifygrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->seller_verify_id->CurrentValue;
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->seller_verify_id->OldValue = $this->seller_verify_id->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->seller_verify_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['seller_verify_id'] = $this->seller_verify_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'seller_verify'
