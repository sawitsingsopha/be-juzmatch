 ...
 * Page class
 */
class BuyerAssetScheduleView extends BuyerAssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerAssetScheduleView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("buyer_asset_schedule_id") ?? Route("buyer_asset_schedule_id")) !== null) {
                ...
                $returnUrl = "buyerassetschedulelist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "buyerassetschedulelist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "buyerassetschedulelist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
