...
/**
 * Table class for number_deals_available
 */
class NumberDealsAvailable extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'number_deals_available';
        $this->TableName = 'number_deals_available';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`number_deals_available`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    public function getDetailUrl()
    {
        ...
        if ($detailUrl == "") {
            $detailUrl = "numberdealsavailablelist";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`number_deals_available`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("numberdealsavailablelist");
    }
    ...
    {
        global $Language;
        if ($pageName == "numberdealsavailableview") {
            return $Language->phrase("View");
        } elseif ($pageName == "numberdealsavailableedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "numberdealsavailableadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "NumberDealsAvailableView";
            case Config("API_ADD_ACTION"):
                return "NumberDealsAvailableAdd";
            case Config("API_EDIT_ACTION"):
                return "NumberDealsAvailableEdit";
            case Config("API_DELETE_ACTION"):
                return "NumberDealsAvailableDelete";
            case Config("API_LIST_ACTION"):
                return "NumberDealsAvailableList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("numberdealsavailableview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("numberdealsavailableview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "numberdealsavailableadd?" . $this->getUrlParm($parm);
        } else {
            $url = "numberdealsavailableadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("numberdealsavailableedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("numberdealsavailableadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("numberdealsavailabledelete", $this->getUrlParm());
    }
