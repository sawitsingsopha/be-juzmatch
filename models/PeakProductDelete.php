 ...
 * Page class
 */
class PeakProductDelete extends PeakProduct
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakProductDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("peakproductlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("peakproductlist"); // Return to list
                return;
            }
        }
