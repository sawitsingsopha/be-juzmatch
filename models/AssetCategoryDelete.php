 ...
 * Page class
 */
class AssetCategoryDelete extends AssetCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetCategoryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("assetcategorylist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("assetcategorylist"); // Return to list
                return;
            }
        }
