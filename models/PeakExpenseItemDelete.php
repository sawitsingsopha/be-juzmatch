 ...
 * Page class
 */
class PeakExpenseItemDelete extends PeakExpenseItem
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakExpenseItemDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("peakexpenseitemlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("peakexpenseitemlist"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['peak_expense_item_id'];
