 ...
 * Page class
 */
class SettingLangList extends SettingLang
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SettingLangList";
    ...
    public $FormName = "fsetting_langlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "settinglangadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "settinglangdelete";
        $this->MultiUpdateUrl = "settinglangupdate";
    ...
    public function run()
    {
        ...
        $this->setting_lang_id->setVisibility();
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fsetting_langsrch");
        }
        $filterList = Concat($filterList, $this->setting_lang_id->AdvancedSearch->toJson(), ","); // Field setting_lang_id
        $filterList = Concat($filterList, $this->lang_en->AdvancedSearch->toJson(), ","); // Field lang_en
        $filterList = Concat($filterList, $this->lang->AdvancedSearch->toJson(), ","); // Field lang
        $filterList = Concat($filterList, $this->_param->AdvancedSearch->toJson(), ","); // Field param
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fsetting_langsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field setting_lang_id
        $this->setting_lang_id->AdvancedSearch->SearchValue = @$filter["x_setting_lang_id"];
        $this->setting_lang_id->AdvancedSearch->SearchOperator = @$filter["z_setting_lang_id"];
        $this->setting_lang_id->AdvancedSearch->SearchCondition = @$filter["v_setting_lang_id"];
        $this->setting_lang_id->AdvancedSearch->SearchValue2 = @$filter["y_setting_lang_id"];
        $this->setting_lang_id->AdvancedSearch->SearchOperator2 = @$filter["w_setting_lang_id"];
        $this->setting_lang_id->AdvancedSearch->save();

        // Field lang_en
        $this->lang_en->AdvancedSearch->SearchValue = @$filter["x_lang_en"];
        $this->lang_en->AdvancedSearch->SearchOperator = @$filter["z_lang_en"];
        $this->lang_en->AdvancedSearch->SearchCondition = @$filter["v_lang_en"];
        $this->lang_en->AdvancedSearch->SearchValue2 = @$filter["y_lang_en"];
        $this->lang_en->AdvancedSearch->SearchOperator2 = @$filter["w_lang_en"];
        $this->lang_en->AdvancedSearch->save();
        ...
        // Field param
        $this->_param->AdvancedSearch->SearchValue = @$filter["x__param"];
        $this->_param->AdvancedSearch->SearchOperator = @$filter["z__param"];
        $this->_param->AdvancedSearch->SearchCondition = @$filter["v__param"];
        $this->_param->AdvancedSearch->SearchValue2 = @$filter["y__param"];
        $this->_param->AdvancedSearch->SearchOperator2 = @$filter["w__param"];
        $this->_param->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->lang_en;
        $searchFlds[] = &$this->lang;
        $searchFlds[] = &$this->_param;
        $searchFlds[] = &$this->cip;
        $searchFlds[] = &$this->uip;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->setting_lang_id, $ctrl); // setting_lang_id
            $this->updateSort($this->lang_en, $ctrl); // lang_en
            $this->updateSort($this->lang, $ctrl); // lang
            $this->updateSort($this->_param, $ctrl); // param
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->setting_lang_id->setSort("");
                $this->lang_en->setSort("");
                $this->lang->setSort("");
                $this->_param->setSort("");
                $this->cip->setSort("");
                $this->udate->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fsetting_langlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fsetting_langlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->setting_lang_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("setting_lang_id", $this->createColumnOption("setting_lang_id"));
            $option->add("lang_en", $this->createColumnOption("lang_en"));
            $option->add("lang", $this->createColumnOption("lang"));
            $option->add("param", $this->createColumnOption("param"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fsetting_langsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fsetting_langsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fsetting_langlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // setting_lang_id
            $this->setting_lang_id->LinkCustomAttributes = "";
            $this->setting_lang_id->HrefValue = "";
            $this->setting_lang_id->TooltipValue = "";

            // lang_en
            $this->lang_en->LinkCustomAttributes = "";
            $this->lang_en->HrefValue = "";
            $this->lang_en->TooltipValue = "";
            if (!$this->isExport()) {
                $this->lang_en->ViewValue = $this->highlightValue($this->lang_en);
            }
            ...
            $this->_param->TooltipValue = "";
            if (!$this->isExport()) {
                $this->_param->ViewValue = $this->highlightValue($this->_param);
            }
            ...
            if (!$this->isExport()) {
                $this->uip->ViewValue = $this->highlightValue($this->uip);
            }
            ...
            if (!$this->isExport()) {
                $this->uuser->ViewValue = $this->highlightValue($this->uuser);
            }
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fsetting_langlist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fsetting_langsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        $item->Body = "<a class=\"btn btn-default ew-highlight active\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-ew-action=\"highlight\" data-form=\"fsetting_langsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
