 ...
 * Page class
 */
class InvertorBookingDelete extends InvertorBooking
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvertorBookingDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("invertorbookinglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("invertorbookinglist"); // Return to list
                return;
            }
        }
