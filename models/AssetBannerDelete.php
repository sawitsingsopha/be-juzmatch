 ...
 * Page class
 */
class AssetBannerDelete extends AssetBanner
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetBannerDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("assetbannerlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("assetbannerlist"); // Return to list
                return;
            }
        }
