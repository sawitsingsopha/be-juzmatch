...
/**
 * Table class for attribute_category
 */
class AttributeCategory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'attribute_category';
        $this->TableName = 'attribute_category';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`attribute_category`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->attribute_category_id = new DbField(
            'attribute_category',
            'attribute_category',
            'x_attribute_category_id',
            'attribute_category_id',
            '`attribute_category_id`',
            '`attribute_category_id`',
            3,
        ...
        $this->attribute_category_id->InputTextType = "text";
        $this->attribute_category_id->IsAutoIncrement = true; // Autoincrement field
        $this->attribute_category_id->IsPrimaryKey = true; // Primary key field
        $this->attribute_category_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['attribute_category_id'] = &$this->attribute_category_id;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`attribute_category`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->attribute_category_id->setDbValue($conn->lastInsertId());
            $rs['attribute_category_id'] = $this->attribute_category_id->DbValue;
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('attribute_category_id', $rs)) {
                AddFilter($where, QuotedName('attribute_category_id', $this->Dbid) . '=' . QuotedValue($rs['attribute_category_id'], $this->attribute_category_id->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->attribute_category_id->DbValue = $row['attribute_category_id'];
    ...
    {
        return "`attribute_category_id` = @attribute_category_id@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->attribute_category_id->CurrentValue : $this->attribute_category_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->attribute_category_id->CurrentValue = $keys[0];
            } else {
                $this->attribute_category_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('attribute_category_id', $row) ? $row['attribute_category_id'] : null;
        } else {
            $val = $this->attribute_category_id->OldValue !== null ? $this->attribute_category_id->OldValue : $this->attribute_category_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@attribute_category_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("attributecategorylist");
    }
    ...
    {
        global $Language;
        if ($pageName == "attributecategoryview") {
            return $Language->phrase("View");
        } elseif ($pageName == "attributecategoryedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "attributecategoryadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_EDIT_ACTION"):
                return "AttributeCategoryEdit";
            case Config("API_DELETE_ACTION"):
                return "AttributeCategoryDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("attributecategoryview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("attributecategoryview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "attributecategoryadd?" . $this->getUrlParm($parm);
        } else {
            $url = "attributecategoryadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("attributecategoryedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("attributecategoryadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("attributecategorydelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "\"attribute_category_id\":" . JsonEncode($this->attribute_category_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->attribute_category_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->attribute_category_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("attribute_category_id") ?? Route("attribute_category_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->attribute_category_id->CurrentValue = $key;
            } else {
                $this->attribute_category_id->OldValue = $key;
            }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->attribute_category_id->setDbValue($row['attribute_category_id']);
    ...
    public function renderListRow()
    {
        ...
        // attribute_category_id
        $this->attribute_category_id->ViewValue = $this->attribute_category_id->CurrentValue;
        $this->attribute_category_id->ViewCustomAttributes = "";
        ...
        // attribute_category_id
        $this->attribute_category_id->LinkCustomAttributes = "";
        $this->attribute_category_id->HrefValue = "";
        $this->attribute_category_id->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // attribute_category_id
        $this->attribute_category_id->setupEditAttributes();
        $this->attribute_category_id->EditCustomAttributes = "";
        $this->attribute_category_id->EditValue = $this->attribute_category_id->CurrentValue;
        $this->attribute_category_id->ViewCustomAttributes = "";
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->attribute_category_id);
        ...
        while (!$recordset->EOF && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->attribute_category_id);
