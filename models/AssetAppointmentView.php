 ...
 * Page class
 */
class AssetAppointmentView extends AssetAppointment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetAppointmentView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("appointment_id") ?? Route("appointment_id")) !== null) {
                ...
                $returnUrl = "assetappointmentlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "assetappointmentlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "assetappointmentlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
