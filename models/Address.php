...
class Address extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->address_type->InputTextType = "text";
        $this->address_type->Sortable = false; // Allow sort
        $this->address_type->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['address_type'] = &$this->address_type;
        ...
        $this->amphur_id->Nullable = false; // NOT NULL field
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->address_type->DbValue = $row['address_type'];
    ...
    public function renderListRow()
    {
        ...
        $this->address_type->ViewValue = FormatNumber($this->address_type->ViewValue, $this->address_type->formatPattern());
    ...
    public function renderEditRow()
    {
        ...
        // address_type
        $this->address_type->setupEditAttributes();
        $this->address_type->EditCustomAttributes = "";
        $this->address_type->EditValue = $this->address_type->CurrentValue;
        $this->address_type->PlaceHolder = RemoveHtml($this->address_type->caption());
        if (strval($this->address_type->EditValue) != "" && is_numeric($this->address_type->EditValue)) {
            $this->address_type->EditValue = FormatNumber($this->address_type->EditValue, null);
        }
