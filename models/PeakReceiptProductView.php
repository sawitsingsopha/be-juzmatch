 ...
 * Page class
 */
class PeakReceiptProductView extends PeakReceiptProduct
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakReceiptProductView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "peakreceiptproductlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "peakreceiptproductlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "peakreceiptproductlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
