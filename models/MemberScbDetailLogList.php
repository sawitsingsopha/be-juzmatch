 ...
 * Page class
 */
class MemberScbDetailLogList extends MemberScbDetailLog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MemberScbDetailLogList";
    ...
    public $FormName = "fmember_scb_detail_loglist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "memberscbdetaillogadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "memberscbdetaillogdelete";
        $this->MultiUpdateUrl = "memberscbdetaillogupdate";
    ...
    public function run()
    {
        ...
        $this->member_scb_detail_log_id->setVisibility();
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fmember_scb_detail_logsrch");
        }
        $filterList = Concat($filterList, $this->member_scb_detail_log_id->AdvancedSearch->toJson(), ","); // Field member_scb_detail_log_id
        $filterList = Concat($filterList, $this->member_scb_id->AdvancedSearch->toJson(), ","); // Field member_scb_id
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fmember_scb_detail_logsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field member_scb_detail_log_id
        $this->member_scb_detail_log_id->AdvancedSearch->SearchValue = @$filter["x_member_scb_detail_log_id"];
        $this->member_scb_detail_log_id->AdvancedSearch->SearchOperator = @$filter["z_member_scb_detail_log_id"];
        $this->member_scb_detail_log_id->AdvancedSearch->SearchCondition = @$filter["v_member_scb_detail_log_id"];
        $this->member_scb_detail_log_id->AdvancedSearch->SearchValue2 = @$filter["y_member_scb_detail_log_id"];
        $this->member_scb_detail_log_id->AdvancedSearch->SearchOperator2 = @$filter["w_member_scb_detail_log_id"];
        $this->member_scb_detail_log_id->AdvancedSearch->save();

        // Field member_scb_id
        $this->member_scb_id->AdvancedSearch->SearchValue = @$filter["x_member_scb_id"];
        $this->member_scb_id->AdvancedSearch->SearchOperator = @$filter["z_member_scb_id"];
        $this->member_scb_id->AdvancedSearch->SearchCondition = @$filter["v_member_scb_id"];
        $this->member_scb_id->AdvancedSearch->SearchValue2 = @$filter["y_member_scb_id"];
        $this->member_scb_id->AdvancedSearch->SearchOperator2 = @$filter["w_member_scb_id"];
        $this->member_scb_id->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->member_scb_detail_log_id, $ctrl); // member_scb_detail_log_id
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->member_scb_detail_log_id->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fmember_scb_detail_loglist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fmember_scb_detail_loglist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->member_scb_detail_log_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("member_scb_detail_log_id", $this->createColumnOption("member_scb_detail_log_id"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fmember_scb_detail_logsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmember_scb_detail_logsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fmember_scb_detail_loglist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    {
        $row = [];
        $row['member_scb_detail_log_id'] = null;
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fmember_scb_detail_logsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
