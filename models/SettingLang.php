...
/**
 * Table class for setting_lang
 */
class SettingLang extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'setting_lang';
        $this->TableName = 'setting_lang';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`setting_lang`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // setting_lang_id
        $this->setting_lang_id = new DbField(
            'setting_lang',
            'setting_lang',
            'x_setting_lang_id',
            'setting_lang_id',
        ...
        $this->setting_lang_id->InputTextType = "text";
        $this->setting_lang_id->IsAutoIncrement = true; // Autoincrement field
        $this->setting_lang_id->IsPrimaryKey = true; // Primary key field
        $this->setting_lang_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['setting_lang_id'] = &$this->setting_lang_id;

        // lang_en
        $this->lang_en = new DbField(
            'setting_lang',
            'setting_lang',
            'x_lang_en',
            'lang_en',
        ...
        $this->lang_en->InputTextType = "text";
        $this->lang_en->Nullable = false; // NOT NULL field
        $this->lang_en->Required = true; // Required field
        $this->Fields['lang_en'] = &$this->lang_en;
        ...
        $this->_param->InputTextType = "text";
        $this->_param->Nullable = false; // NOT NULL field
        $this->_param->Required = true; // Required field
        $this->Fields['param'] = &$this->_param;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`setting_lang`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->setting_lang_id->setDbValue($conn->lastInsertId());
            $rs['setting_lang_id'] = $this->setting_lang_id->DbValue;
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('setting_lang_id', $rs)) {
                AddFilter($where, QuotedName('setting_lang_id', $this->Dbid) . '=' . QuotedValue($rs['setting_lang_id'], $this->setting_lang_id->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->setting_lang_id->DbValue = $row['setting_lang_id'];
        $this->lang_en->DbValue = $row['lang_en'];
        $this->lang->DbValue = $row['lang'];
        $this->_param->DbValue = $row['param'];
    ...
    {
        return "`setting_lang_id` = @setting_lang_id@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->setting_lang_id->CurrentValue : $this->setting_lang_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->setting_lang_id->CurrentValue = $keys[0];
            } else {
                $this->setting_lang_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('setting_lang_id', $row) ? $row['setting_lang_id'] : null;
        } else {
            $val = $this->setting_lang_id->OldValue !== null ? $this->setting_lang_id->OldValue : $this->setting_lang_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@setting_lang_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("settinglanglist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "settinglangedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "settinglangadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "SettingLangView";
            case Config("API_ADD_ACTION"):
                return "SettingLangAdd";
            case Config("API_EDIT_ACTION"):
                return "SettingLangEdit";
            case Config("API_DELETE_ACTION"):
                return "SettingLangDelete";
            case Config("API_LIST_ACTION"):
                return "SettingLangList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("settinglangview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("settinglangview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "settinglangadd?" . $this->getUrlParm($parm);
        } else {
            $url = "settinglangadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("settinglangedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("settinglangadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("settinglangdelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "\"setting_lang_id\":" . JsonEncode($this->setting_lang_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->setting_lang_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->setting_lang_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("setting_lang_id") ?? Route("setting_lang_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->setting_lang_id->CurrentValue = $key;
            } else {
                $this->setting_lang_id->OldValue = $key;
            }
    ...
    public function renderEditRow()
    {
        ...
        // setting_lang_id
        $this->setting_lang_id->setupEditAttributes();
        $this->setting_lang_id->EditCustomAttributes = "";
        $this->setting_lang_id->EditValue = $this->setting_lang_id->CurrentValue;
        $this->setting_lang_id->ViewCustomAttributes = "";
        ...
        $this->lang_en->EditValue = $this->lang_en->CurrentValue;
        ...
        $this->_param->EditValue = $this->_param->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->setting_lang_id);
                    $doc->exportCaption($this->lang_en);
                    $doc->exportCaption($this->lang);
                    $doc->exportCaption($this->_param);
        ...
        while (!$recordset->EOF && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->setting_lang_id);
                        $doc->exportField($this->lang_en);
                        $doc->exportField($this->lang);
                        $doc->exportField($this->_param);
