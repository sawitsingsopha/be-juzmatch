 ...
 * Page class
 */
class SellerAppointmentDelete extends SellerAppointment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SellerAppointmentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("sellerappointmentlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("sellerappointmentlist"); // Return to list
                return;
            }
        }
