...
class BuyerView extends Buyer
{
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("member_id") ?? Route("member_id")) !== null) {
                ...
                $returnUrl = "buyerlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "buyerlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "buyerlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        // "detail_buyer_verify"
        $item = &$option->add("detail_buyer_verify");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("buyer_verify", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("buyerverifylist?" . Config("TABLE_SHOW_MASTER") . "=buyer&" . GetForeignKeyUrl("fk_member_id", $this->member_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("BuyerVerifyGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'buyer')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=buyer_verify"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        // "detail_save_search"
        $item = &$option->add("detail_save_search");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("save_search", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("savesearchlist?" . Config("TABLE_SHOW_MASTER") . "=buyer&" . GetForeignKeyUrl("fk_member_id", $this->member_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("SaveSearchGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'buyer')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=save_search"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        $item = &$option->add("detail_juzcalculator");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("juzcalculator", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("juzcalculatorlist?" . Config("TABLE_SHOW_MASTER") . "=buyer&" . GetForeignKeyUrl("fk_member_id", $this->member_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("JuzcalculatorGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'buyer')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=juzcalculator"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        // "detail_appointment"
        $item = &$option->add("detail_appointment");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("appointment", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("appointmentlist?" . Config("TABLE_SHOW_MASTER") . "=buyer&" . GetForeignKeyUrl("fk_member_id", $this->member_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("AppointmentGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'buyer')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=appointment"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        $item = &$option->add("detail_buyer_booking_asset");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("buyer_booking_asset", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("buyerbookingassetlist?" . Config("TABLE_SHOW_MASTER") . "=buyer&" . GetForeignKeyUrl("fk_member_id", $this->member_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("BuyerBookingAssetGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'buyer')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=buyer_booking_asset"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        if ($item->Visible) {
            ...
            $detailTableLink .= "buyer_booking_asset";
        }
        if ($this->ShowMultipleDetails) {
            $item->Visible = false;
        }
        ...
        // "detail_buyer_asset"
        $item = &$option->add("detail_buyer_asset");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("buyer_asset", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("buyerassetlist?" . Config("TABLE_SHOW_MASTER") . "=buyer&" . GetForeignKeyUrl("fk_member_id", $this->member_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("BuyerAssetGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'buyer')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=buyer_asset"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
    ...
    protected function setupDetailParms()
    {
        ...
        if ($detailTblVar != "") {
            ...
            if (in_array("buyer_verify", $detailTblVar)) {
                $detailPageObj = Container("BuyerVerifyGrid");
            ...
            if (in_array("save_search", $detailTblVar)) {
                $detailPageObj = Container("SaveSearchGrid");
                if ($detailPageObj->DetailView) {
                    $detailPageObj->CurrentMode = "view";
            ...
            if (in_array("juzcalculator", $detailTblVar)) {
                $detailPageObj = Container("JuzcalculatorGrid");
                if ($detailPageObj->DetailView) {
                    $detailPageObj->CurrentMode = "view";
            ...
            if (in_array("buyer_booking_asset", $detailTblVar)) {
                $detailPageObj = Container("BuyerBookingAssetGrid");
                if ($detailPageObj->DetailView) {
                    $detailPageObj->CurrentMode = "view";
            ...
            if (in_array("buyer_asset", $detailTblVar)) {
                $detailPageObj = Container("BuyerAssetGrid");
                if ($detailPageObj->DetailView) {
                    $detailPageObj->CurrentMode = "view";
