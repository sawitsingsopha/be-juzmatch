 ...
 * Page class
 */
class MasterBuyerCalculatorDelete extends MasterBuyerCalculator
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterBuyerCalculatorDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("masterbuyercalculatorlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("masterbuyercalculatorlist"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['master_buyer_calculator_id'];
