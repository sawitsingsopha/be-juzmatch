...
/**
 * Table class for outstanding_amount
 */
class OutstandingAmount extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'outstanding_amount';
        $this->TableName = 'outstanding_amount';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`outstanding_amount`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    public function getDetailUrl()
    {
        ...
        if ($detailUrl == "") {
            $detailUrl = "outstandingamountlist";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`outstanding_amount`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("outstandingamountlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "outstandingamountview") {
            return $Language->phrase("View");
        } elseif ($pageName == "outstandingamountedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "outstandingamountadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "OutstandingAmountView";
            case Config("API_ADD_ACTION"):
                return "OutstandingAmountAdd";
            case Config("API_EDIT_ACTION"):
                return "OutstandingAmountEdit";
            case Config("API_DELETE_ACTION"):
                return "OutstandingAmountDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("outstandingamountview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("outstandingamountview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "outstandingamountadd?" . $this->getUrlParm($parm);
        } else {
            $url = "outstandingamountadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("outstandingamountedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("outstandingamountadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("outstandingamountdelete", $this->getUrlParm());
    }
