...
/**
 * Table class for buyer_all_asset_rent
 */
class BuyerAllAssetRent extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'buyer_all_asset_rent';
        $this->TableName = 'buyer_all_asset_rent';
        ...
        $this->one_time_status->UseFilter = true; // Table header filter
        $this->one_time_status->Lookup = new Lookup('one_time_status', 'buyer_all_asset_rent', true, 'one_time_status', ["one_time_status","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->status_pay_half_price_1->Lookup = new Lookup('status_pay_half_price_1', 'buyer_all_asset_rent', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->date_pay_half_price_1 = new DbField(
            ...
            'date_pay_half_price_1',
            '`date_pay_half_price_1`',
            CastDateFieldForLike("`date_pay_half_price_1`", 7, "juzmatch1"),
            135,
            19,
            7,
            false,
        ...
        $this->due_date_pay_half_price_1 = new DbField(
            ...
            'due_date_pay_half_price_1',
            '`due_date_pay_half_price_1`',
            CastDateFieldForLike("`due_date_pay_half_price_1`", 7, "juzmatch1"),
            135,
            19,
            7,
            false,
        ...
        $this->status_pay_half_price_2->Lookup = new Lookup('status_pay_half_price_2', 'buyer_all_asset_rent', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->date_pay_half_price_2 = new DbField(
            ...
            'date_pay_half_price_2',
            '`date_pay_half_price_2`',
            CastDateFieldForLike("`date_pay_half_price_2`", 7, "juzmatch1"),
            135,
            19,
            7,
            false,
        ...
        $this->due_date_pay_half_price_2 = new DbField(
            ...
            'due_date_pay_half_price_2',
            '`due_date_pay_half_price_2`',
            CastDateFieldForLike("`due_date_pay_half_price_2`", 7, "juzmatch1"),
            135,
            19,
            7,
            false,
        ...
        $this->transaction_datetime1 = new DbField(
            ...
            'transaction_datetime1',
            '`transaction_datetime1`',
            CastDateFieldForLike("`transaction_datetime1`", 0, "juzmatch1"),
            135,
            19,
            0,
            false,
        ...
        $this->transaction_datetime2 = new DbField(
            ...
            'transaction_datetime2',
            '`transaction_datetime2`',
            CastDateFieldForLike("`transaction_datetime2`", 0, "juzmatch1"),
            135,
            19,
            0,
            false,
        ...
        $this->res_maskedPan1->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("buyerallassetrentlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "buyerallassetrentedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "buyerallassetrentadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BuyerAllAssetRentView";
            case Config("API_ADD_ACTION"):
                return "BuyerAllAssetRentAdd";
            case Config("API_EDIT_ACTION"):
                return "BuyerAllAssetRentEdit";
            case Config("API_DELETE_ACTION"):
                return "BuyerAllAssetRentDelete";
            case Config("API_LIST_ACTION"):
                return "BuyerAllAssetRentList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("buyerallassetrentview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("buyerallassetrentview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "buyerallassetrentadd?" . $this->getUrlParm($parm);
        } else {
            $url = "buyerallassetrentadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("buyerallassetrentedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("buyerallassetrentadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("buyerallassetrentdelete", $this->getUrlParm());
    }
