 ...
 * Page class
 */
class PeakExpenseDelete extends PeakExpense
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakExpenseDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("peakexpenselist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("peakexpenselist"); // Return to list
                return;
            }
        }
