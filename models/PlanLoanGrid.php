 ...
 * Page class
 */
class PlanLoanGrid extends PlanLoan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanLoanGrid";
    ...
    public $FormName = "fplan_loangrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->plan_loan_id->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_time") && $CurrentForm->hasValue("o_time") && $this->time->CurrentValue != $this->time->OldValue) {
            return false;
        }
        return true;
    }
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->plan_loan_id->OldValue = $this->plan_loan_id->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->plan_loan_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['plan_loan_id'] = $this->plan_loan_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'plan_loan'
        ...
        // time
        $this->time->setDbValueDef($rsnew, UnFormatDateTime($this->time->CurrentValue, $this->time->formatPattern()), CurrentTime(), false);
