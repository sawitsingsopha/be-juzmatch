 ...
 * Page class
 */
class DocCredenSignerDelete extends DocCredenSigner
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocCredenSignerDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("doccredensignerlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("doccredensignerlist"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['doc_creden_signer_id'];
