...
/**
 * Table class for seller_appointment
 */
class SellerAppointment extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'seller_appointment';
        $this->TableName = 'seller_appointment';
        ...
        $this->date = new DbField(
            ...
            'date',
            '`date`',
            CastDateFieldForLike("`date`", 0, "juzmatch1"),
            133,
            10,
            0,
            false,
        ...
        $this->status->Lookup = new Lookup('status', 'seller_appointment', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("sellerappointmentlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "sellerappointmentedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "sellerappointmentadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "SellerAppointmentView";
            case Config("API_ADD_ACTION"):
                return "SellerAppointmentAdd";
            case Config("API_EDIT_ACTION"):
                return "SellerAppointmentEdit";
            case Config("API_DELETE_ACTION"):
                return "SellerAppointmentDelete";
            case Config("API_LIST_ACTION"):
                return "SellerAppointmentList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("sellerappointmentview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("sellerappointmentview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "sellerappointmentadd?" . $this->getUrlParm($parm);
        } else {
            $url = "sellerappointmentadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("sellerappointmentedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("sellerappointmentadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("sellerappointmentdelete", $this->getUrlParm());
    }
