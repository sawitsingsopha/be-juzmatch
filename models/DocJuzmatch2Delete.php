 ...
 * Page class
 */
class DocJuzmatch2Delete extends DocJuzmatch2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocJuzmatch2Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("docjuzmatch2list"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("docjuzmatch2list"); // Return to list
                return;
            }
        }
