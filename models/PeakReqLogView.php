 ...
 * Page class
 */
class PeakReqLogView extends PeakReqLog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakReqLogView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "peakreqloglist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "peakreqloglist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "peakreqloglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
