 ...
 * Page class
 */
class JuzcalculatorIncomePreview extends JuzcalculatorIncome
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JuzcalculatorIncomePreview";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("juzcalculatorincomelist"), "", $this->TableVar, true);
        $pageId = "preview";
