 ...
 * Page class
 */
class AllBuyerConfigAssetScheduleEdit extends AllBuyerConfigAssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AllBuyerConfigAssetScheduleEdit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("all_buyer_asset_schedule", $detailTblVar) && $detailPage->DetailEdit) {
