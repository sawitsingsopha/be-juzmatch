 ...
 * Page class
 */
class PeakReceiptProductList extends PeakReceiptProduct
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakReceiptProductList";
    ...
    public $FormName = "fpeak_receipt_productlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "peakreceiptproductadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "peakreceiptproductdelete";
        $this->MultiUpdateUrl = "peakreceiptproductupdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fpeak_receipt_productsrch");
        }
        $filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
        $filterList = Concat($filterList, $this->peak_receipt_id->AdvancedSearch->toJson(), ","); // Field peak_receipt_id
        $filterList = Concat($filterList, $this->products_id->AdvancedSearch->toJson(), ","); // Field products_id
        ...
        $filterList = Concat($filterList, $this->producttemplate->AdvancedSearch->toJson(), ","); // Field producttemplate
        $filterList = Concat($filterList, $this->description->AdvancedSearch->toJson(), ","); // Field description
        $filterList = Concat($filterList, $this->accountcode->AdvancedSearch->toJson(), ","); // Field accountcode
        $filterList = Concat($filterList, $this->accountSubId->AdvancedSearch->toJson(), ","); // Field accountSubId
        $filterList = Concat($filterList, $this->accountSubCode->AdvancedSearch->toJson(), ","); // Field accountSubCode
        ...
        $filterList = Concat($filterList, $this->vatType->AdvancedSearch->toJson(), ","); // Field vatType
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpeak_receipt_productsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field peak_receipt_id
        $this->peak_receipt_id->AdvancedSearch->SearchValue = @$filter["x_peak_receipt_id"];
        $this->peak_receipt_id->AdvancedSearch->SearchOperator = @$filter["z_peak_receipt_id"];
        $this->peak_receipt_id->AdvancedSearch->SearchCondition = @$filter["v_peak_receipt_id"];
        $this->peak_receipt_id->AdvancedSearch->SearchValue2 = @$filter["y_peak_receipt_id"];
        $this->peak_receipt_id->AdvancedSearch->SearchOperator2 = @$filter["w_peak_receipt_id"];
        $this->peak_receipt_id->AdvancedSearch->save();

        // Field products_id
        $this->products_id->AdvancedSearch->SearchValue = @$filter["x_products_id"];
        $this->products_id->AdvancedSearch->SearchOperator = @$filter["z_products_id"];
        $this->products_id->AdvancedSearch->SearchCondition = @$filter["v_products_id"];
        $this->products_id->AdvancedSearch->SearchValue2 = @$filter["y_products_id"];
        $this->products_id->AdvancedSearch->SearchOperator2 = @$filter["w_products_id"];
        $this->products_id->AdvancedSearch->save();
        ...
        $this->producttemplate->AdvancedSearch->SearchValue = @$filter["x_producttemplate"];
        $this->producttemplate->AdvancedSearch->SearchOperator = @$filter["z_producttemplate"];
        $this->producttemplate->AdvancedSearch->SearchCondition = @$filter["v_producttemplate"];
        $this->producttemplate->AdvancedSearch->SearchValue2 = @$filter["y_producttemplate"];
        $this->producttemplate->AdvancedSearch->SearchOperator2 = @$filter["w_producttemplate"];
        $this->producttemplate->AdvancedSearch->save();
        ...
        // Field accountSubId
        $this->accountSubId->AdvancedSearch->SearchValue = @$filter["x_accountSubId"];
        $this->accountSubId->AdvancedSearch->SearchOperator = @$filter["z_accountSubId"];
        $this->accountSubId->AdvancedSearch->SearchCondition = @$filter["v_accountSubId"];
        $this->accountSubId->AdvancedSearch->SearchValue2 = @$filter["y_accountSubId"];
        $this->accountSubId->AdvancedSearch->SearchOperator2 = @$filter["w_accountSubId"];
        $this->accountSubId->AdvancedSearch->save();

        // Field accountSubCode
        $this->accountSubCode->AdvancedSearch->SearchValue = @$filter["x_accountSubCode"];
        $this->accountSubCode->AdvancedSearch->SearchOperator = @$filter["z_accountSubCode"];
        $this->accountSubCode->AdvancedSearch->SearchCondition = @$filter["v_accountSubCode"];
        $this->accountSubCode->AdvancedSearch->SearchValue2 = @$filter["y_accountSubCode"];
        $this->accountSubCode->AdvancedSearch->SearchOperator2 = @$filter["w_accountSubCode"];
        $this->accountSubCode->AdvancedSearch->save();
        ...
        // Field vatType
        $this->vatType->AdvancedSearch->SearchValue = @$filter["x_vatType"];
        $this->vatType->AdvancedSearch->SearchOperator = @$filter["z_vatType"];
        $this->vatType->AdvancedSearch->SearchCondition = @$filter["v_vatType"];
        $this->vatType->AdvancedSearch->SearchValue2 = @$filter["y_vatType"];
        $this->vatType->AdvancedSearch->SearchOperator2 = @$filter["w_vatType"];
        $this->vatType->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->products_id;
        $searchFlds[] = &$this->productid;
        $searchFlds[] = &$this->productcode;
        $searchFlds[] = &$this->producttemplate;
        $searchFlds[] = &$this->description;
        $searchFlds[] = &$this->accountcode;
        $searchFlds[] = &$this->accountSubId;
        $searchFlds[] = &$this->accountSubCode;
        $searchFlds[] = &$this->vatType;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->peak_receipt_id, $ctrl); // peak_receipt_id
            $this->updateSort($this->products_id, $ctrl); // products_id
            $this->updateSort($this->productid, $ctrl); // productid
            $this->updateSort($this->productcode, $ctrl); // productcode
            $this->updateSort($this->producttemplate, $ctrl); // producttemplate
            $this->updateSort($this->accountcode, $ctrl); // accountcode
            $this->updateSort($this->accountSubId, $ctrl); // accountSubId
            $this->updateSort($this->accountSubCode, $ctrl); // accountSubCode
            ...
            $this->updateSort($this->vatType, $ctrl); // vatType
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->setSessionOrderBy($orderBy);
                $this->id->setSort("");
                $this->peak_receipt_id->setSort("");
                $this->products_id->setSort("");
                $this->productid->setSort("");
                $this->productcode->setSort("");
                $this->producttemplate->setSort("");
                $this->description->setSort("");
                $this->accountcode->setSort("");
                $this->accountSubId->setSort("");
                $this->accountSubCode->setSort("");
                $this->quantity->setSort("");
                $this->price->setSort("");
                $this->discount->setSort("");
                $this->vatType->setSort("");
                $this->note->setSort("");
            }
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpeak_receipt_productlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpeak_receipt_productlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("peak_receipt_id", $this->createColumnOption("peak_receipt_id"));
            $option->add("products_id", $this->createColumnOption("products_id"));
            $option->add("productid", $this->createColumnOption("productid"));
            $option->add("productcode", $this->createColumnOption("productcode"));
            $option->add("producttemplate", $this->createColumnOption("producttemplate"));
            $option->add("accountcode", $this->createColumnOption("accountcode"));
            $option->add("accountSubId", $this->createColumnOption("accountSubId"));
            $option->add("accountSubCode", $this->createColumnOption("accountSubCode"));
            $option->add("quantity", $this->createColumnOption("quantity"));
            $option->add("price", $this->createColumnOption("price"));
            $option->add("discount", $this->createColumnOption("discount"));
            $option->add("vatType", $this->createColumnOption("vatType"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpeak_receipt_productsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpeak_receipt_productsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fpeak_receipt_productlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->producttemplate->TooltipValue = "";
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fpeak_receipt_productlist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fpeak_receipt_productsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
