 ...
 * Page class
 */
class PeakReceiptEdit extends PeakReceipt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakReceiptEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // issueddate
            $this->issueddate->setDbValueDef($rsnew, UnFormatDateTime($this->issueddate->CurrentValue, $this->issueddate->formatPattern()), null, $this->issueddate->ReadOnly);
            ...
            // contactcode
            $this->contactcode->setDbValueDef($rsnew, $this->contactcode->CurrentValue, null, $this->contactcode->ReadOnly);

            // tag
            $this->tag->setDbValueDef($rsnew, $this->tag->CurrentValue, null, $this->tag->ReadOnly);

            // istaxinvoice
            $this->istaxinvoice->setDbValueDef($rsnew, $this->istaxinvoice->CurrentValue, null, $this->istaxinvoice->ReadOnly);

            // taxstatus
            $this->taxstatus->setDbValueDef($rsnew, $this->taxstatus->CurrentValue, null, $this->taxstatus->ReadOnly);

            // paymentdate
            $this->paymentdate->setDbValueDef($rsnew, UnFormatDateTime($this->paymentdate->CurrentValue, $this->paymentdate->formatPattern()), null, $this->paymentdate->ReadOnly);

            // paymentmethodid
            $this->paymentmethodid->setDbValueDef($rsnew, $this->paymentmethodid->CurrentValue, null, $this->paymentmethodid->ReadOnly);

            // paymentMethodCode
            $this->paymentMethodCode->setDbValueDef($rsnew, $this->paymentMethodCode->CurrentValue, null, $this->paymentMethodCode->ReadOnly);
            ...
            // receipt_id
            $this->receipt_id->setDbValueDef($rsnew, $this->receipt_id->CurrentValue, null, $this->receipt_id->ReadOnly);

            // receipt_code
            $this->receipt_code->setDbValueDef($rsnew, $this->receipt_code->CurrentValue, null, $this->receipt_code->ReadOnly);

            // receipt_status
            $this->receipt_status->setDbValueDef($rsnew, $this->receipt_status->CurrentValue, null, $this->receipt_status->ReadOnly);

            // preTaxAmount
            $this->preTaxAmount->setDbValueDef($rsnew, $this->preTaxAmount->CurrentValue, null, $this->preTaxAmount->ReadOnly);

            // vatAmount
            $this->vatAmount->setDbValueDef($rsnew, $this->vatAmount->CurrentValue, null, $this->vatAmount->ReadOnly);

            // netAmount
            $this->netAmount->setDbValueDef($rsnew, $this->netAmount->CurrentValue, null, $this->netAmount->ReadOnly);

            // whtAmount
            $this->whtAmount->setDbValueDef($rsnew, $this->whtAmount->CurrentValue, null, $this->whtAmount->ReadOnly);

            // paymentAmount
            $this->paymentAmount->setDbValueDef($rsnew, $this->paymentAmount->CurrentValue, null, $this->paymentAmount->ReadOnly);

            // remainAmount
            $this->remainAmount->setDbValueDef($rsnew, $this->remainAmount->CurrentValue, null, $this->remainAmount->ReadOnly);

            // remainWhtAmount
            $this->remainWhtAmount->setDbValueDef($rsnew, $this->remainWhtAmount->CurrentValue, null, $this->remainWhtAmount->ReadOnly);

            // onlineViewLink
            $this->onlineViewLink->setDbValueDef($rsnew, $this->onlineViewLink->CurrentValue, null, $this->onlineViewLink->ReadOnly);

            // isPartialReceipt
            $this->isPartialReceipt->setDbValueDef($rsnew, $this->isPartialReceipt->CurrentValue, null, $this->isPartialReceipt->ReadOnly);

            // journals_id
            $this->journals_id->setDbValueDef($rsnew, $this->journals_id->CurrentValue, null, $this->journals_id->ReadOnly);

            // journals_code
            $this->journals_code->setDbValueDef($rsnew, $this->journals_code->CurrentValue, null, $this->journals_code->ReadOnly);

            // refid
            $this->refid->setDbValueDef($rsnew, $this->refid->CurrentValue, null, $this->refid->ReadOnly);

            // transition_type
            $this->transition_type->setDbValueDef($rsnew, $this->transition_type->CurrentValue, null, $this->transition_type->ReadOnly);
