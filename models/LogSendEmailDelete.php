 ...
 * Page class
 */
class LogSendEmailDelete extends LogSendEmail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LogSendEmailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("logsendemaillist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("logsendemaillist"); // Return to list
                return;
            }
        }
