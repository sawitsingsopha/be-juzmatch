 ...
 * Page class
 */
class Log2c2pAdd extends Log2c2p
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "log2c2pview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->log_2c2p_id->OldValue = $this->log_2c2p_id->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['log_2c2p_id'] = $this->log_2c2p_id->CurrentValue;
