...
/**
 * Table class for asset_schedule
 */
class AssetSchedule extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'asset_schedule';
        $this->TableName = 'asset_schedule';
        ...
        $this->status_payment->Lookup = new Lookup('status_payment', 'asset_schedule', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("assetschedulelist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "assetscheduleedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "assetscheduleadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AssetScheduleView";
            case Config("API_ADD_ACTION"):
                return "AssetScheduleAdd";
            case Config("API_EDIT_ACTION"):
                return "AssetScheduleEdit";
            case Config("API_DELETE_ACTION"):
                return "AssetScheduleDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("assetscheduleview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("assetscheduleview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "assetscheduleadd?" . $this->getUrlParm($parm);
        } else {
            $url = "assetscheduleadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("assetscheduleedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("assetscheduleadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("assetscheduledelete", $this->getUrlParm());
    }
