 ...
 * Page class
 */
class AssetConfigScheduleDelete extends AssetConfigSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetConfigScheduleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("assetconfigschedulelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("assetconfigschedulelist"); // Return to list
                return;
            }
        }
