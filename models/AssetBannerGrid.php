 ...
 * Page class
 */
class AssetBannerGrid extends AssetBanner
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetBannerGrid";
    ...
    public $FormName = "fasset_bannergrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->asset_banner_id->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_order_by") && $CurrentForm->hasValue("o_order_by") && $this->order_by->CurrentValue != $this->order_by->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->order_by->clearErrorMessage();
    ...
    {
        $this->asset_banner_id->CurrentValue = null;
        $this->asset_banner_id->OldValue = $this->asset_banner_id->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_order_by")) {
            $this->order_by->setOldValue($CurrentForm->getValue("o_order_by"));
        }
        ...
        // Check field name 'asset_banner_id' first before field var 'x_asset_banner_id'
        $val = $CurrentForm->hasValue("asset_banner_id") ? $CurrentForm->getValue("asset_banner_id") : $CurrentForm->getValue("x_asset_banner_id");
        if (!$this->asset_banner_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->asset_banner_id->setFormValue($val);
        }
		$this->image->OldUploadPath = './upload/asset_banner';
		$this->image->UploadPath = $this->image->OldUploadPath;
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->asset_banner_id->CurrentValue = $this->asset_banner_id->FormValue;
        }
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['asset_banner_id'] = $this->asset_banner_id->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (strval($this->order_by->EditValue) != "" && is_numeric($this->order_by->EditValue)) {
                ...
                $this->order_by->OldValue = $this->order_by->EditValue;
            }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'asset_banner'
