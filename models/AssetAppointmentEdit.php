 ...
 * Page class
 */
class AssetAppointmentEdit extends AssetAppointment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetAppointmentEdit";
    ...
    public function run()
    {
        ...
        $this->first_name->Required = false;
        $this->last_name->Required = false;
        $this->_email->Required = false;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("assetappointmentlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "assetappointmentlist") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("assetappointmentlist"), "", $this->TableVar, true);
        $pageId = "edit";
