 ...
 * Page class
 */
class AssetConfigScheduleGrid extends AssetConfigSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetConfigScheduleGrid";
    ...
    public $FormName = "fasset_config_schedulegrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->asset_config_schedule_id->CurrentValue;
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->asset_config_schedule_id->OldValue = $this->asset_config_schedule_id->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->asset_config_schedule_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['asset_config_schedule_id'] = $this->asset_config_schedule_id->CurrentValue;
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['asset_config_schedule_id'];
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'asset_config_schedule'
