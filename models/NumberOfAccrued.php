...
/**
 * Table class for number_of_accrued
 */
class NumberOfAccrued extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'number_of_accrued';
        $this->TableName = 'number_of_accrued';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`number_of_accrued`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`number_of_accrued`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("numberofaccruedlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "numberofaccruedview") {
            return $Language->phrase("View");
        } elseif ($pageName == "numberofaccruededit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "numberofaccruedadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "NumberOfAccruedView";
            case Config("API_ADD_ACTION"):
                return "NumberOfAccruedAdd";
            case Config("API_EDIT_ACTION"):
                return "NumberOfAccruedEdit";
            case Config("API_DELETE_ACTION"):
                return "NumberOfAccruedDelete";
            case Config("API_LIST_ACTION"):
                return "NumberOfAccruedList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("numberofaccruedview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("numberofaccruedview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "numberofaccruedadd?" . $this->getUrlParm($parm);
        } else {
            $url = "numberofaccruedadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("numberofaccruededit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("numberofaccruedadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("numberofaccrueddelete", $this->getUrlParm());
    }
