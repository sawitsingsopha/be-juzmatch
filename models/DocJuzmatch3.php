...
/**
 * Table class for doc_juzmatch3
 */
class DocJuzmatch3 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public $next_pay_date_txt;
    public $service_price;
    public $service_price_txt;
    public $provide_service_date;
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'doc_juzmatch3';
        $this->TableName = 'doc_juzmatch3';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`doc_juzmatch3`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->years->InputTextType = "text";
        $this->years->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['years'] = &$this->years;
        ...
        $this->start_date = new DbField(
            ...
            'start_date',
            '`start_date`',
            CastDateFieldForLike("`start_date`", 7, "DB"),
            133,
            10,
            7,
            false,
        ...
        $this->end_date = new DbField(
            ...
            'end_date',
            '`end_date`',
            CastDateFieldForLike("`end_date`", 7, "DB"),
            133,
            10,
            7,
            false,
        ...
        // appoint_agent_date
        $this->appoint_agent_date = new DbField(
            'doc_juzmatch3',
            'doc_juzmatch3',
            'x_appoint_agent_date',
            'appoint_agent_date',
            '`appoint_agent_date`',
            CastDateFieldForLike("`appoint_agent_date`", 7, "DB"),
            133,
            10,
            7,
            false,
        ...
        $this->appoint_agent_date->InputTextType = "text";
        $this->appoint_agent_date->DefaultErrorMessage = str_replace("%s", DateFormat(7), $Language->phrase("IncorrectDate"));
        $this->Fields['appoint_agent_date'] = &$this->appoint_agent_date;
        ...
        $this->total_txt->InputTextType = "text";
        $this->Fields['total_txt'] = &$this->total_txt;

        // next_pay_date
        $this->next_pay_date = new DbField(
            'doc_juzmatch3',
            'doc_juzmatch3',
            'x_next_pay_date',
            'next_pay_date',
            '`next_pay_date`',
            CastDateFieldForLike("`next_pay_date`", 7, "DB"),
            133,
            10,
            7,
            false,
        ...
        $this->next_pay_date->InputTextType = "text";
        $this->next_pay_date->DefaultErrorMessage = str_replace("%s", DateFormat(7), $Language->phrase("IncorrectDate"));
        $this->Fields['next_pay_date'] = &$this->next_pay_date;

        // next_pay_date_txt
        $this->next_pay_date_txt = new DbField(
            'doc_juzmatch3',
            'doc_juzmatch3',
            'x_next_pay_date_txt',
            'next_pay_date_txt',
        ...
        $this->next_pay_date_txt->InputTextType = "text";
        $this->Fields['next_pay_date_txt'] = &$this->next_pay_date_txt;
        ...
        $this->provide_service_date = new DbField(
            'doc_juzmatch3',
            'doc_juzmatch3',
            'x_provide_service_date',
            'provide_service_date',
            '`provide_service_date`',
            CastDateFieldForLike("`provide_service_date`", 7, "DB"),
            133,
            10,
            7,
            false,
        ...
        $this->provide_service_date->InputTextType = "text";
        $this->provide_service_date->DefaultErrorMessage = str_replace("%s", DateFormat(7), $Language->phrase("IncorrectDate"));
        $this->Fields['provide_service_date'] = &$this->provide_service_date;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`doc_juzmatch3`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->appoint_agent_date->DbValue = $row['appoint_agent_date'];
        ...
        $this->total_txt->DbValue = $row['total_txt'];
        $this->next_pay_date->DbValue = $row['next_pay_date'];
        $this->next_pay_date_txt->DbValue = $row['next_pay_date_txt'];
        $this->service_price->DbValue = $row['service_price'];
        $this->service_price_txt->DbValue = $row['service_price_txt'];
        $this->provide_service_date->DbValue = $row['provide_service_date'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("docjuzmatch3list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "docjuzmatch3edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "docjuzmatch3add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DocJuzmatch3View";
            case Config("API_ADD_ACTION"):
                return "DocJuzmatch3Add";
            case Config("API_EDIT_ACTION"):
                return "DocJuzmatch3Edit";
            case Config("API_DELETE_ACTION"):
                return "DocJuzmatch3Delete";
            case Config("API_LIST_ACTION"):
                return "DocJuzmatch3List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("docjuzmatch3view", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("docjuzmatch3view", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "docjuzmatch3add?" . $this->getUrlParm($parm);
        } else {
            $url = "docjuzmatch3add";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("docjuzmatch3edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("docjuzmatch3add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("docjuzmatch3delete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->years->EditValue = $this->years->CurrentValue;
        ...
        $this->appoint_agent_date->EditValue = FormatDateTime($this->appoint_agent_date->CurrentValue, $this->appoint_agent_date->formatPattern());
        ...
        $this->total_txt->EditValue = $this->total_txt->CurrentValue;
        ...
        $this->next_pay_date->EditValue = FormatDateTime($this->next_pay_date->CurrentValue, $this->next_pay_date->formatPattern());
        ...
        $this->next_pay_date_txt->EditValue = $this->next_pay_date_txt->CurrentValue;
        ...
        $this->provide_service_date->EditValue = FormatDateTime($this->provide_service_date->CurrentValue, $this->provide_service_date->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->appoint_agent_date);
                    ...
                    $doc->exportCaption($this->total_txt);
                    $doc->exportCaption($this->next_pay_date);
                    $doc->exportCaption($this->next_pay_date_txt);
                    $doc->exportCaption($this->service_price);
                    $doc->exportCaption($this->service_price_txt);
                    $doc->exportCaption($this->provide_service_date);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->appoint_agent_date);
                        ...
                        $doc->exportField($this->total_txt);
                        $doc->exportField($this->next_pay_date);
                        $doc->exportField($this->next_pay_date_txt);
                        $doc->exportField($this->service_price);
                        $doc->exportField($this->service_price_txt);
                        $doc->exportField($this->provide_service_date);
