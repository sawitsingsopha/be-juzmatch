 ...
 * Page class
 */
class AppointmentPreview extends Appointment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AppointmentPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "sale_asset") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sale_asset&" . GetForeignKeyUrl("fk_asset_id", $this->asset_id->QueryStringValue) . "&" . GetForeignKeyUrl("fk_member_id", $this->member_id->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("appointmentlist"), "", $this->TableVar, true);
        $pageId = "preview";
