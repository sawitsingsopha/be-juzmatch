 ...
 * Page class
 */
class BuyerConfigAssetScheduleDelete extends BuyerConfigAssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerConfigAssetScheduleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("buyerconfigassetschedulelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("buyerconfigassetschedulelist"); // Return to list
                return;
            }
        }
