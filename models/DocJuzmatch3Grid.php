 ...
 * Page class
 */
class DocJuzmatch3Grid extends DocJuzmatch3
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocJuzmatch3Grid";
    ...
    public $FormName = "fdoc_juzmatch3grid";
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_years") && $CurrentForm->hasValue("o_years") && $this->years->CurrentValue != $this->years->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_appoint_agent_date") && $CurrentForm->hasValue("o_appoint_agent_date") && $this->appoint_agent_date->CurrentValue != $this->appoint_agent_date->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_total_txt") && $CurrentForm->hasValue("o_total_txt") && $this->total_txt->CurrentValue != $this->total_txt->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_next_pay_date") && $CurrentForm->hasValue("o_next_pay_date") && $this->next_pay_date->CurrentValue != $this->next_pay_date->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_next_pay_date_txt") && $CurrentForm->hasValue("o_next_pay_date_txt") && $this->next_pay_date_txt->CurrentValue != $this->next_pay_date_txt->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_provide_service_date") && $CurrentForm->hasValue("o_provide_service_date") && $this->provide_service_date->CurrentValue != $this->provide_service_date->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->appoint_agent_date->clearErrorMessage();
        ...
        $this->total_txt->clearErrorMessage();
        $this->next_pay_date->clearErrorMessage();
        $this->next_pay_date_txt->clearErrorMessage();
        $this->service_price->clearErrorMessage();
        $this->service_price_txt->clearErrorMessage();
        $this->provide_service_date->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_years")) {
            $this->years->setOldValue($CurrentForm->getValue("o_years"));
        }
        ...
        if ($CurrentForm->hasValue("o_appoint_agent_date")) {
            $this->appoint_agent_date->setOldValue($CurrentForm->getValue("o_appoint_agent_date"));
        }
        ...
        if ($CurrentForm->hasValue("o_total_txt")) {
            $this->total_txt->setOldValue($CurrentForm->getValue("o_total_txt"));
        }
        ...
        if ($CurrentForm->hasValue("o_next_pay_date")) {
            $this->next_pay_date->setOldValue($CurrentForm->getValue("o_next_pay_date"));
        }
        ...
        if ($CurrentForm->hasValue("o_next_pay_date_txt")) {
            $this->next_pay_date_txt->setOldValue($CurrentForm->getValue("o_next_pay_date_txt"));
        }
        ...
        if ($CurrentForm->hasValue("o_provide_service_date")) {
            $this->provide_service_date->setOldValue($CurrentForm->getValue("o_provide_service_date"));
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (strval($this->years->EditValue) != "" && is_numeric($this->years->EditValue)) {
                ...
                $this->years->OldValue = $this->years->EditValue;
            }
