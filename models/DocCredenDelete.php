 ...
 * Page class
 */
class DocCredenDelete extends DocCreden
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocCredenDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("doccredenlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("doccredenlist"); // Return to list
                return;
            }
        }
