 ...
 * Page class
 */
class DocCredenRunningView extends DocCredenRunning
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocCredenRunningView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("year") ?? Route("year")) !== null) {
            $this->RecKey["year"] = $keyValue;
        }
        if (($keyValue = Get("month") ?? Route("month")) !== null) {
            $this->RecKey["month"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("year") ?? Route("year")) !== null) {
                ...
                $returnUrl = "doccredenrunninglist"; // Return to list
            }
            if (($keyValue = Get("month") ?? Route("month")) !== null) {
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "doccredenrunninglist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "doccredenrunninglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
