 ...
 * Page class
 */
class BuyerAssetSchedulePreview extends BuyerAssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerAssetSchedulePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "buyer_config_asset_schedule") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=buyer_config_asset_schedule&" . GetForeignKeyUrl("fk_member_id", $this->member_id->QueryStringValue) . "&" . GetForeignKeyUrl("fk_asset_id", $this->asset_id->QueryStringValue) . "";
        }
        return $url;
    }
