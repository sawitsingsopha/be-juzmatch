 ...
 * Page class
 */
class LogTestPaymentList extends LogTestPayment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LogTestPaymentList";
    ...
    public $FormName = "flog_test_paymentlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "logtestpaymentadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "logtestpaymentdelete";
        $this->MultiUpdateUrl = "logtestpaymentupdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "flog_test_paymentsrch");
        }
        $filterList = Concat($filterList, $this->log_test_payment_id->AdvancedSearch->toJson(), ","); // Field log_test_payment_id
        ...
        $filterList = Concat($filterList, $this->transaction_datetime->AdvancedSearch->toJson(), ","); // Field transaction_datetime
        $filterList = Concat($filterList, $this->payment_scheme->AdvancedSearch->toJson(), ","); // Field payment_scheme
        $filterList = Concat($filterList, $this->transaction_ref->AdvancedSearch->toJson(), ","); // Field transaction_ref
        $filterList = Concat($filterList, $this->channel_response_desc->AdvancedSearch->toJson(), ","); // Field channel_response_desc
        $filterList = Concat($filterList, $this->res_status->AdvancedSearch->toJson(), ","); // Field res_status
        $filterList = Concat($filterList, $this->res_referenceNo->AdvancedSearch->toJson(), ","); // Field res_referenceNo
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "flog_test_paymentsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field log_test_payment_id
        $this->log_test_payment_id->AdvancedSearch->SearchValue = @$filter["x_log_test_payment_id"];
        $this->log_test_payment_id->AdvancedSearch->SearchOperator = @$filter["z_log_test_payment_id"];
        $this->log_test_payment_id->AdvancedSearch->SearchCondition = @$filter["v_log_test_payment_id"];
        $this->log_test_payment_id->AdvancedSearch->SearchValue2 = @$filter["y_log_test_payment_id"];
        $this->log_test_payment_id->AdvancedSearch->SearchOperator2 = @$filter["w_log_test_payment_id"];
        $this->log_test_payment_id->AdvancedSearch->save();
        ...
        $this->transaction_datetime->AdvancedSearch->SearchValue = @$filter["x_transaction_datetime"];
        $this->transaction_datetime->AdvancedSearch->SearchOperator = @$filter["z_transaction_datetime"];
        $this->transaction_datetime->AdvancedSearch->SearchCondition = @$filter["v_transaction_datetime"];
        $this->transaction_datetime->AdvancedSearch->SearchValue2 = @$filter["y_transaction_datetime"];
        $this->transaction_datetime->AdvancedSearch->SearchOperator2 = @$filter["w_transaction_datetime"];
        $this->transaction_datetime->AdvancedSearch->save();

        // Field payment_scheme
        $this->payment_scheme->AdvancedSearch->SearchValue = @$filter["x_payment_scheme"];
        $this->payment_scheme->AdvancedSearch->SearchOperator = @$filter["z_payment_scheme"];
        $this->payment_scheme->AdvancedSearch->SearchCondition = @$filter["v_payment_scheme"];
        $this->payment_scheme->AdvancedSearch->SearchValue2 = @$filter["y_payment_scheme"];
        $this->payment_scheme->AdvancedSearch->SearchOperator2 = @$filter["w_payment_scheme"];
        $this->payment_scheme->AdvancedSearch->save();

        // Field transaction_ref
        $this->transaction_ref->AdvancedSearch->SearchValue = @$filter["x_transaction_ref"];
        $this->transaction_ref->AdvancedSearch->SearchOperator = @$filter["z_transaction_ref"];
        $this->transaction_ref->AdvancedSearch->SearchCondition = @$filter["v_transaction_ref"];
        $this->transaction_ref->AdvancedSearch->SearchValue2 = @$filter["y_transaction_ref"];
        $this->transaction_ref->AdvancedSearch->SearchOperator2 = @$filter["w_transaction_ref"];
        $this->transaction_ref->AdvancedSearch->save();

        // Field channel_response_desc
        $this->channel_response_desc->AdvancedSearch->SearchValue = @$filter["x_channel_response_desc"];
        $this->channel_response_desc->AdvancedSearch->SearchOperator = @$filter["z_channel_response_desc"];
        $this->channel_response_desc->AdvancedSearch->SearchCondition = @$filter["v_channel_response_desc"];
        $this->channel_response_desc->AdvancedSearch->SearchValue2 = @$filter["y_channel_response_desc"];
        $this->channel_response_desc->AdvancedSearch->SearchOperator2 = @$filter["w_channel_response_desc"];
        $this->channel_response_desc->AdvancedSearch->save();

        // Field res_status
        $this->res_status->AdvancedSearch->SearchValue = @$filter["x_res_status"];
        $this->res_status->AdvancedSearch->SearchOperator = @$filter["z_res_status"];
        $this->res_status->AdvancedSearch->SearchCondition = @$filter["v_res_status"];
        $this->res_status->AdvancedSearch->SearchValue2 = @$filter["y_res_status"];
        $this->res_status->AdvancedSearch->SearchOperator2 = @$filter["w_res_status"];
        $this->res_status->AdvancedSearch->save();

        // Field res_referenceNo
        $this->res_referenceNo->AdvancedSearch->SearchValue = @$filter["x_res_referenceNo"];
        $this->res_referenceNo->AdvancedSearch->SearchOperator = @$filter["z_res_referenceNo"];
        $this->res_referenceNo->AdvancedSearch->SearchCondition = @$filter["v_res_referenceNo"];
        $this->res_referenceNo->AdvancedSearch->SearchValue2 = @$filter["y_res_referenceNo"];
        $this->res_referenceNo->AdvancedSearch->SearchOperator2 = @$filter["w_res_referenceNo"];
        $this->res_referenceNo->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->pay_number;
        $searchFlds[] = &$this->payment_scheme;
        $searchFlds[] = &$this->transaction_ref;
        $searchFlds[] = &$this->channel_response_desc;
        $searchFlds[] = &$this->res_status;
        $searchFlds[] = &$this->res_referenceNo;
        $searchFlds[] = &$this->res_paidAgent;
        $searchFlds[] = &$this->res_paidChannel;
        $searchFlds[] = &$this->res_maskedPan;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->log_test_payment_id, $ctrl); // log_test_payment_id
            ...
            $this->updateSort($this->transaction_datetime, $ctrl); // transaction_datetime
            $this->updateSort($this->payment_scheme, $ctrl); // payment_scheme
            $this->updateSort($this->transaction_ref, $ctrl); // transaction_ref
            $this->updateSort($this->channel_response_desc, $ctrl); // channel_response_desc
            $this->updateSort($this->res_status, $ctrl); // res_status
            $this->updateSort($this->res_referenceNo, $ctrl); // res_referenceNo
            $this->updateSort($this->res_paidAgent, $ctrl); // res_paidAgent
            $this->updateSort($this->res_paidChannel, $ctrl); // res_paidChannel
            $this->updateSort($this->res_maskedPan, $ctrl); // res_maskedPan
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->log_test_payment_id->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"flog_test_paymentlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"flog_test_paymentlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->log_test_payment_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("log_test_payment_id", $this->createColumnOption("log_test_payment_id"));
            ...
            $option->add("transaction_datetime", $this->createColumnOption("transaction_datetime"));
            $option->add("payment_scheme", $this->createColumnOption("payment_scheme"));
            $option->add("transaction_ref", $this->createColumnOption("transaction_ref"));
            $option->add("channel_response_desc", $this->createColumnOption("channel_response_desc"));
            $option->add("res_status", $this->createColumnOption("res_status"));
            $option->add("res_referenceNo", $this->createColumnOption("res_referenceNo"));
            $option->add("res_paidAgent", $this->createColumnOption("res_paidAgent"));
            $option->add("res_paidChannel", $this->createColumnOption("res_paidChannel"));
            $option->add("res_maskedPan", $this->createColumnOption("res_maskedPan"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"flog_test_paymentsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"flog_test_paymentsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="flog_test_paymentlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->log_test_payment_id->TooltipValue = "";
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="flog_test_paymentlist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"flog_test_paymentsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
