 ...
 * Page class
 */
class DocCredenSignerAdd extends DocCredenSigner
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocCredenSignerAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "doccredensignerview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->doc_creden_signer_id->OldValue = $this->doc_creden_signer_id->CurrentValue;
        $this->doc_creden_id->CurrentValue = null;
        $this->doc_creden_id->OldValue = $this->doc_creden_id->CurrentValue;
        $this->doc_creden_signer_no->CurrentValue = null;
        $this->doc_creden_signer_no->OldValue = $this->doc_creden_signer_no->CurrentValue;
        $this->doc_creden_signer_link->CurrentValue = null;
        $this->doc_creden_signer_link->OldValue = $this->doc_creden_signer_link->CurrentValue;
        $this->doc_creden_signer_session->CurrentValue = null;
        $this->doc_creden_signer_session->OldValue = $this->doc_creden_signer_session->CurrentValue;
        $this->doc_creden_signer_name->CurrentValue = null;
        $this->doc_creden_signer_name->OldValue = $this->doc_creden_signer_name->CurrentValue;
        $this->doc_creden_signer_email->CurrentValue = null;
        $this->doc_creden_signer_email->OldValue = $this->doc_creden_signer_email->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['doc_creden_signer_id'] = $this->doc_creden_signer_id->CurrentValue;
        $row['doc_creden_id'] = $this->doc_creden_id->CurrentValue;
        $row['doc_creden_signer_no'] = $this->doc_creden_signer_no->CurrentValue;
        $row['doc_creden_signer_link'] = $this->doc_creden_signer_link->CurrentValue;
        $row['doc_creden_signer_session'] = $this->doc_creden_signer_session->CurrentValue;
        $row['doc_creden_signer_name'] = $this->doc_creden_signer_name->CurrentValue;
        $row['doc_creden_signer_email'] = $this->doc_creden_signer_email->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // doc_creden_id
        $this->doc_creden_id->setDbValueDef($rsnew, $this->doc_creden_id->CurrentValue, null, false);

        // doc_creden_signer_no
        $this->doc_creden_signer_no->setDbValueDef($rsnew, $this->doc_creden_signer_no->CurrentValue, null, false);

        // doc_creden_signer_link
        $this->doc_creden_signer_link->setDbValueDef($rsnew, $this->doc_creden_signer_link->CurrentValue, null, false);

        // doc_creden_signer_session
        $this->doc_creden_signer_session->setDbValueDef($rsnew, $this->doc_creden_signer_session->CurrentValue, null, false);

        // doc_creden_signer_name
        $this->doc_creden_signer_name->setDbValueDef($rsnew, $this->doc_creden_signer_name->CurrentValue, null, false);

        // doc_creden_signer_email
        $this->doc_creden_signer_email->setDbValueDef($rsnew, $this->doc_creden_signer_email->CurrentValue, null, false);
