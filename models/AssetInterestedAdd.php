 ...
 * Page class
 */
class AssetInterestedAdd extends AssetInterested
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetInterestedAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "assetinterestedview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->asset_interested_id->OldValue = $this->asset_interested_id->CurrentValue;
        $this->asset_id->CurrentValue = null;
        $this->asset_id->OldValue = $this->asset_id->CurrentValue;
        $this->master_asset_interested_id->CurrentValue = null;
        $this->master_asset_interested_id->OldValue = $this->master_asset_interested_id->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['asset_interested_id'] = $this->asset_interested_id->CurrentValue;
        $row['asset_id'] = $this->asset_id->CurrentValue;
        $row['master_asset_interested_id'] = $this->master_asset_interested_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // master_asset_interested_id
        $this->master_asset_interested_id->setDbValueDef($rsnew, $this->master_asset_interested_id->CurrentValue, 0, false);
