 ...
 * Page class
 */
class LogTestPaymentAdd extends LogTestPayment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LogTestPaymentAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "logtestpaymentview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->log_test_payment_id->OldValue = $this->log_test_payment_id->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['log_test_payment_id'] = $this->log_test_payment_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // due_date
        $this->due_date->setDbValueDef($rsnew, UnFormatDateTime($this->due_date->CurrentValue, $this->due_date->formatPattern()), null, false);
        ...
        // transaction_datetime
        $this->transaction_datetime->setDbValueDef($rsnew, UnFormatDateTime($this->transaction_datetime->CurrentValue, $this->transaction_datetime->formatPattern()), null, false);

        // payment_scheme
        $this->payment_scheme->setDbValueDef($rsnew, $this->payment_scheme->CurrentValue, null, false);

        // transaction_ref
        $this->transaction_ref->setDbValueDef($rsnew, $this->transaction_ref->CurrentValue, null, false);

        // channel_response_desc
        $this->channel_response_desc->setDbValueDef($rsnew, $this->channel_response_desc->CurrentValue, null, false);

        // res_status
        $this->res_status->setDbValueDef($rsnew, $this->res_status->CurrentValue, null, false);

        // res_referenceNo
        $this->res_referenceNo->setDbValueDef($rsnew, $this->res_referenceNo->CurrentValue, null, false);

        // res_paidAgent
        $this->res_paidAgent->setDbValueDef($rsnew, $this->res_paidAgent->CurrentValue, null, false);

        // res_paidChannel
        $this->res_paidChannel->setDbValueDef($rsnew, $this->res_paidChannel->CurrentValue, null, false);

        // res_maskedPan
        $this->res_maskedPan->setDbValueDef($rsnew, $this->res_maskedPan->CurrentValue, null, false);
