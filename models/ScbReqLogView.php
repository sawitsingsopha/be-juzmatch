 ...
 * Page class
 */
class ScbReqLogView extends ScbReqLog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScbReqLogView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "scbreqloglist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "scbreqloglist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "scbreqloglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
