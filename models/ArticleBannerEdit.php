 ...
 * Page class
 */
class ArticleBannerEdit extends ArticleBanner
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArticleBannerEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("article_banner_id") ?? Key(0) ?? Route(2)) !== null) {
                $this->article_banner_id->setQueryStringValue($keyValue);
                $this->article_banner_id->setOldValue($this->article_banner_id->QueryStringValue);
            } elseif (Post("article_banner_id") !== null) {
                $this->article_banner_id->setFormValue(Post("article_banner_id"));
                $this->article_banner_id->setOldValue($this->article_banner_id->FormValue);
            } else {
            ...
            if (Post("action") !== null) {
                ...
                if (($keyValue = Get("article_banner_id") ?? Route("article_banner_id")) !== null) {
                    ...
                    $this->article_banner_id->CurrentValue = null;
                }
            }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("articlebannerlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "articlebannerlist") {
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'article_banner_id' first before field var 'x_article_banner_id'
        $val = $CurrentForm->hasValue("article_banner_id") ? $CurrentForm->getValue("article_banner_id") : $CurrentForm->getValue("x_article_banner_id");
        if (!$this->article_banner_id->IsDetailKey) {
            $this->article_banner_id->setFormValue($val);
        }
		$this->image->OldUploadPath = './upload';
		$this->image->UploadPath = $this->image->OldUploadPath;
    ...
    {
        global $CurrentForm;
        $this->article_banner_id->CurrentValue = $this->article_banner_id->FormValue;
    ...
    public function renderRow()
    {
        ...
        // article_banner_id
        $this->article_banner_id->RowCssClass = "row";
