...
/**
 * Table class for peak_req_log
 */
class PeakReqLog extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'peak_req_log';
        $this->TableName = 'peak_req_log';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`peak_req_log`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`peak_req_log`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("peakreqloglist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "peakreqlogedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "peakreqlogadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PeakReqLogView";
            case Config("API_ADD_ACTION"):
                return "PeakReqLogAdd";
            case Config("API_EDIT_ACTION"):
                return "PeakReqLogEdit";
            case Config("API_DELETE_ACTION"):
                return "PeakReqLogDelete";
            case Config("API_LIST_ACTION"):
                return "PeakReqLogList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("peakreqlogview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("peakreqlogview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "peakreqlogadd?" . $this->getUrlParm($parm);
        } else {
            $url = "peakreqlogadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("peakreqlogedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("peakreqlogadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("peakreqlogdelete", $this->getUrlParm());
    }
