 ...
 * Page class
 */
class SaveLogSearchNonmemberDelete extends SaveLogSearchNonmember
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SaveLogSearchNonmemberDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("savelogsearchnonmemberlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("savelogsearchnonmemberlist"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['save_log_search_nonmember_id'];
