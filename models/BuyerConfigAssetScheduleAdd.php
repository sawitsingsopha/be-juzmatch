 ...
 * Page class
 */
class BuyerConfigAssetScheduleAdd extends BuyerConfigAssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerConfigAssetScheduleAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "buyerconfigassetscheduleview") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("buyer_asset_schedule", $detailTblVar) && $detailPage->DetailAdd) {
