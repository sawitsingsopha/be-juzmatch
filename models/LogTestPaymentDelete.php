 ...
 * Page class
 */
class LogTestPaymentDelete extends LogTestPayment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LogTestPaymentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("logtestpaymentlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("logtestpaymentlist"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['log_test_payment_id'];
