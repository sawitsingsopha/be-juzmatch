...
class ArticleEdit extends Article
{
    ...
    // Page object name
    public $PageObjName = "ArticleEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("article_id") ?? Key(0) ?? Route(2)) !== null) {
                $this->article_id->setQueryStringValue($keyValue);
                $this->article_id->setOldValue($this->article_id->QueryStringValue);
            } elseif (Post("article_id") !== null) {
                $this->article_id->setFormValue(Post("article_id"));
                $this->article_id->setOldValue($this->article_id->FormValue);
            } else {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->article_id->IsDetailKey) {
            $this->article_id->setFormValue($val);
        }
		$this->image->OldUploadPath = './upload/Juzhightlight';
		$this->image->UploadPath = $this->image->OldUploadPath;
    ...
    {
        global $CurrentForm;
        $this->article_id->CurrentValue = $this->article_id->FormValue;
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // article_category_id
            $this->article_category_id->setDbValueDef($rsnew, $this->article_category_id->CurrentValue, 0, $this->article_category_id->ReadOnly);
            ...
            // detail
            $this->detail->setDbValueDef($rsnew, $this->detail->CurrentValue, "", $this->detail->ReadOnly);

            // detail_en
            $this->detail_en->setDbValueDef($rsnew, $this->detail_en->CurrentValue, "", $this->detail_en->ReadOnly);
            ...
            // highlight
            $this->highlight->setDbValueDef($rsnew, $this->highlight->CurrentValue, null, $this->highlight->ReadOnly);

            // active_status
            $this->active_status->setDbValueDef($rsnew, $this->active_status->CurrentValue, null, $this->active_status->ReadOnly);

            // meta_title
            $this->meta_title->setDbValueDef($rsnew, $this->meta_title->CurrentValue, null, $this->meta_title->ReadOnly);

            // meta_title_en
            $this->meta_title_en->setDbValueDef($rsnew, $this->meta_title_en->CurrentValue, null, $this->meta_title_en->ReadOnly);

            // meta_description
            $this->meta_description->setDbValueDef($rsnew, $this->meta_description->CurrentValue, null, $this->meta_description->ReadOnly);

            // meta_description_en
            $this->meta_description_en->setDbValueDef($rsnew, $this->meta_description_en->CurrentValue, null, $this->meta_description_en->ReadOnly);

            // meta_keyword
            $this->meta_keyword->setDbValueDef($rsnew, $this->meta_keyword->CurrentValue, null, $this->meta_keyword->ReadOnly);

            // meta_keyword_en
            $this->meta_keyword_en->setDbValueDef($rsnew, $this->meta_keyword_en->CurrentValue, null, $this->meta_keyword_en->ReadOnly);
