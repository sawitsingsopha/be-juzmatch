 ...
 * Page class
 */
class SaveLogSearchNonmemberView extends SaveLogSearchNonmember
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SaveLogSearchNonmemberView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("save_log_search_nonmember_id") ?? Route("save_log_search_nonmember_id")) !== null) {
            $this->RecKey["save_log_search_nonmember_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("save_log_search_nonmember_id") ?? Route("save_log_search_nonmember_id")) !== null) {
                ...
                $this->RecKey["save_log_search_nonmember_id"] = $this->save_log_search_nonmember_id->QueryStringValue;
                ...
                $this->RecKey["save_log_search_nonmember_id"] = $this->save_log_search_nonmember_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->save_log_search_nonmember_id->setQueryStringValue($keyValue);
                $this->RecKey["save_log_search_nonmember_id"] = $this->save_log_search_nonmember_id->QueryStringValue;
            } else {
                $returnUrl = "savelogsearchnonmemberlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "savelogsearchnonmemberlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "savelogsearchnonmemberlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
