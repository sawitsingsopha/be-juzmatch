...
/**
 * Table class for member_scb_detail
 */
class MemberScbDetail extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'member_scb_detail';
        $this->TableName = 'member_scb_detail';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`member_scb_detail`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->member_scb_detail_id = new DbField(
            'member_scb_detail',
            'member_scb_detail',
            'x_member_scb_detail_id',
            'member_scb_detail_id',
            '`member_scb_detail_id`',
            '`member_scb_detail_id`',
            3,
        ...
        $this->member_scb_detail_id->InputTextType = "text";
        $this->member_scb_detail_id->IsAutoIncrement = true; // Autoincrement field
        $this->member_scb_detail_id->IsPrimaryKey = true; // Primary key field
        $this->member_scb_detail_id->Sortable = false; // Allow sort
        $this->member_scb_detail_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['member_scb_detail_id'] = &$this->member_scb_detail_id;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`member_scb_detail`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->member_scb_detail_id->setDbValue($conn->lastInsertId());
            $rs['member_scb_detail_id'] = $this->member_scb_detail_id->DbValue;
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('member_scb_detail_id', $rs)) {
                AddFilter($where, QuotedName('member_scb_detail_id', $this->Dbid) . '=' . QuotedValue($rs['member_scb_detail_id'], $this->member_scb_detail_id->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->member_scb_detail_id->DbValue = $row['member_scb_detail_id'];
    ...
    {
        return "`member_scb_detail_id` = @member_scb_detail_id@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->member_scb_detail_id->CurrentValue : $this->member_scb_detail_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->member_scb_detail_id->CurrentValue = $keys[0];
            } else {
                $this->member_scb_detail_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('member_scb_detail_id', $row) ? $row['member_scb_detail_id'] : null;
        } else {
            $val = $this->member_scb_detail_id->OldValue !== null ? $this->member_scb_detail_id->OldValue : $this->member_scb_detail_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@member_scb_detail_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("memberscbdetaillist");
    }
    ...
    {
        global $Language;
        if ($pageName == "memberscbdetailview") {
            return $Language->phrase("View");
        } elseif ($pageName == "memberscbdetailedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "memberscbdetailadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MemberScbDetailView";
            case Config("API_ADD_ACTION"):
                return "MemberScbDetailAdd";
            case Config("API_EDIT_ACTION"):
                return "MemberScbDetailEdit";
            case Config("API_DELETE_ACTION"):
                return "MemberScbDetailDelete";
            case Config("API_LIST_ACTION"):
                return "MemberScbDetailList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("memberscbdetailview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("memberscbdetailview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "memberscbdetailadd?" . $this->getUrlParm($parm);
        } else {
            $url = "memberscbdetailadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("memberscbdetailedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("memberscbdetailadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("memberscbdetaildelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "\"member_scb_detail_id\":" . JsonEncode($this->member_scb_detail_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->member_scb_detail_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->member_scb_detail_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("member_scb_detail_id") ?? Route("member_scb_detail_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->member_scb_detail_id->CurrentValue = $key;
            } else {
                $this->member_scb_detail_id->OldValue = $key;
            }
    ...
    public function renderListRow()
    {
        ...
        // member_scb_detail_id
        $this->member_scb_detail_id->ViewValue = $this->member_scb_detail_id->CurrentValue;
        $this->member_scb_detail_id->ViewCustomAttributes = "";
        ...
        // member_scb_detail_id
        $this->member_scb_detail_id->LinkCustomAttributes = "";
        $this->member_scb_detail_id->HrefValue = "";
        $this->member_scb_detail_id->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // member_scb_detail_id
        $this->member_scb_detail_id->setupEditAttributes();
        $this->member_scb_detail_id->EditCustomAttributes = "";
        $this->member_scb_detail_id->EditValue = $this->member_scb_detail_id->CurrentValue;
        $this->member_scb_detail_id->ViewCustomAttributes = "";
        ...
        if (strval($this->member_scb_id->EditValue) != "" && is_numeric($this->member_scb_id->EditValue)) {
            $this->member_scb_id->EditValue = $this->member_scb_id->EditValue;
        }
