 ...
 * Page class
 */
class SellerAppointmentEdit extends SellerAppointment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SellerAppointmentEdit";
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if ($pageName != $this->getListUrl()) { // Not List page
                    ...
                    if ($pageName == "sellerappointmentview") {
                        $row["view"] = "1";
                    }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("sellerappointmentlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "sellerappointmentlist") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("sellerappointmentlist"), "", $this->TableVar, true);
        $pageId = "edit";
