 ...
 * Page class
 */
class AssetWarningDelete extends AssetWarning
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetWarningDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("assetwarninglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("assetwarninglist"); // Return to list
                return;
            }
        }
