 ...
 * Page class
 */
class AllBuyerConfigAssetScheduleGrid extends AllBuyerConfigAssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AllBuyerConfigAssetScheduleGrid";
    ...
    public $FormName = "fall_buyer_config_asset_schedulegrid";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "allbuyerconfigassetscheduleadd";
    ...
    protected function clearInlineMode()
    {
        ...
        $this->annual_interest->FormValue = ""; // Clear form value
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_annual_interest") && $CurrentForm->hasValue("o_annual_interest") && $this->annual_interest->CurrentValue != $this->annual_interest->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->annual_interest->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_annual_interest")) {
            $this->annual_interest->setOldValue($CurrentForm->getValue("o_annual_interest"));
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (strval($this->annual_interest->EditValue) != "" && is_numeric($this->annual_interest->EditValue)) {
                ...
                $this->annual_interest->OldValue = $this->annual_interest->EditValue;
            }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // annual_interest
            $this->annual_interest->setDbValueDef($rsnew, $this->annual_interest->CurrentValue, null, $this->annual_interest->ReadOnly);
