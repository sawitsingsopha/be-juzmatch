 ...
 * Page class
 */
class BuyerAssetRentGrid extends BuyerAssetRent
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerAssetRentGrid";
    ...
    public $FormName = "fbuyer_asset_rentgrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_pay_number_half_price_1") && $CurrentForm->hasValue("o_pay_number_half_price_1") && $this->pay_number_half_price_1->CurrentValue != $this->pay_number_half_price_1->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_date_pay_half_price_1") && $CurrentForm->hasValue("o_date_pay_half_price_1") && $this->date_pay_half_price_1->CurrentValue != $this->date_pay_half_price_1->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_pay_number_half_price_2") && $CurrentForm->hasValue("o_pay_number_half_price_2") && $this->pay_number_half_price_2->CurrentValue != $this->pay_number_half_price_2->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_date_pay_half_price_2") && $CurrentForm->hasValue("o_date_pay_half_price_2") && $this->date_pay_half_price_2->CurrentValue != $this->date_pay_half_price_2->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->pay_number_half_price_1->clearErrorMessage();
        $this->date_pay_half_price_1->clearErrorMessage();
        ...
        $this->pay_number_half_price_2->clearErrorMessage();
        $this->date_pay_half_price_2->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_pay_number_half_price_1")) {
            $this->pay_number_half_price_1->setOldValue($CurrentForm->getValue("o_pay_number_half_price_1"));
        }
        ...
        if ($CurrentForm->hasValue("o_date_pay_half_price_1")) {
            $this->date_pay_half_price_1->setOldValue($CurrentForm->getValue("o_date_pay_half_price_1"));
        }
        ...
        if ($CurrentForm->hasValue("o_pay_number_half_price_2")) {
            $this->pay_number_half_price_2->setOldValue($CurrentForm->getValue("o_pay_number_half_price_2"));
        }
        ...
        if ($CurrentForm->hasValue("o_date_pay_half_price_2")) {
            $this->date_pay_half_price_2->setOldValue($CurrentForm->getValue("o_date_pay_half_price_2"));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            $this->one_time_status->setDbValueDef($rsnew, $tmpBool, 0, $this->one_time_status->ReadOnly);

            // half_price_1
            $this->half_price_1->setDbValueDef($rsnew, $this->half_price_1->CurrentValue, null, $this->half_price_1->ReadOnly);

            // status_pay_half_price_1
            $this->status_pay_half_price_1->setDbValueDef($rsnew, $this->status_pay_half_price_1->CurrentValue, null, $this->status_pay_half_price_1->ReadOnly);

            // pay_number_half_price_1
            $this->pay_number_half_price_1->setDbValueDef($rsnew, $this->pay_number_half_price_1->CurrentValue, null, $this->pay_number_half_price_1->ReadOnly);

            // date_pay_half_price_1
            $this->date_pay_half_price_1->setDbValueDef($rsnew, UnFormatDateTime($this->date_pay_half_price_1->CurrentValue, $this->date_pay_half_price_1->formatPattern()), null, $this->date_pay_half_price_1->ReadOnly);
            ...
            // half_price_2
            $this->half_price_2->setDbValueDef($rsnew, $this->half_price_2->CurrentValue, null, $this->half_price_2->ReadOnly);

            // status_pay_half_price_2
            $this->status_pay_half_price_2->setDbValueDef($rsnew, $this->status_pay_half_price_2->CurrentValue, null, $this->status_pay_half_price_2->ReadOnly);

            // pay_number_half_price_2
            $this->pay_number_half_price_2->setDbValueDef($rsnew, $this->pay_number_half_price_2->CurrentValue, null, $this->pay_number_half_price_2->ReadOnly);

            // date_pay_half_price_2
            $this->date_pay_half_price_2->setDbValueDef($rsnew, UnFormatDateTime($this->date_pay_half_price_2->CurrentValue, $this->date_pay_half_price_2->formatPattern()), null, $this->date_pay_half_price_2->ReadOnly);
