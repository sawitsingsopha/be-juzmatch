 ...
 * Page class
 */
class AssetCategoryPreview extends AssetCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetCategoryPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "category") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=category&" . GetForeignKeyUrl("fk_category_id", $this->category_id->QueryStringValue) . "";
        }
    ...
    protected function setupForeignKeysFromFilter($f)
    {
        ...
        if ($masterTblVar == "category") {
            ...
            if ($x !== false) {
                ...
                $this->category_id->setQueryStringValue($val);
            }
        }
        if ($masterTblVar == "asset") {
            $find = "`asset_id`=";
