...
/**
 * Table class for article_category
 */
class ArticleCategory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'article_category';
        $this->TableName = 'article_category';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`article_category`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->article_category_id->IsAutoIncrement = true; // Autoincrement field
        $this->article_category_id->IsPrimaryKey = true; // Primary key field
        ...
        // article_title_en
        $this->article_title_en = new DbField(
            'article_category',
            'article_category',
            'x_article_title_en',
            'article_title_en',
        ...
        $this->article_title_en->InputTextType = "text";
        $this->article_title_en->Nullable = false; // NOT NULL field
        $this->article_title_en->Required = true; // Required field
        $this->Fields['article_title_en'] = &$this->article_title_en;
        ...
        $this->active_status->Lookup = new Lookup('active_status', 'article_category', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`article_category`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->article_category_id->setDbValue($conn->lastInsertId());
            $rs['article_category_id'] = $this->article_category_id->DbValue;
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('article_category_id', $rs)) {
                AddFilter($where, QuotedName('article_category_id', $this->Dbid) . '=' . QuotedValue($rs['article_category_id'], $this->article_category_id->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->article_title_en->DbValue = $row['article_title_en'];
    ...
    {
        return "`article_category_id` = @article_category_id@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->article_category_id->CurrentValue : $this->article_category_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->article_category_id->CurrentValue = $keys[0];
            } else {
                $this->article_category_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('article_category_id', $row) ? $row['article_category_id'] : null;
        } else {
            $val = $this->article_category_id->OldValue !== null ? $this->article_category_id->OldValue : $this->article_category_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@article_category_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("articlecategorylist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "articlecategoryedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "articlecategoryadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "ArticleCategoryAdd";
            case Config("API_EDIT_ACTION"):
                return "ArticleCategoryEdit";
            case Config("API_DELETE_ACTION"):
                return "ArticleCategoryDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("articlecategoryview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("articlecategoryview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "articlecategoryadd?" . $this->getUrlParm($parm);
        } else {
            $url = "articlecategoryadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("articlecategoryedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("articlecategoryadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("articlecategorydelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "\"article_category_id\":" . JsonEncode($this->article_category_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->article_category_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->article_category_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("article_category_id") ?? Route("article_category_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->article_category_id->CurrentValue = $key;
            } else {
                $this->article_category_id->OldValue = $key;
            }
    ...
    public function renderListRow()
    {
        ...
        $this->article_title_en->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->article_category_id->EditValue = $this->article_category_id->CurrentValue;
        $this->article_category_id->ViewCustomAttributes = "";
        ...
        $this->article_title_en->EditValue = $this->article_title_en->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->article_title_en);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->article_title_en);
