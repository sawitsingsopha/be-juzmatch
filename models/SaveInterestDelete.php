 ...
 * Page class
 */
class SaveInterestDelete extends SaveInterest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SaveInterestDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("saveinterestlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("saveinterestlist"); // Return to list
                return;
            }
        }
