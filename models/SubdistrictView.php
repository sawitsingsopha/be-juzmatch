 ...
 * Page class
 */
class SubdistrictView extends Subdistrict
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubdistrictView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("subdistrict_id") ?? Route("subdistrict_id")) !== null) {
            $this->RecKey["subdistrict_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("subdistrict_id") ?? Route("subdistrict_id")) !== null) {
                ...
                $this->RecKey["subdistrict_id"] = $this->subdistrict_id->QueryStringValue;
            } elseif (Post("subdistrict_id") !== null) {
                $this->subdistrict_id->setFormValue(Post("subdistrict_id"));
                $this->RecKey["subdistrict_id"] = $this->subdistrict_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->subdistrict_id->setQueryStringValue($keyValue);
                $this->RecKey["subdistrict_id"] = $this->subdistrict_id->QueryStringValue;
            } else {
                $returnUrl = "subdistrictlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "subdistrictlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "subdistrictlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
