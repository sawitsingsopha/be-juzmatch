 ...
 * Page class
 */
class AssetScheduleView extends AssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetScheduleView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("asset_schedule_id") ?? Route("asset_schedule_id")) !== null) {
                ...
                $returnUrl = "assetschedulelist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "assetschedulelist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "assetschedulelist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
