...
/**
 * Table class for master_asset_interested
 */
class MasterAssetInterested extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'master_asset_interested';
        $this->TableName = 'master_asset_interested';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`master_asset_interested`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->master_asset_interested_id->IsAutoIncrement = true; // Autoincrement field
        $this->master_asset_interested_id->IsPrimaryKey = true; // Primary key field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`master_asset_interested`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->master_asset_interested_id->setDbValue($conn->lastInsertId());
            $rs['master_asset_interested_id'] = $this->master_asset_interested_id->DbValue;
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('master_asset_interested_id', $rs)) {
                AddFilter($where, QuotedName('master_asset_interested_id', $this->Dbid) . '=' . QuotedValue($rs['master_asset_interested_id'], $this->master_asset_interested_id->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    {
        return "`master_asset_interested_id` = @master_asset_interested_id@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->master_asset_interested_id->CurrentValue : $this->master_asset_interested_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->master_asset_interested_id->CurrentValue = $keys[0];
            } else {
                $this->master_asset_interested_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('master_asset_interested_id', $row) ? $row['master_asset_interested_id'] : null;
        } else {
            $val = $this->master_asset_interested_id->OldValue !== null ? $this->master_asset_interested_id->OldValue : $this->master_asset_interested_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@master_asset_interested_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("masterassetinterestedlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "masterassetinterestedview") {
            return $Language->phrase("View");
        } elseif ($pageName == "masterassetinterestededit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "masterassetinterestedadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MasterAssetInterestedView";
            case Config("API_ADD_ACTION"):
                return "MasterAssetInterestedAdd";
            case Config("API_EDIT_ACTION"):
                return "MasterAssetInterestedEdit";
            case Config("API_DELETE_ACTION"):
                return "MasterAssetInterestedDelete";
            case Config("API_LIST_ACTION"):
                return "MasterAssetInterestedList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("masterassetinterestedview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("masterassetinterestedview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "masterassetinterestedadd?" . $this->getUrlParm($parm);
        } else {
            $url = "masterassetinterestedadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("masterassetinterestededit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("masterassetinterestedadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("masterassetinteresteddelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "\"master_asset_interested_id\":" . JsonEncode($this->master_asset_interested_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->master_asset_interested_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->master_asset_interested_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("master_asset_interested_id") ?? Route("master_asset_interested_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->master_asset_interested_id->CurrentValue = $key;
            } else {
                $this->master_asset_interested_id->OldValue = $key;
            }
    ...
    public function renderListRow()
    {
        ...
        // master_asset_interested_id
        $this->master_asset_interested_id->ViewValue = $this->master_asset_interested_id->CurrentValue;
    ...
    public function renderEditRow()
    {
        ...
        $this->master_asset_interested_id->EditValue = $this->master_asset_interested_id->CurrentValue;
        $this->master_asset_interested_id->ViewCustomAttributes = "";
