 ...
 * Page class
 */
class ArticleBannerList extends ArticleBanner
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArticleBannerList";
    ...
    public $FormName = "farticle_bannerlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "articlebanneradd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "articlebannerdelete";
        $this->MultiUpdateUrl = "articlebannerupdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "farticle_bannersrch");
        }
        $filterList = Concat($filterList, $this->article_banner_id->AdvancedSearch->toJson(), ","); // Field article_banner_id
        $filterList = Concat($filterList, $this->article_title->AdvancedSearch->toJson(), ","); // Field article_title
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "farticle_bannersrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field article_banner_id
        $this->article_banner_id->AdvancedSearch->SearchValue = @$filter["x_article_banner_id"];
        $this->article_banner_id->AdvancedSearch->SearchOperator = @$filter["z_article_banner_id"];
        $this->article_banner_id->AdvancedSearch->SearchCondition = @$filter["v_article_banner_id"];
        $this->article_banner_id->AdvancedSearch->SearchValue2 = @$filter["y_article_banner_id"];
        $this->article_banner_id->AdvancedSearch->SearchOperator2 = @$filter["w_article_banner_id"];
        $this->article_banner_id->AdvancedSearch->save();

        // Field article_title
        $this->article_title->AdvancedSearch->SearchValue = @$filter["x_article_title"];
        $this->article_title->AdvancedSearch->SearchOperator = @$filter["z_article_title"];
        $this->article_title->AdvancedSearch->SearchCondition = @$filter["v_article_title"];
        $this->article_title->AdvancedSearch->SearchValue2 = @$filter["y_article_title"];
        $this->article_title->AdvancedSearch->SearchOperator2 = @$filter["w_article_title"];
        $this->article_title->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->article_banner_id, $default, false); // article_banner_id
        $this->buildSearchSql($where, $this->article_title, $default, false); // article_title
        ...
        if (!$default && $this->Command == "search") {
            $this->article_banner_id->AdvancedSearch->save(); // article_banner_id
            $this->article_title->AdvancedSearch->save(); // article_title
    ...
    {
        if ($this->article_banner_id->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->article_title->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    {
        $this->article_banner_id->AdvancedSearch->unsetSession();
        $this->article_title->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->article_banner_id->AdvancedSearch->load();
        $this->article_title->AdvancedSearch->load();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->article_title, $ctrl); // article_title
            $this->updateSort($this->image, $ctrl); // image
            $this->updateSort($this->order_by, $ctrl); // order_by
            $this->updateSort($this->active_status, $ctrl); // active_status
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->article_banner_id->setSort("");
                $this->article_title->setSort("");
                $this->image->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"farticle_bannerlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"farticle_bannerlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->article_banner_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("article_title", $this->createColumnOption("article_title"));
            $option->add("image", $this->createColumnOption("image"));
            $option->add("order_by", $this->createColumnOption("order_by"));
            $option->add("active_status", $this->createColumnOption("active_status"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"farticle_bannersrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"farticle_bannersrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="farticle_bannerlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function loadSearchValues()
    {
        ...
        // article_banner_id
        if ($this->article_banner_id->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->article_banner_id->AdvancedSearch->SearchValue != "" || $this->article_banner_id->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // article_title
        if ($this->article_title->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->article_title->AdvancedSearch->SearchValue != "" || $this->article_title->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (!$this->isExport()) {
                $this->article_title->ViewValue = $this->highlightValue($this->article_title);
            }
            ...
            if ($this->image->UseColorbox) {
                ...
                $this->image->LinkAttrs["data-rel"] = "article_banner_x" . $this->RowCount . "_image";
            ...
            if (!$this->article_title->Raw) {
                $this->article_title->AdvancedSearch->SearchValue = HtmlDecode($this->article_title->AdvancedSearch->SearchValue);
            }
            $this->article_title->EditValue = HtmlEncode($this->article_title->AdvancedSearch->SearchValue);
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="farticle_bannerlist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"farticle_bannersrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        $item->Body = "<a class=\"btn btn-default ew-highlight active\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-ew-action=\"highlight\" data-form=\"farticle_bannersrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
    ...
    {
        return $this->article_title->Visible || $this->active_status->Visible;
    }
