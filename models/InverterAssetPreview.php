 ...
 * Page class
 */
class InverterAssetPreview extends InverterAsset
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InverterAssetPreview";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("inverterassetlist"), "", $this->TableVar, true);
        $pageId = "preview";
