 ...
 * Page class
 */
class PeakContactList extends PeakContact
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakContactList";
    ...
    public $FormName = "fpeak_contactlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "peakcontactadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "peakcontactdelete";
        $this->MultiUpdateUrl = "peakcontactupdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fpeak_contactsrch");
        }
        ...
        $filterList = Concat($filterList, $this->contact_code->AdvancedSearch->toJson(), ","); // Field contact_code
        $filterList = Concat($filterList, $this->contact_name->AdvancedSearch->toJson(), ","); // Field contact_name
        $filterList = Concat($filterList, $this->contact_type->AdvancedSearch->toJson(), ","); // Field contact_type
        $filterList = Concat($filterList, $this->contact_taxnumber->AdvancedSearch->toJson(), ","); // Field contact_taxnumber
        $filterList = Concat($filterList, $this->contact_branchcode->AdvancedSearch->toJson(), ","); // Field contact_branchcode
        $filterList = Concat($filterList, $this->contact_address->AdvancedSearch->toJson(), ","); // Field contact_address
        $filterList = Concat($filterList, $this->contact_subdistrict->AdvancedSearch->toJson(), ","); // Field contact_subdistrict
        $filterList = Concat($filterList, $this->contact_district->AdvancedSearch->toJson(), ","); // Field contact_district
        $filterList = Concat($filterList, $this->contact_province->AdvancedSearch->toJson(), ","); // Field contact_province
        $filterList = Concat($filterList, $this->contact_country->AdvancedSearch->toJson(), ","); // Field contact_country
        $filterList = Concat($filterList, $this->contact_postcode->AdvancedSearch->toJson(), ","); // Field contact_postcode
        $filterList = Concat($filterList, $this->contact_callcenternumber->AdvancedSearch->toJson(), ","); // Field contact_callcenternumber
        $filterList = Concat($filterList, $this->contact_faxnumber->AdvancedSearch->toJson(), ","); // Field contact_faxnumber
        $filterList = Concat($filterList, $this->contact_email->AdvancedSearch->toJson(), ","); // Field contact_email
        $filterList = Concat($filterList, $this->contact_website->AdvancedSearch->toJson(), ","); // Field contact_website
        $filterList = Concat($filterList, $this->contact_contactfirstname->AdvancedSearch->toJson(), ","); // Field contact_contactfirstname
        $filterList = Concat($filterList, $this->contact_contactlastname->AdvancedSearch->toJson(), ","); // Field contact_contactlastname
        $filterList = Concat($filterList, $this->contact_contactnickname->AdvancedSearch->toJson(), ","); // Field contact_contactnickname
        $filterList = Concat($filterList, $this->contact_contactpostition->AdvancedSearch->toJson(), ","); // Field contact_contactpostition
        $filterList = Concat($filterList, $this->contact_contactphonenumber->AdvancedSearch->toJson(), ","); // Field contact_contactphonenumber
        $filterList = Concat($filterList, $this->contact_contactcontactemail->AdvancedSearch->toJson(), ","); // Field contact_contactcontactemail
        $filterList = Concat($filterList, $this->contact_purchaseaccount->AdvancedSearch->toJson(), ","); // Field contact_purchaseaccount
        $filterList = Concat($filterList, $this->contact_sellaccount->AdvancedSearch->toJson(), ","); // Field contact_sellaccount
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpeak_contactsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field contact_code
        $this->contact_code->AdvancedSearch->SearchValue = @$filter["x_contact_code"];
        $this->contact_code->AdvancedSearch->SearchOperator = @$filter["z_contact_code"];
        $this->contact_code->AdvancedSearch->SearchCondition = @$filter["v_contact_code"];
        $this->contact_code->AdvancedSearch->SearchValue2 = @$filter["y_contact_code"];
        $this->contact_code->AdvancedSearch->SearchOperator2 = @$filter["w_contact_code"];
        $this->contact_code->AdvancedSearch->save();
        ...
        // Field contact_taxnumber
        $this->contact_taxnumber->AdvancedSearch->SearchValue = @$filter["x_contact_taxnumber"];
        $this->contact_taxnumber->AdvancedSearch->SearchOperator = @$filter["z_contact_taxnumber"];
        $this->contact_taxnumber->AdvancedSearch->SearchCondition = @$filter["v_contact_taxnumber"];
        $this->contact_taxnumber->AdvancedSearch->SearchValue2 = @$filter["y_contact_taxnumber"];
        $this->contact_taxnumber->AdvancedSearch->SearchOperator2 = @$filter["w_contact_taxnumber"];
        $this->contact_taxnumber->AdvancedSearch->save();

        // Field contact_branchcode
        $this->contact_branchcode->AdvancedSearch->SearchValue = @$filter["x_contact_branchcode"];
        $this->contact_branchcode->AdvancedSearch->SearchOperator = @$filter["z_contact_branchcode"];
        $this->contact_branchcode->AdvancedSearch->SearchCondition = @$filter["v_contact_branchcode"];
        $this->contact_branchcode->AdvancedSearch->SearchValue2 = @$filter["y_contact_branchcode"];
        $this->contact_branchcode->AdvancedSearch->SearchOperator2 = @$filter["w_contact_branchcode"];
        $this->contact_branchcode->AdvancedSearch->save();
        ...
        // Field contact_subdistrict
        $this->contact_subdistrict->AdvancedSearch->SearchValue = @$filter["x_contact_subdistrict"];
        $this->contact_subdistrict->AdvancedSearch->SearchOperator = @$filter["z_contact_subdistrict"];
        $this->contact_subdistrict->AdvancedSearch->SearchCondition = @$filter["v_contact_subdistrict"];
        $this->contact_subdistrict->AdvancedSearch->SearchValue2 = @$filter["y_contact_subdistrict"];
        $this->contact_subdistrict->AdvancedSearch->SearchOperator2 = @$filter["w_contact_subdistrict"];
        $this->contact_subdistrict->AdvancedSearch->save();

        // Field contact_district
        $this->contact_district->AdvancedSearch->SearchValue = @$filter["x_contact_district"];
        $this->contact_district->AdvancedSearch->SearchOperator = @$filter["z_contact_district"];
        $this->contact_district->AdvancedSearch->SearchCondition = @$filter["v_contact_district"];
        $this->contact_district->AdvancedSearch->SearchValue2 = @$filter["y_contact_district"];
        $this->contact_district->AdvancedSearch->SearchOperator2 = @$filter["w_contact_district"];
        $this->contact_district->AdvancedSearch->save();

        // Field contact_province
        $this->contact_province->AdvancedSearch->SearchValue = @$filter["x_contact_province"];
        $this->contact_province->AdvancedSearch->SearchOperator = @$filter["z_contact_province"];
        $this->contact_province->AdvancedSearch->SearchCondition = @$filter["v_contact_province"];
        $this->contact_province->AdvancedSearch->SearchValue2 = @$filter["y_contact_province"];
        $this->contact_province->AdvancedSearch->SearchOperator2 = @$filter["w_contact_province"];
        $this->contact_province->AdvancedSearch->save();

        // Field contact_country
        $this->contact_country->AdvancedSearch->SearchValue = @$filter["x_contact_country"];
        $this->contact_country->AdvancedSearch->SearchOperator = @$filter["z_contact_country"];
        $this->contact_country->AdvancedSearch->SearchCondition = @$filter["v_contact_country"];
        $this->contact_country->AdvancedSearch->SearchValue2 = @$filter["y_contact_country"];
        $this->contact_country->AdvancedSearch->SearchOperator2 = @$filter["w_contact_country"];
        $this->contact_country->AdvancedSearch->save();

        // Field contact_postcode
        $this->contact_postcode->AdvancedSearch->SearchValue = @$filter["x_contact_postcode"];
        $this->contact_postcode->AdvancedSearch->SearchOperator = @$filter["z_contact_postcode"];
        $this->contact_postcode->AdvancedSearch->SearchCondition = @$filter["v_contact_postcode"];
        $this->contact_postcode->AdvancedSearch->SearchValue2 = @$filter["y_contact_postcode"];
        $this->contact_postcode->AdvancedSearch->SearchOperator2 = @$filter["w_contact_postcode"];
        $this->contact_postcode->AdvancedSearch->save();

        // Field contact_callcenternumber
        $this->contact_callcenternumber->AdvancedSearch->SearchValue = @$filter["x_contact_callcenternumber"];
        $this->contact_callcenternumber->AdvancedSearch->SearchOperator = @$filter["z_contact_callcenternumber"];
        $this->contact_callcenternumber->AdvancedSearch->SearchCondition = @$filter["v_contact_callcenternumber"];
        $this->contact_callcenternumber->AdvancedSearch->SearchValue2 = @$filter["y_contact_callcenternumber"];
        $this->contact_callcenternumber->AdvancedSearch->SearchOperator2 = @$filter["w_contact_callcenternumber"];
        $this->contact_callcenternumber->AdvancedSearch->save();

        // Field contact_faxnumber
        $this->contact_faxnumber->AdvancedSearch->SearchValue = @$filter["x_contact_faxnumber"];
        $this->contact_faxnumber->AdvancedSearch->SearchOperator = @$filter["z_contact_faxnumber"];
        $this->contact_faxnumber->AdvancedSearch->SearchCondition = @$filter["v_contact_faxnumber"];
        $this->contact_faxnumber->AdvancedSearch->SearchValue2 = @$filter["y_contact_faxnumber"];
        $this->contact_faxnumber->AdvancedSearch->SearchOperator2 = @$filter["w_contact_faxnumber"];
        $this->contact_faxnumber->AdvancedSearch->save();
        ...
        $this->contact_website->AdvancedSearch->SearchValue = @$filter["x_contact_website"];
        $this->contact_website->AdvancedSearch->SearchOperator = @$filter["z_contact_website"];
        $this->contact_website->AdvancedSearch->SearchCondition = @$filter["v_contact_website"];
        $this->contact_website->AdvancedSearch->SearchValue2 = @$filter["y_contact_website"];
        $this->contact_website->AdvancedSearch->SearchOperator2 = @$filter["w_contact_website"];
        $this->contact_website->AdvancedSearch->save();

        // Field contact_contactfirstname
        $this->contact_contactfirstname->AdvancedSearch->SearchValue = @$filter["x_contact_contactfirstname"];
        $this->contact_contactfirstname->AdvancedSearch->SearchOperator = @$filter["z_contact_contactfirstname"];
        $this->contact_contactfirstname->AdvancedSearch->SearchCondition = @$filter["v_contact_contactfirstname"];
        $this->contact_contactfirstname->AdvancedSearch->SearchValue2 = @$filter["y_contact_contactfirstname"];
        $this->contact_contactfirstname->AdvancedSearch->SearchOperator2 = @$filter["w_contact_contactfirstname"];
        $this->contact_contactfirstname->AdvancedSearch->save();

        // Field contact_contactlastname
        $this->contact_contactlastname->AdvancedSearch->SearchValue = @$filter["x_contact_contactlastname"];
        $this->contact_contactlastname->AdvancedSearch->SearchOperator = @$filter["z_contact_contactlastname"];
        $this->contact_contactlastname->AdvancedSearch->SearchCondition = @$filter["v_contact_contactlastname"];
        $this->contact_contactlastname->AdvancedSearch->SearchValue2 = @$filter["y_contact_contactlastname"];
        $this->contact_contactlastname->AdvancedSearch->SearchOperator2 = @$filter["w_contact_contactlastname"];
        $this->contact_contactlastname->AdvancedSearch->save();

        // Field contact_contactnickname
        $this->contact_contactnickname->AdvancedSearch->SearchValue = @$filter["x_contact_contactnickname"];
        $this->contact_contactnickname->AdvancedSearch->SearchOperator = @$filter["z_contact_contactnickname"];
        $this->contact_contactnickname->AdvancedSearch->SearchCondition = @$filter["v_contact_contactnickname"];
        $this->contact_contactnickname->AdvancedSearch->SearchValue2 = @$filter["y_contact_contactnickname"];
        $this->contact_contactnickname->AdvancedSearch->SearchOperator2 = @$filter["w_contact_contactnickname"];
        $this->contact_contactnickname->AdvancedSearch->save();

        // Field contact_contactpostition
        $this->contact_contactpostition->AdvancedSearch->SearchValue = @$filter["x_contact_contactpostition"];
        $this->contact_contactpostition->AdvancedSearch->SearchOperator = @$filter["z_contact_contactpostition"];
        $this->contact_contactpostition->AdvancedSearch->SearchCondition = @$filter["v_contact_contactpostition"];
        $this->contact_contactpostition->AdvancedSearch->SearchValue2 = @$filter["y_contact_contactpostition"];
        $this->contact_contactpostition->AdvancedSearch->SearchOperator2 = @$filter["w_contact_contactpostition"];
        $this->contact_contactpostition->AdvancedSearch->save();

        // Field contact_contactphonenumber
        $this->contact_contactphonenumber->AdvancedSearch->SearchValue = @$filter["x_contact_contactphonenumber"];
        $this->contact_contactphonenumber->AdvancedSearch->SearchOperator = @$filter["z_contact_contactphonenumber"];
        $this->contact_contactphonenumber->AdvancedSearch->SearchCondition = @$filter["v_contact_contactphonenumber"];
        $this->contact_contactphonenumber->AdvancedSearch->SearchValue2 = @$filter["y_contact_contactphonenumber"];
        $this->contact_contactphonenumber->AdvancedSearch->SearchOperator2 = @$filter["w_contact_contactphonenumber"];
        $this->contact_contactphonenumber->AdvancedSearch->save();

        // Field contact_contactcontactemail
        $this->contact_contactcontactemail->AdvancedSearch->SearchValue = @$filter["x_contact_contactcontactemail"];
        $this->contact_contactcontactemail->AdvancedSearch->SearchOperator = @$filter["z_contact_contactcontactemail"];
        $this->contact_contactcontactemail->AdvancedSearch->SearchCondition = @$filter["v_contact_contactcontactemail"];
        $this->contact_contactcontactemail->AdvancedSearch->SearchValue2 = @$filter["y_contact_contactcontactemail"];
        $this->contact_contactcontactemail->AdvancedSearch->SearchOperator2 = @$filter["w_contact_contactcontactemail"];
        $this->contact_contactcontactemail->AdvancedSearch->save();

        // Field contact_purchaseaccount
        $this->contact_purchaseaccount->AdvancedSearch->SearchValue = @$filter["x_contact_purchaseaccount"];
        $this->contact_purchaseaccount->AdvancedSearch->SearchOperator = @$filter["z_contact_purchaseaccount"];
        $this->contact_purchaseaccount->AdvancedSearch->SearchCondition = @$filter["v_contact_purchaseaccount"];
        $this->contact_purchaseaccount->AdvancedSearch->SearchValue2 = @$filter["y_contact_purchaseaccount"];
        $this->contact_purchaseaccount->AdvancedSearch->SearchOperator2 = @$filter["w_contact_purchaseaccount"];
        $this->contact_purchaseaccount->AdvancedSearch->save();

        // Field contact_sellaccount
        $this->contact_sellaccount->AdvancedSearch->SearchValue = @$filter["x_contact_sellaccount"];
        $this->contact_sellaccount->AdvancedSearch->SearchOperator = @$filter["z_contact_sellaccount"];
        $this->contact_sellaccount->AdvancedSearch->SearchCondition = @$filter["v_contact_sellaccount"];
        $this->contact_sellaccount->AdvancedSearch->SearchValue2 = @$filter["y_contact_sellaccount"];
        $this->contact_sellaccount->AdvancedSearch->SearchOperator2 = @$filter["w_contact_sellaccount"];
        $this->contact_sellaccount->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->contact_id;
        $searchFlds[] = &$this->contact_code;
        $searchFlds[] = &$this->contact_name;
        $searchFlds[] = &$this->contact_taxnumber;
        $searchFlds[] = &$this->contact_branchcode;
        $searchFlds[] = &$this->contact_address;
        $searchFlds[] = &$this->contact_subdistrict;
        $searchFlds[] = &$this->contact_district;
        $searchFlds[] = &$this->contact_province;
        $searchFlds[] = &$this->contact_country;
        $searchFlds[] = &$this->contact_postcode;
        $searchFlds[] = &$this->contact_callcenternumber;
        $searchFlds[] = &$this->contact_faxnumber;
        $searchFlds[] = &$this->contact_email;
        $searchFlds[] = &$this->contact_website;
        $searchFlds[] = &$this->contact_contactfirstname;
        $searchFlds[] = &$this->contact_contactlastname;
        $searchFlds[] = &$this->contact_contactnickname;
        $searchFlds[] = &$this->contact_contactpostition;
        $searchFlds[] = &$this->contact_contactphonenumber;
        $searchFlds[] = &$this->contact_contactcontactemail;
        $searchFlds[] = &$this->contact_purchaseaccount;
        $searchFlds[] = &$this->contact_sellaccount;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->contact_id, $ctrl); // contact_id
            $this->updateSort($this->contact_code, $ctrl); // contact_code
            $this->updateSort($this->contact_name, $ctrl); // contact_name
            $this->updateSort($this->contact_type, $ctrl); // contact_type
            $this->updateSort($this->contact_taxnumber, $ctrl); // contact_taxnumber
            $this->updateSort($this->contact_branchcode, $ctrl); // contact_branchcode
            $this->updateSort($this->contact_address, $ctrl); // contact_address
            $this->updateSort($this->contact_subdistrict, $ctrl); // contact_subdistrict
            $this->updateSort($this->contact_district, $ctrl); // contact_district
            $this->updateSort($this->contact_province, $ctrl); // contact_province
            $this->updateSort($this->contact_country, $ctrl); // contact_country
            $this->updateSort($this->contact_postcode, $ctrl); // contact_postcode
            $this->updateSort($this->contact_callcenternumber, $ctrl); // contact_callcenternumber
            $this->updateSort($this->contact_faxnumber, $ctrl); // contact_faxnumber
            $this->updateSort($this->contact_email, $ctrl); // contact_email
            $this->updateSort($this->contact_website, $ctrl); // contact_website
            $this->updateSort($this->contact_contactfirstname, $ctrl); // contact_contactfirstname
            $this->updateSort($this->contact_contactlastname, $ctrl); // contact_contactlastname
            $this->updateSort($this->contact_contactnickname, $ctrl); // contact_contactnickname
            $this->updateSort($this->contact_contactpostition, $ctrl); // contact_contactpostition
            $this->updateSort($this->contact_contactphonenumber, $ctrl); // contact_contactphonenumber
            $this->updateSort($this->contact_contactcontactemail, $ctrl); // contact_contactcontactemail
            $this->updateSort($this->contact_purchaseaccount, $ctrl); // contact_purchaseaccount
            $this->updateSort($this->contact_sellaccount, $ctrl); // contact_sellaccount
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->contact_code->setSort("");
                $this->contact_name->setSort("");
                $this->contact_type->setSort("");
                $this->contact_taxnumber->setSort("");
                $this->contact_branchcode->setSort("");
                $this->contact_address->setSort("");
                $this->contact_subdistrict->setSort("");
                $this->contact_district->setSort("");
                $this->contact_province->setSort("");
                $this->contact_country->setSort("");
                $this->contact_postcode->setSort("");
                $this->contact_callcenternumber->setSort("");
                $this->contact_faxnumber->setSort("");
                $this->contact_email->setSort("");
                $this->contact_website->setSort("");
                $this->contact_contactfirstname->setSort("");
                $this->contact_contactlastname->setSort("");
                $this->contact_contactnickname->setSort("");
                $this->contact_contactpostition->setSort("");
                $this->contact_contactphonenumber->setSort("");
                $this->contact_contactcontactemail->setSort("");
                $this->contact_purchaseaccount->setSort("");
                $this->contact_sellaccount->setSort("");
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpeak_contactlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpeak_contactlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("contact_id", $this->createColumnOption("contact_id"));
            $option->add("contact_code", $this->createColumnOption("contact_code"));
            $option->add("contact_name", $this->createColumnOption("contact_name"));
            $option->add("contact_type", $this->createColumnOption("contact_type"));
            $option->add("contact_taxnumber", $this->createColumnOption("contact_taxnumber"));
            $option->add("contact_branchcode", $this->createColumnOption("contact_branchcode"));
            $option->add("contact_address", $this->createColumnOption("contact_address"));
            $option->add("contact_subdistrict", $this->createColumnOption("contact_subdistrict"));
            $option->add("contact_district", $this->createColumnOption("contact_district"));
            $option->add("contact_province", $this->createColumnOption("contact_province"));
            $option->add("contact_country", $this->createColumnOption("contact_country"));
            $option->add("contact_postcode", $this->createColumnOption("contact_postcode"));
            $option->add("contact_callcenternumber", $this->createColumnOption("contact_callcenternumber"));
            $option->add("contact_faxnumber", $this->createColumnOption("contact_faxnumber"));
            $option->add("contact_email", $this->createColumnOption("contact_email"));
            $option->add("contact_website", $this->createColumnOption("contact_website"));
            $option->add("contact_contactfirstname", $this->createColumnOption("contact_contactfirstname"));
            $option->add("contact_contactlastname", $this->createColumnOption("contact_contactlastname"));
            $option->add("contact_contactnickname", $this->createColumnOption("contact_contactnickname"));
            $option->add("contact_contactpostition", $this->createColumnOption("contact_contactpostition"));
            $option->add("contact_contactphonenumber", $this->createColumnOption("contact_contactphonenumber"));
            $option->add("contact_contactcontactemail", $this->createColumnOption("contact_contactcontactemail"));
            $option->add("contact_purchaseaccount", $this->createColumnOption("contact_purchaseaccount"));
            $option->add("contact_sellaccount", $this->createColumnOption("contact_sellaccount"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpeak_contactsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpeak_contactsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fpeak_contactlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fpeak_contactsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
