 ...
 * Page class
 */
class SaveLogSearchNonmemberAdd extends SaveLogSearchNonmember
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SaveLogSearchNonmemberAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "savelogsearchnonmemberview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->save_log_search_nonmember_id->OldValue = $this->save_log_search_nonmember_id->CurrentValue;
        ...
        $this->attribute_detail_id->CurrentValue = null;
        $this->attribute_detail_id->OldValue = $this->attribute_detail_id->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['save_log_search_nonmember_id'] = $this->save_log_search_nonmember_id->CurrentValue;
        ...
        $row['attribute_detail_id'] = $this->attribute_detail_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // attribute_detail_id
        $this->attribute_detail_id->setDbValueDef($rsnew, $this->attribute_detail_id->CurrentValue, null, false);
