 ...
 * Page class
 */
class AppointmentGrid extends Appointment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AppointmentGrid";
    ...
    public $FormName = "fappointmentgrid";
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->appointment_id->OldValue = $this->appointment_id->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['appointment_id'] = $this->appointment_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'appointment'
