...
/**
 * Table class for master_facilities
 */
class MasterFacilities extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'master_facilities';
        $this->TableName = 'master_facilities';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`master_facilities`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->master_facilities_group_id->Nullable = false; // NOT NULL field
        ...
        $this->isactive->Lookup = new Lookup('isactive', 'master_facilities', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`master_facilities`";
    }
    ...
    {
        return "`master_facilities_id` = @master_facilities_id@";
    }
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->master_facilities_id->CurrentValue = $keys[0];
            } else {
                $this->master_facilities_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("masterfacilitieslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "masterfacilitiesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "masterfacilitiesadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MasterFacilitiesView";
            case Config("API_ADD_ACTION"):
                return "MasterFacilitiesAdd";
            case Config("API_EDIT_ACTION"):
                return "MasterFacilitiesEdit";
            case Config("API_DELETE_ACTION"):
                return "MasterFacilitiesDelete";
            case Config("API_LIST_ACTION"):
                return "MasterFacilitiesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("masterfacilitiesview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("masterfacilitiesview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "masterfacilitiesadd?" . $this->getUrlParm($parm);
        } else {
            $url = "masterfacilitiesadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("masterfacilitiesedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("masterfacilitiesadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("masterfacilitiesdelete", $this->getUrlParm());
    }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->master_facilities_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->master_facilities_id->CurrentValue);
        } else {
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->master_facilities_id->CurrentValue = $key;
            } else {
                $this->master_facilities_id->OldValue = $key;
            }
    ...
    public function writeAuditTrailOnEdit(&$rsold, &$rsnew)
    {
        ...
        $key .= $rsold['master_facilities_id'];
