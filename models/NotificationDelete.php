 ...
 * Page class
 */
class NotificationDelete extends Notification
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotificationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("notificationlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("notificationlist"); // Return to list
                return;
            }
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("notificationlist"), "", $this->TableVar, true);
        $pageId = "delete";
