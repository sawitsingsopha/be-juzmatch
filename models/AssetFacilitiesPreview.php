 ...
 * Page class
 */
class AssetFacilitiesPreview extends AssetFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetFacilitiesPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "asset") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=asset&" . GetForeignKeyUrl("fk_asset_id", $this->asset_id->QueryStringValue) . "";
        }
        return $url;
    }
