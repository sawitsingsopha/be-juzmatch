 ...
 * Page class
 */
class Log2c2pView extends Log2c2p
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Log2c2pView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("log_2c2p_id") ?? Route("log_2c2p_id")) !== null) {
            $this->RecKey["log_2c2p_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("log_2c2p_id") ?? Route("log_2c2p_id")) !== null) {
                ...
                $this->RecKey["log_2c2p_id"] = $this->log_2c2p_id->QueryStringValue;
            } elseif (Post("log_2c2p_id") !== null) {
                $this->log_2c2p_id->setFormValue(Post("log_2c2p_id"));
                $this->RecKey["log_2c2p_id"] = $this->log_2c2p_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->log_2c2p_id->setQueryStringValue($keyValue);
                $this->RecKey["log_2c2p_id"] = $this->log_2c2p_id->QueryStringValue;
            } else {
                $returnUrl = "log2c2plist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "log2c2plist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "log2c2plist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
