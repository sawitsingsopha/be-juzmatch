 ...
 * Page class
 */
class CredenLogView extends CredenLog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CredenLogView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "credenloglist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "credenloglist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "credenloglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
