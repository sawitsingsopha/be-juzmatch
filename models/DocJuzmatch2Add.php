 ...
 * Page class
 */
class DocJuzmatch2Add extends DocJuzmatch2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocJuzmatch2Add";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "docjuzmatch2view") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->file_loan->CurrentValue = null; // Clear file related field
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->isShow() || $this->isCopy()) {
                RenderUploadField($this->file_loan);
            }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // investment_money_txt
        $this->investment_money_txt->setDbValueDef($rsnew, $this->investment_money_txt->CurrentValue, null, false);
        ...
        // investor_witness_name
        $this->investor_witness_name->setDbValueDef($rsnew, $this->investor_witness_name->CurrentValue, null, false);
