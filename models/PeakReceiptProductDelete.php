 ...
 * Page class
 */
class PeakReceiptProductDelete extends PeakReceiptProduct
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakReceiptProductDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("peakreceiptproductlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("peakreceiptproductlist"); // Return to list
                return;
            }
        }
