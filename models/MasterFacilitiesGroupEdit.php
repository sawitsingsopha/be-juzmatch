 ...
 * Page class
 */
class MasterFacilitiesGroupEdit extends MasterFacilitiesGroup
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterFacilitiesGroupEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("master_facilities_group_id") ?? Key(0) ?? Route(2)) !== null) {
                $this->master_facilities_group_id->setQueryStringValue($keyValue);
                $this->master_facilities_group_id->setOldValue($this->master_facilities_group_id->QueryStringValue);
            } elseif (Post("master_facilities_group_id") !== null) {
                $this->master_facilities_group_id->setFormValue(Post("master_facilities_group_id"));
                $this->master_facilities_group_id->setOldValue($this->master_facilities_group_id->FormValue);
            } else {
