 ...
 * Page class
 */
class MpayReqLogView extends MpayReqLog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MpayReqLogView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "mpayreqloglist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "mpayreqloglist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "mpayreqloglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
