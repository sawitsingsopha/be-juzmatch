 ...
 * Page class
 */
class PeakProductView extends PeakProduct
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakProductView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "peakproductlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "peakproductlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "peakproductlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
