...
/**
 * Table class for master_facilities_group
 */
class MasterFacilitiesGroup extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'master_facilities_group';
        $this->TableName = 'master_facilities_group';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`master_facilities_group`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->isactive->Lookup = new Lookup('isactive', 'master_facilities_group', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`master_facilities_group`";
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success && $this->AuditTrailOnEdit && $rsold) {
            $rsaudit = $rs;
            $fldname = 'master_facilities_group_id';
    ...
    {
        return "`master_facilities_group_id` = @master_facilities_group_id@";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("masterfacilitiesgrouplist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "masterfacilitiesgroupedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "masterfacilitiesgroupadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MasterFacilitiesGroupView";
            case Config("API_ADD_ACTION"):
                return "MasterFacilitiesGroupAdd";
            case Config("API_EDIT_ACTION"):
                return "MasterFacilitiesGroupEdit";
            case Config("API_DELETE_ACTION"):
                return "MasterFacilitiesGroupDelete";
            case Config("API_LIST_ACTION"):
                return "MasterFacilitiesGroupList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("masterfacilitiesgroupview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("masterfacilitiesgroupview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "masterfacilitiesgroupadd?" . $this->getUrlParm($parm);
        } else {
            $url = "masterfacilitiesgroupadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("masterfacilitiesgroupedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("masterfacilitiesgroupadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("masterfacilitiesgroupdelete", $this->getUrlParm());
    }
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->master_facilities_group_id->CurrentValue = $key;
            } else {
                $this->master_facilities_group_id->OldValue = $key;
            }
    ...
    public function renderEditRow()
    {
        ...
        $dispVal = $this->master_facilities_group_id->displayValue($arwrk);
        if ($dispVal != "") {
            $this->master_facilities_group_id->EditValue = $dispVal;
        }
        $this->master_facilities_group_id->ViewCustomAttributes = "";
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        $key .= $rs['master_facilities_group_id'];
    ...
    public function writeAuditTrailOnEdit(&$rsold, &$rsnew)
    {
        ...
        $key .= $rsold['master_facilities_group_id'];
