 ...
 * Page class
 */
class DocCredenLogEdit extends DocCredenLog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocCredenLogEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // pdfbase64
            $this->pdfbase64->setDbValueDef($rsnew, $this->pdfbase64->CurrentValue, null, $this->pdfbase64->ReadOnly);

            // request_header
            $this->request_header->setDbValueDef($rsnew, $this->request_header->CurrentValue, null, $this->request_header->ReadOnly);
