...
class Audittrail extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->datetime = new DbField(
            ...
            'datetime',
            '`datetime`',
            CastDateFieldForLike("`datetime`", 111, "DB"),
            135,
            19,
            111,
            false,
        ...
        $this->user->Lookup = new Lookup('user', 'users', false, 'users_id', ["user_name","","",""], [], [], [], [], [], [], '`user_name` ASC', '', "`user_name`");
        ...
        $this->_action->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->_action->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->_action->Lookup = new Lookup('action', 'audittrail', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        $this->_action->OptionCount = 5;
