 ...
 * Page class
 */
class TodoListGrid extends TodoList
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TodoListGrid";
    ...
    public $FormName = "ftodo_listgrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->todo_list_id->CurrentValue;
    ...
    {
        $this->todo_list_id->CurrentValue = null;
        $this->todo_list_id->OldValue = $this->todo_list_id->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'todo_list_id' first before field var 'x_todo_list_id'
        $val = $CurrentForm->hasValue("todo_list_id") ? $CurrentForm->getValue("todo_list_id") : $CurrentForm->getValue("x_todo_list_id");
        if (!$this->todo_list_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->todo_list_id->setFormValue($val);
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->todo_list_id->CurrentValue = $this->todo_list_id->FormValue;
        }
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['todo_list_id'] = $this->todo_list_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'todo_list'
