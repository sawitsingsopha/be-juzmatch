 ...
 * Page class
 */
class AllBuyerConfigAssetSchedulePreview extends AllBuyerConfigAssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AllBuyerConfigAssetSchedulePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "buyer_all_booking_asset") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=buyer_all_booking_asset&" . GetForeignKeyUrl("fk_asset_id", $this->asset_id->QueryStringValue) . "";
        }
        return $url;
    }
