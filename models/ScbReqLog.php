...
/**
 * Table class for scb_req_log
 */
class ScbReqLog extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'scb_req_log';
        $this->TableName = 'scb_req_log';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`scb_req_log`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`scb_req_log`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("scbreqloglist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "scbreqlogedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "scbreqlogadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ScbReqLogView";
            case Config("API_ADD_ACTION"):
                return "ScbReqLogAdd";
            case Config("API_EDIT_ACTION"):
                return "ScbReqLogEdit";
            case Config("API_DELETE_ACTION"):
                return "ScbReqLogDelete";
            case Config("API_LIST_ACTION"):
                return "ScbReqLogList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("scbreqlogview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("scbreqlogview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "scbreqlogadd?" . $this->getUrlParm($parm);
        } else {
            $url = "scbreqlogadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("scbreqlogedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("scbreqlogadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("scbreqlogdelete", $this->getUrlParm());
    }
