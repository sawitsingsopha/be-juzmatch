 ...
 * Page class
 */
class AssetProsDetailDelete extends AssetProsDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetProsDetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("assetprosdetaillist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("assetprosdetaillist"); // Return to list
                return;
            }
        }
