 ...
 * Page class
 */
class MasterFacilitiesAdd extends MasterFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterFacilitiesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "masterfacilitiesview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // master_facilities_group_id
        $this->master_facilities_group_id->setDbValueDef($rsnew, $this->master_facilities_group_id->CurrentValue, 0, false);
        ...
        // isactive
        $this->isactive->setDbValueDef($rsnew, $this->isactive->CurrentValue, 0, false);
        ...
        $this->cuser->setDbValueDef($rsnew, $this->cuser->CurrentValue, "");
