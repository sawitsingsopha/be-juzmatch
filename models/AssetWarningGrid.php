 ...
 * Page class
 */
class AssetWarningGrid extends AssetWarning
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetWarningGrid";
    ...
    public $FormName = "fasset_warninggrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->asset_warning_id->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->asset_warning_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->asset_warning_id->setFormValue($val);
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->asset_warning_id->CurrentValue = $this->asset_warning_id->FormValue;
        }
