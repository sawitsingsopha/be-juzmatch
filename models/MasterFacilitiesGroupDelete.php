 ...
 * Page class
 */
class MasterFacilitiesGroupDelete extends MasterFacilitiesGroup
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterFacilitiesGroupDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("masterfacilitiesgrouplist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("masterfacilitiesgrouplist"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['master_facilities_group_id'];
