 ...
 * Page class
 */
class PaymentInverterBookingPreview extends PaymentInverterBooking
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PaymentInverterBookingPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "invertor_booking") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=invertor_booking&" . GetForeignKeyUrl("fk_member_id", $this->member_id->QueryStringValue) . "&" . GetForeignKeyUrl("fk_asset_id", $this->asset_id->QueryStringValue) . "";
        }
