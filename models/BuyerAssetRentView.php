 ...
 * Page class
 */
class BuyerAssetRentView extends BuyerAssetRent
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerAssetRentView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("buyer_asset_rent_id") ?? Route("buyer_asset_rent_id")) !== null) {
                ...
                $returnUrl = "buyerassetrentlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "buyerassetrentlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "buyerassetrentlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
