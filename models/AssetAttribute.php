...
/**
 * Table class for asset_attribute
 */
class AssetAttribute extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'asset_attribute';
        $this->TableName = 'asset_attribute';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`asset_attribute`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // asset_attribute_id
        $this->asset_attribute_id = new DbField(
            'asset_attribute',
            'asset_attribute',
            'x_asset_attribute_id',
            'asset_attribute_id',
            '`asset_attribute_id`',
            '`asset_attribute_id`',
            3,
        ...
        $this->asset_attribute_id->InputTextType = "text";
        $this->asset_attribute_id->IsAutoIncrement = true; // Autoincrement field
        $this->asset_attribute_id->IsPrimaryKey = true; // Primary key field
        $this->asset_attribute_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['asset_attribute_id'] = &$this->asset_attribute_id;
        ...
        $this->attribute_detail_id->Nullable = false; // NOT NULL field
        $this->attribute_detail_id->Required = true; // Required field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`asset_attribute`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->asset_attribute_id->setDbValue($conn->lastInsertId());
            $rs['asset_attribute_id'] = $this->asset_attribute_id->DbValue;
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('asset_attribute_id', $rs)) {
                AddFilter($where, QuotedName('asset_attribute_id', $this->Dbid) . '=' . QuotedValue($rs['asset_attribute_id'], $this->asset_attribute_id->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->asset_attribute_id->DbValue = $row['asset_attribute_id'];
    ...
    {
        return "`asset_attribute_id` = @asset_attribute_id@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->asset_attribute_id->CurrentValue : $this->asset_attribute_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->asset_attribute_id->CurrentValue = $keys[0];
            } else {
                $this->asset_attribute_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('asset_attribute_id', $row) ? $row['asset_attribute_id'] : null;
        } else {
            $val = $this->asset_attribute_id->OldValue !== null ? $this->asset_attribute_id->OldValue : $this->asset_attribute_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@asset_attribute_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("assetattributelist");
    }
    ...
    {
        global $Language;
        if ($pageName == "assetattributeview") {
            return $Language->phrase("View");
        } elseif ($pageName == "assetattributeedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "assetattributeadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "AssetAttributeAdd";
            case Config("API_EDIT_ACTION"):
                return "AssetAttributeEdit";
            case Config("API_DELETE_ACTION"):
                return "AssetAttributeDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("assetattributeview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("assetattributeview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "assetattributeadd?" . $this->getUrlParm($parm);
        } else {
            $url = "assetattributeadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("assetattributeedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("assetattributeadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("assetattributedelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "\"asset_attribute_id\":" . JsonEncode($this->asset_attribute_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->asset_attribute_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->asset_attribute_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("asset_attribute_id") ?? Route("asset_attribute_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->asset_attribute_id->CurrentValue = $key;
            } else {
                $this->asset_attribute_id->OldValue = $key;
            }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->asset_attribute_id->setDbValue($row['asset_attribute_id']);
    ...
    public function renderListRow()
    {
        ...
        // asset_attribute_id
        $this->asset_attribute_id->ViewValue = $this->asset_attribute_id->CurrentValue;
        $this->asset_attribute_id->ViewCustomAttributes = "";
        ...
        // asset_attribute_id
        $this->asset_attribute_id->LinkCustomAttributes = "";
        $this->asset_attribute_id->HrefValue = "";
        $this->asset_attribute_id->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // asset_attribute_id
        $this->asset_attribute_id->setupEditAttributes();
        $this->asset_attribute_id->EditCustomAttributes = "";
        $this->asset_attribute_id->EditValue = $this->asset_attribute_id->CurrentValue;
        $this->asset_attribute_id->ViewCustomAttributes = "";
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->asset_attribute_id);
        ...
        while (!$recordset->EOF && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->asset_attribute_id);
