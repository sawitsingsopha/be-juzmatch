 ...
 * Page class
 */
class DocJuzmatch1Add extends DocJuzmatch1
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocJuzmatch1Add";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("docjuzmatch1list"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "docjuzmatch1list") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "docjuzmatch1view") {
