...
/**
 * Table class for creden_log
 */
class CredenLog extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'creden_log';
        $this->TableName = 'creden_log';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`creden_log`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`creden_log`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("credenloglist");
    }
    ...
    {
        global $Language;
        if ($pageName == "credenlogview") {
            return $Language->phrase("View");
        } elseif ($pageName == "credenlogedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "credenlogadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "CredenLogView";
            case Config("API_ADD_ACTION"):
                return "CredenLogAdd";
            case Config("API_EDIT_ACTION"):
                return "CredenLogEdit";
            case Config("API_DELETE_ACTION"):
                return "CredenLogDelete";
            case Config("API_LIST_ACTION"):
                return "CredenLogList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("credenlogview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("credenlogview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "credenlogadd?" . $this->getUrlParm($parm);
        } else {
            $url = "credenlogadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("credenlogedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("credenlogadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("credenlogdelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->__request->Raw) {
            $this->__request->CurrentValue = HtmlDecode($this->__request->CurrentValue);
        }
