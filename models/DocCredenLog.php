...
/**
 * Table class for doc_creden_log
 */
class DocCredenLog extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'doc_creden_log';
        $this->TableName = 'doc_creden_log';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`doc_creden_log`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->pdfbase64->InputTextType = "text";
        $this->Fields['pdfbase64'] = &$this->pdfbase64;

        // request_header
        $this->request_header = new DbField(
            'doc_creden_log',
            'doc_creden_log',
            'x_request_header',
            'request_header',
        ...
        $this->request_header->InputTextType = "text";
        $this->Fields['request_header'] = &$this->request_header;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`doc_creden_log`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->pdfbase64->DbValue = $row['pdfbase64'];
        $this->request_header->DbValue = $row['request_header'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("doccredenloglist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "doccredenlogedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "doccredenlogadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DocCredenLogView";
            case Config("API_ADD_ACTION"):
                return "DocCredenLogAdd";
            case Config("API_EDIT_ACTION"):
                return "DocCredenLogEdit";
            case Config("API_DELETE_ACTION"):
                return "DocCredenLogDelete";
            case Config("API_LIST_ACTION"):
                return "DocCredenLogList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("doccredenlogview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("doccredenlogview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "doccredenlogadd?" . $this->getUrlParm($parm);
        } else {
            $url = "doccredenlogadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("doccredenlogedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("doccredenlogadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("doccredenlogdelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->pdfbase64->EditValue = $this->pdfbase64->CurrentValue;
        ...
        $this->request_header->EditValue = $this->request_header->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->pdfbase64);
                    $doc->exportCaption($this->request_header);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->cdate);
                    $doc->exportCaption($this->url);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->pdfbase64);
                        $doc->exportField($this->request_header);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->cdate);
                        $doc->exportField($this->url);
