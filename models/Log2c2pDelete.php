 ...
 * Page class
 */
class Log2c2pDelete extends Log2c2p
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Log2c2pDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("log2c2plist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("log2c2plist"); // Return to list
                return;
            }
        }
