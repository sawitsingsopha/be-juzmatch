 ...
 * Page class
 */
class JuzcalculatorList extends Juzcalculator
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JuzcalculatorList";
    ...
    public $FormName = "fjuzcalculatorlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "juzcalculatoradd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "juzcalculatordelete";
        $this->MultiUpdateUrl = "juzcalculatorupdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fjuzcalculatorsrch");
        }
        ...
        $filterList = Concat($filterList, $this->income_all->AdvancedSearch->toJson(), ","); // Field income_all
        $filterList = Concat($filterList, $this->outcome_all->AdvancedSearch->toJson(), ","); // Field outcome_all
        $filterList = Concat($filterList, $this->rent_price->AdvancedSearch->toJson(), ","); // Field rent_price
        $filterList = Concat($filterList, $this->asset_price->AdvancedSearch->toJson(), ","); // Field asset_price
        $filterList = Concat($filterList, $this->investment->AdvancedSearch->toJson(), ","); // Field investment
        $filterList = Concat($filterList, $this->credit_limit->AdvancedSearch->toJson(), ","); // Field credit_limit
        $filterList = Concat($filterList, $this->monthly_payments->AdvancedSearch->toJson(), ","); // Field monthly_payments
        $filterList = Concat($filterList, $this->highest_rental_price->AdvancedSearch->toJson(), ","); // Field highest_rental_price
        $filterList = Concat($filterList, $this->transfer->AdvancedSearch->toJson(), ","); // Field transfer
        $filterList = Concat($filterList, $this->total_invertor_year->AdvancedSearch->toJson(), ","); // Field total_invertor_year
        $filterList = Concat($filterList, $this->invert_payoff_day->AdvancedSearch->toJson(), ","); // Field invert_payoff_day
        $filterList = Concat($filterList, $this->type_invertor->AdvancedSearch->toJson(), ","); // Field type_invertor
        $filterList = Concat($filterList, $this->invest_amount->AdvancedSearch->toJson(), ","); // Field invest_amount
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fjuzcalculatorsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field income_all
        $this->income_all->AdvancedSearch->SearchValue = @$filter["x_income_all"];
        $this->income_all->AdvancedSearch->SearchOperator = @$filter["z_income_all"];
        $this->income_all->AdvancedSearch->SearchCondition = @$filter["v_income_all"];
        $this->income_all->AdvancedSearch->SearchValue2 = @$filter["y_income_all"];
        $this->income_all->AdvancedSearch->SearchOperator2 = @$filter["w_income_all"];
        $this->income_all->AdvancedSearch->save();

        // Field outcome_all
        $this->outcome_all->AdvancedSearch->SearchValue = @$filter["x_outcome_all"];
        $this->outcome_all->AdvancedSearch->SearchOperator = @$filter["z_outcome_all"];
        $this->outcome_all->AdvancedSearch->SearchCondition = @$filter["v_outcome_all"];
        $this->outcome_all->AdvancedSearch->SearchValue2 = @$filter["y_outcome_all"];
        $this->outcome_all->AdvancedSearch->SearchOperator2 = @$filter["w_outcome_all"];
        $this->outcome_all->AdvancedSearch->save();

        // Field rent_price
        $this->rent_price->AdvancedSearch->SearchValue = @$filter["x_rent_price"];
        $this->rent_price->AdvancedSearch->SearchOperator = @$filter["z_rent_price"];
        $this->rent_price->AdvancedSearch->SearchCondition = @$filter["v_rent_price"];
        $this->rent_price->AdvancedSearch->SearchValue2 = @$filter["y_rent_price"];
        $this->rent_price->AdvancedSearch->SearchOperator2 = @$filter["w_rent_price"];
        $this->rent_price->AdvancedSearch->save();

        // Field asset_price
        $this->asset_price->AdvancedSearch->SearchValue = @$filter["x_asset_price"];
        $this->asset_price->AdvancedSearch->SearchOperator = @$filter["z_asset_price"];
        $this->asset_price->AdvancedSearch->SearchCondition = @$filter["v_asset_price"];
        $this->asset_price->AdvancedSearch->SearchValue2 = @$filter["y_asset_price"];
        $this->asset_price->AdvancedSearch->SearchOperator2 = @$filter["w_asset_price"];
        $this->asset_price->AdvancedSearch->save();

        // Field investment
        $this->investment->AdvancedSearch->SearchValue = @$filter["x_investment"];
        $this->investment->AdvancedSearch->SearchOperator = @$filter["z_investment"];
        $this->investment->AdvancedSearch->SearchCondition = @$filter["v_investment"];
        $this->investment->AdvancedSearch->SearchValue2 = @$filter["y_investment"];
        $this->investment->AdvancedSearch->SearchOperator2 = @$filter["w_investment"];
        $this->investment->AdvancedSearch->save();

        // Field credit_limit
        $this->credit_limit->AdvancedSearch->SearchValue = @$filter["x_credit_limit"];
        $this->credit_limit->AdvancedSearch->SearchOperator = @$filter["z_credit_limit"];
        $this->credit_limit->AdvancedSearch->SearchCondition = @$filter["v_credit_limit"];
        $this->credit_limit->AdvancedSearch->SearchValue2 = @$filter["y_credit_limit"];
        $this->credit_limit->AdvancedSearch->SearchOperator2 = @$filter["w_credit_limit"];
        $this->credit_limit->AdvancedSearch->save();

        // Field monthly_payments
        $this->monthly_payments->AdvancedSearch->SearchValue = @$filter["x_monthly_payments"];
        $this->monthly_payments->AdvancedSearch->SearchOperator = @$filter["z_monthly_payments"];
        $this->monthly_payments->AdvancedSearch->SearchCondition = @$filter["v_monthly_payments"];
        $this->monthly_payments->AdvancedSearch->SearchValue2 = @$filter["y_monthly_payments"];
        $this->monthly_payments->AdvancedSearch->SearchOperator2 = @$filter["w_monthly_payments"];
        $this->monthly_payments->AdvancedSearch->save();

        // Field highest_rental_price
        $this->highest_rental_price->AdvancedSearch->SearchValue = @$filter["x_highest_rental_price"];
        $this->highest_rental_price->AdvancedSearch->SearchOperator = @$filter["z_highest_rental_price"];
        $this->highest_rental_price->AdvancedSearch->SearchCondition = @$filter["v_highest_rental_price"];
        $this->highest_rental_price->AdvancedSearch->SearchValue2 = @$filter["y_highest_rental_price"];
        $this->highest_rental_price->AdvancedSearch->SearchOperator2 = @$filter["w_highest_rental_price"];
        $this->highest_rental_price->AdvancedSearch->save();
        ...
        // Field total_invertor_year
        $this->total_invertor_year->AdvancedSearch->SearchValue = @$filter["x_total_invertor_year"];
        $this->total_invertor_year->AdvancedSearch->SearchOperator = @$filter["z_total_invertor_year"];
        $this->total_invertor_year->AdvancedSearch->SearchCondition = @$filter["v_total_invertor_year"];
        $this->total_invertor_year->AdvancedSearch->SearchValue2 = @$filter["y_total_invertor_year"];
        $this->total_invertor_year->AdvancedSearch->SearchOperator2 = @$filter["w_total_invertor_year"];
        $this->total_invertor_year->AdvancedSearch->save();

        // Field invert_payoff_day
        $this->invert_payoff_day->AdvancedSearch->SearchValue = @$filter["x_invert_payoff_day"];
        $this->invert_payoff_day->AdvancedSearch->SearchOperator = @$filter["z_invert_payoff_day"];
        $this->invert_payoff_day->AdvancedSearch->SearchCondition = @$filter["v_invert_payoff_day"];
        $this->invert_payoff_day->AdvancedSearch->SearchValue2 = @$filter["y_invert_payoff_day"];
        $this->invert_payoff_day->AdvancedSearch->SearchOperator2 = @$filter["w_invert_payoff_day"];
        $this->invert_payoff_day->AdvancedSearch->save();

        // Field type_invertor
        $this->type_invertor->AdvancedSearch->SearchValue = @$filter["x_type_invertor"];
        $this->type_invertor->AdvancedSearch->SearchOperator = @$filter["z_type_invertor"];
        $this->type_invertor->AdvancedSearch->SearchCondition = @$filter["v_type_invertor"];
        $this->type_invertor->AdvancedSearch->SearchValue2 = @$filter["y_type_invertor"];
        $this->type_invertor->AdvancedSearch->SearchOperator2 = @$filter["w_type_invertor"];
        $this->type_invertor->AdvancedSearch->save();

        // Field invest_amount
        $this->invest_amount->AdvancedSearch->SearchValue = @$filter["x_invest_amount"];
        $this->invest_amount->AdvancedSearch->SearchOperator = @$filter["z_invest_amount"];
        $this->invest_amount->AdvancedSearch->SearchCondition = @$filter["v_invest_amount"];
        $this->invest_amount->AdvancedSearch->SearchValue2 = @$filter["y_invest_amount"];
        $this->invest_amount->AdvancedSearch->SearchOperator2 = @$filter["w_invest_amount"];
        $this->invest_amount->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->income_all, $default, false); // income_all
        $this->buildSearchSql($where, $this->outcome_all, $default, false); // outcome_all
        $this->buildSearchSql($where, $this->rent_price, $default, false); // rent_price
        $this->buildSearchSql($where, $this->asset_price, $default, false); // asset_price
        $this->buildSearchSql($where, $this->investment, $default, false); // investment
        $this->buildSearchSql($where, $this->credit_limit, $default, false); // credit_limit
        $this->buildSearchSql($where, $this->monthly_payments, $default, false); // monthly_payments
        $this->buildSearchSql($where, $this->highest_rental_price, $default, false); // highest_rental_price
        $this->buildSearchSql($where, $this->transfer, $default, false); // transfer
        $this->buildSearchSql($where, $this->total_invertor_year, $default, false); // total_invertor_year
        $this->buildSearchSql($where, $this->invert_payoff_day, $default, false); // invert_payoff_day
        $this->buildSearchSql($where, $this->type_invertor, $default, false); // type_invertor
        $this->buildSearchSql($where, $this->invest_amount, $default, false); // invest_amount
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->income_all->AdvancedSearch->save(); // income_all
            $this->outcome_all->AdvancedSearch->save(); // outcome_all
            $this->rent_price->AdvancedSearch->save(); // rent_price
            $this->asset_price->AdvancedSearch->save(); // asset_price
            $this->investment->AdvancedSearch->save(); // investment
            $this->credit_limit->AdvancedSearch->save(); // credit_limit
            $this->monthly_payments->AdvancedSearch->save(); // monthly_payments
            $this->highest_rental_price->AdvancedSearch->save(); // highest_rental_price
            $this->transfer->AdvancedSearch->save(); // transfer
            $this->total_invertor_year->AdvancedSearch->save(); // total_invertor_year
            $this->invert_payoff_day->AdvancedSearch->save(); // invert_payoff_day
            $this->type_invertor->AdvancedSearch->save(); // type_invertor
            $this->invest_amount->AdvancedSearch->save(); // invest_amount
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->income_all->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->outcome_all->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->rent_price->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->asset_price->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->investment->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->credit_limit->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->monthly_payments->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->highest_rental_price->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->transfer->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->total_invertor_year->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->invert_payoff_day->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->type_invertor->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->invest_amount->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
        ...
        $this->income_all->AdvancedSearch->unsetSession();
        $this->outcome_all->AdvancedSearch->unsetSession();
        $this->rent_price->AdvancedSearch->unsetSession();
        $this->asset_price->AdvancedSearch->unsetSession();
        $this->investment->AdvancedSearch->unsetSession();
        $this->credit_limit->AdvancedSearch->unsetSession();
        $this->monthly_payments->AdvancedSearch->unsetSession();
        $this->highest_rental_price->AdvancedSearch->unsetSession();
        $this->transfer->AdvancedSearch->unsetSession();
        $this->total_invertor_year->AdvancedSearch->unsetSession();
        $this->invert_payoff_day->AdvancedSearch->unsetSession();
        $this->type_invertor->AdvancedSearch->unsetSession();
        $this->invest_amount->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->income_all->AdvancedSearch->load();
        $this->outcome_all->AdvancedSearch->load();
        $this->rent_price->AdvancedSearch->load();
        $this->asset_price->AdvancedSearch->load();
        $this->investment->AdvancedSearch->load();
        $this->credit_limit->AdvancedSearch->load();
        $this->monthly_payments->AdvancedSearch->load();
        $this->highest_rental_price->AdvancedSearch->load();
        $this->transfer->AdvancedSearch->load();
        $this->total_invertor_year->AdvancedSearch->load();
        $this->invert_payoff_day->AdvancedSearch->load();
        $this->type_invertor->AdvancedSearch->load();
        $this->invest_amount->AdvancedSearch->load();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->income_all, $ctrl); // income_all
            $this->updateSort($this->outcome_all, $ctrl); // outcome_all
            $this->updateSort($this->rent_price, $ctrl); // rent_price
            $this->updateSort($this->asset_price, $ctrl); // asset_price
    ...
    protected function setupListOptions()
    {
        ...
        // "detail_juzcalculator_income"
        $item = &$this->ListOptions->add("detail_juzcalculator_income");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'juzcalculator_income');
        $item->OnLeft = false;
        $item->ShowInButtonGroup = false;

        // "detail_juzcalculator_outcome"
        $item = &$this->ListOptions->add("detail_juzcalculator_outcome");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'juzcalculator_outcome');
        $item->OnLeft = false;
        $item->ShowInButtonGroup = false;
        ...
        // Set up detail pages
        $pages = new SubPages();
        $pages->add("juzcalculator_income");
        $pages->add("juzcalculator_outcome");
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fjuzcalculatorlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fjuzcalculatorlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        // "detail_juzcalculator_income"
        $opt = $this->ListOptions["detail_juzcalculator_income"];
        if ($Security->allowList(CurrentProjectID() . 'juzcalculator_income')) {
            $body = $Language->phrase("DetailLink") . $Language->TablePhrase("juzcalculator_income", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("juzcalculatorincomelist?" . Config("TABLE_SHOW_MASTER") . "=juzcalculator&" . GetForeignKeyUrl("fk_juzcalculator_id", $this->juzcalculator_id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("JuzcalculatorIncomeGrid");
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'juzcalculator')) {
                $caption = $Language->phrase("MasterDetailEditLink", null);
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=juzcalculator_income");
                ...
                $detailEditTblVar .= "juzcalculator_income";
            }
            if ($links != "") {
        ...
        // "detail_juzcalculator_outcome"
        $opt = $this->ListOptions["detail_juzcalculator_outcome"];
        if ($Security->allowList(CurrentProjectID() . 'juzcalculator_outcome')) {
            $body = $Language->phrase("DetailLink") . $Language->TablePhrase("juzcalculator_outcome", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("juzcalculatoroutcomelist?" . Config("TABLE_SHOW_MASTER") . "=juzcalculator&" . GetForeignKeyUrl("fk_juzcalculator_id", $this->juzcalculator_id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("JuzcalculatorOutcomeGrid");
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'juzcalculator')) {
                $caption = $Language->phrase("MasterDetailEditLink", null);
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=juzcalculator_outcome");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a></li>";
                if ($detailEditTblVar != "") {
                    $detailEditTblVar .= ",";
                }
                $detailEditTblVar .= "juzcalculator_outcome";
            }
            if ($links != "") {
                $body .= "<button class=\"dropdown-toggle btn btn-default ew-detail\" data-bs-toggle=\"dropdown\"></button>";
                $body .= "<ul class=\"dropdown-menu\">" . $links . "</ul>";
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->juzcalculator_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("income_all", $this->createColumnOption("income_all"));
            $option->add("outcome_all", $this->createColumnOption("outcome_all"));
            $option->add("rent_price", $this->createColumnOption("rent_price"));
            $option->add("asset_price", $this->createColumnOption("asset_price"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fjuzcalculatorsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fjuzcalculatorsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fjuzcalculatorlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function loadSearchValues()
    {
        ...
        // income_all
        if ($this->income_all->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->income_all->AdvancedSearch->SearchValue != "" || $this->income_all->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // outcome_all
        if ($this->outcome_all->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->outcome_all->AdvancedSearch->SearchValue != "" || $this->outcome_all->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // rent_price
        if ($this->rent_price->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->rent_price->AdvancedSearch->SearchValue != "" || $this->rent_price->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // asset_price
        if ($this->asset_price->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->asset_price->AdvancedSearch->SearchValue != "" || $this->asset_price->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // investment
        if ($this->investment->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->investment->AdvancedSearch->SearchValue != "" || $this->investment->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // credit_limit
        if ($this->credit_limit->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->credit_limit->AdvancedSearch->SearchValue != "" || $this->credit_limit->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // monthly_payments
        if ($this->monthly_payments->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->monthly_payments->AdvancedSearch->SearchValue != "" || $this->monthly_payments->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // highest_rental_price
        if ($this->highest_rental_price->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->highest_rental_price->AdvancedSearch->SearchValue != "" || $this->highest_rental_price->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // transfer
        if ($this->transfer->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->transfer->AdvancedSearch->SearchValue != "" || $this->transfer->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // total_invertor_year
        if ($this->total_invertor_year->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->total_invertor_year->AdvancedSearch->SearchValue != "" || $this->total_invertor_year->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // invert_payoff_day
        if ($this->invert_payoff_day->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->invert_payoff_day->AdvancedSearch->SearchValue != "" || $this->invert_payoff_day->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // type_invertor
        if ($this->type_invertor->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->type_invertor->AdvancedSearch->SearchValue != "" || $this->type_invertor->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // invest_amount
        if ($this->invest_amount->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->invest_amount->AdvancedSearch->SearchValue != "" || $this->invest_amount->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->income_all->EditValue = HtmlEncode($this->income_all->AdvancedSearch->SearchValue);
            ...
            $this->outcome_all->EditValue = HtmlEncode($this->outcome_all->AdvancedSearch->SearchValue);
            ...
            $this->rent_price->EditValue = HtmlEncode($this->rent_price->AdvancedSearch->SearchValue);
            ...
            $this->asset_price->EditValue = HtmlEncode($this->asset_price->AdvancedSearch->SearchValue);
            ...
            if (!$this->cdate->Raw) {
                $this->cdate->AdvancedSearch->SearchValue = HtmlDecode($this->cdate->AdvancedSearch->SearchValue);
            }
            $this->cdate->EditValue = HtmlEncode($this->cdate->AdvancedSearch->SearchValue);
            $this->cdate->PlaceHolder = RemoveHtml($this->cdate->caption());
            $this->cdate->setupEditAttributes();
            $this->cdate->EditCustomAttributes = "";
            if (!$this->cdate->Raw) {
                $this->cdate->AdvancedSearch->SearchValue2 = HtmlDecode($this->cdate->AdvancedSearch->SearchValue2);
            }
            $this->cdate->EditValue2 = HtmlEncode($this->cdate->AdvancedSearch->SearchValue2);
            $this->cdate->PlaceHolder = RemoveHtml($this->cdate->caption());
        }
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckNumber($this->income_all->AdvancedSearch->SearchValue)) {
            $this->income_all->addErrorMessage($this->income_all->getErrorMessage(false));
        }
        if (!CheckNumber($this->outcome_all->AdvancedSearch->SearchValue)) {
            $this->outcome_all->addErrorMessage($this->outcome_all->getErrorMessage(false));
        }
        if (!CheckNumber($this->rent_price->AdvancedSearch->SearchValue)) {
            $this->rent_price->addErrorMessage($this->rent_price->getErrorMessage(false));
        }
        if (!CheckNumber($this->asset_price->AdvancedSearch->SearchValue)) {
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fjuzcalculatorsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        $item->Body = "<a class=\"btn btn-default ew-highlight active\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-ew-action=\"highlight\" data-form=\"fjuzcalculatorsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
    ...
    {
        return $this->income_all->Visible || $this->outcome_all->Visible || $this->rent_price->Visible || $this->asset_price->Visible || $this->cdate->Visible;
    }
