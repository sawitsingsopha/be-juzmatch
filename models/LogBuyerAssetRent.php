...
/**
 * Table class for log_buyer_asset_rent
 */
class LogBuyerAssetRent extends DbTable
{
    protected $SqlFrom = "";
    ...
    // Fields
    public $log_buyer_asset_rent_id;
    public $pay_number;
    public $asset_id;
    public $member_id;
    public $half_price_1;
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'log_buyer_asset_rent';
        $this->TableName = 'log_buyer_asset_rent';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`log_buyer_asset_rent`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // log_buyer_asset_rent_id
        $this->log_buyer_asset_rent_id = new DbField(
            'log_buyer_asset_rent',
            'log_buyer_asset_rent',
            'x_log_buyer_asset_rent_id',
            'log_buyer_asset_rent_id',
            '`log_buyer_asset_rent_id`',
            '`log_buyer_asset_rent_id`',
            3,
        ...
        $this->log_buyer_asset_rent_id->InputTextType = "text";
        $this->log_buyer_asset_rent_id->IsAutoIncrement = true; // Autoincrement field
        $this->log_buyer_asset_rent_id->IsPrimaryKey = true; // Primary key field
        $this->log_buyer_asset_rent_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['log_buyer_asset_rent_id'] = &$this->log_buyer_asset_rent_id;
        ...
        $this->date_pay_half_price_1 = new DbField(
            ...
            'date_pay_half_price_1',
            '`date_pay_half_price_1`',
            CastDateFieldForLike("`date_pay_half_price_1`", 0, "DB"),
            135,
            19,
            0,
            false,
        ...
        $this->date_pay_half_price_1->Required = true; // Required field
        $this->date_pay_half_price_1->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        ...
        $this->due_date_pay_half_price_1 = new DbField(
            ...
            'due_date_pay_half_price_1',
            '`due_date_pay_half_price_1`',
            CastDateFieldForLike("`due_date_pay_half_price_1`", 0, "DB"),
            135,
            19,
            0,
            false,
        ...
        $this->due_date_pay_half_price_1->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        ...
        $this->date_pay_half_price_2 = new DbField(
            ...
            'date_pay_half_price_2',
            '`date_pay_half_price_2`',
            CastDateFieldForLike("`date_pay_half_price_2`", 0, "DB"),
            135,
            19,
            0,
            false,
        ...
        $this->date_pay_half_price_2->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        ...
        $this->due_date_pay_half_price_2 = new DbField(
            ...
            'due_date_pay_half_price_2',
            '`due_date_pay_half_price_2`',
            CastDateFieldForLike("`due_date_pay_half_price_2`", 0, "DB"),
            135,
            19,
            0,
            false,
        ...
        $this->due_date_pay_half_price_2->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        ...
        $this->payment_scheme1->Required = true; // Required field
        ...
        $this->transaction_ref1->Required = true; // Required field
        ...
        $this->channel_response_desc1->Required = true; // Required field
        ...
        $this->res_status1->Required = true; // Required field
        ...
        $this->res_referenceNo1->Required = true; // Required field
        ...
        $this->transaction_datetime2->Required = true; // Required field
        ...
        $this->payment_scheme2->Required = true; // Required field
        ...
        $this->transaction_ref2->Required = true; // Required field
        ...
        $this->channel_response_desc2->Required = true; // Required field
        ...
        $this->res_status2->Required = true; // Required field
        ...
        $this->res_referenceNo2->Required = true; // Required field
        ...
        $this->one_time_status->Lookup = new Lookup('one_time_status', 'log_buyer_asset_rent', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`log_buyer_asset_rent`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->log_buyer_asset_rent_id->setDbValue($conn->lastInsertId());
            $rs['log_buyer_asset_rent_id'] = $this->log_buyer_asset_rent_id->DbValue;
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('log_buyer_asset_rent_id', $rs)) {
                AddFilter($where, QuotedName('log_buyer_asset_rent_id', $this->Dbid) . '=' . QuotedValue($rs['log_buyer_asset_rent_id'], $this->log_buyer_asset_rent_id->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->log_buyer_asset_rent_id->DbValue = $row['log_buyer_asset_rent_id'];
    ...
    {
        return "`log_buyer_asset_rent_id` = @log_buyer_asset_rent_id@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->log_buyer_asset_rent_id->CurrentValue : $this->log_buyer_asset_rent_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->log_buyer_asset_rent_id->CurrentValue = $keys[0];
            } else {
                $this->log_buyer_asset_rent_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('log_buyer_asset_rent_id', $row) ? $row['log_buyer_asset_rent_id'] : null;
        } else {
            $val = $this->log_buyer_asset_rent_id->OldValue !== null ? $this->log_buyer_asset_rent_id->OldValue : $this->log_buyer_asset_rent_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@log_buyer_asset_rent_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("logbuyerassetrentlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "logbuyerassetrentview") {
            return $Language->phrase("View");
        } elseif ($pageName == "logbuyerassetrentedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "logbuyerassetrentadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "LogBuyerAssetRentView";
            case Config("API_ADD_ACTION"):
                return "LogBuyerAssetRentAdd";
            case Config("API_EDIT_ACTION"):
                return "LogBuyerAssetRentEdit";
            case Config("API_DELETE_ACTION"):
                return "LogBuyerAssetRentDelete";
            case Config("API_LIST_ACTION"):
                return "LogBuyerAssetRentList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("logbuyerassetrentview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("logbuyerassetrentview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "logbuyerassetrentadd?" . $this->getUrlParm($parm);
        } else {
            $url = "logbuyerassetrentadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("logbuyerassetrentedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("logbuyerassetrentadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("logbuyerassetrentdelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "\"log_buyer_asset_rent_id\":" . JsonEncode($this->log_buyer_asset_rent_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->log_buyer_asset_rent_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->log_buyer_asset_rent_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("log_buyer_asset_rent_id") ?? Route("log_buyer_asset_rent_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->log_buyer_asset_rent_id->CurrentValue = $key;
            } else {
                $this->log_buyer_asset_rent_id->OldValue = $key;
            }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->log_buyer_asset_rent_id->setDbValue($row['log_buyer_asset_rent_id']);
    ...
    public function renderListRow()
    {
        ...
        // log_buyer_asset_rent_id
        $this->log_buyer_asset_rent_id->ViewValue = $this->log_buyer_asset_rent_id->CurrentValue;
        $this->log_buyer_asset_rent_id->ViewCustomAttributes = "";
        ...
        $this->half_price_1->ViewValue = FormatNumber($this->half_price_1->ViewValue, $this->half_price_1->formatPattern());
        ...
        // status_pay_half_price_1
        $this->status_pay_half_price_1->ViewValue = $this->status_pay_half_price_1->CurrentValue;
        $this->status_pay_half_price_1->ViewValue = FormatNumber($this->status_pay_half_price_1->ViewValue, $this->status_pay_half_price_1->formatPattern());
        ...
        $this->half_price_2->ViewValue = FormatNumber($this->half_price_2->ViewValue, $this->half_price_2->formatPattern());
        $this->half_price_2->ViewCustomAttributes = "";

        // status_pay_half_price_2
        $this->status_pay_half_price_2->ViewValue = $this->status_pay_half_price_2->CurrentValue;
        $this->status_pay_half_price_2->ViewValue = FormatNumber($this->status_pay_half_price_2->ViewValue, $this->status_pay_half_price_2->formatPattern());
        ...
        // log_buyer_asset_rent_id
        $this->log_buyer_asset_rent_id->LinkCustomAttributes = "";
        $this->log_buyer_asset_rent_id->HrefValue = "";
        $this->log_buyer_asset_rent_id->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // log_buyer_asset_rent_id
        $this->log_buyer_asset_rent_id->setupEditAttributes();
        $this->log_buyer_asset_rent_id->EditCustomAttributes = "";
        $this->log_buyer_asset_rent_id->EditValue = $this->log_buyer_asset_rent_id->CurrentValue;
        $this->log_buyer_asset_rent_id->ViewCustomAttributes = "";
        ...
        $this->status_pay_half_price_1->EditValue = $this->status_pay_half_price_1->CurrentValue;
        $this->status_pay_half_price_1->PlaceHolder = RemoveHtml($this->status_pay_half_price_1->caption());
        if (strval($this->status_pay_half_price_1->EditValue) != "" && is_numeric($this->status_pay_half_price_1->EditValue)) {
            $this->status_pay_half_price_1->EditValue = FormatNumber($this->status_pay_half_price_1->EditValue, null);
        }
        ...
        $this->status_pay_half_price_2->EditValue = $this->status_pay_half_price_2->CurrentValue;
        $this->status_pay_half_price_2->PlaceHolder = RemoveHtml($this->status_pay_half_price_2->caption());
        if (strval($this->status_pay_half_price_2->EditValue) != "" && is_numeric($this->status_pay_half_price_2->EditValue)) {
            $this->status_pay_half_price_2->EditValue = FormatNumber($this->status_pay_half_price_2->EditValue, null);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->log_buyer_asset_rent_id);
                    ...
                    $doc->exportCaption($this->transaction_datetime1);
                    $doc->exportCaption($this->payment_scheme1);
                    $doc->exportCaption($this->transaction_ref1);
                    $doc->exportCaption($this->channel_response_desc1);
                    $doc->exportCaption($this->res_status1);
                    $doc->exportCaption($this->res_referenceNo1);
                    $doc->exportCaption($this->transaction_datetime2);
                    $doc->exportCaption($this->payment_scheme2);
                    $doc->exportCaption($this->transaction_ref2);
                    $doc->exportCaption($this->channel_response_desc2);
                    $doc->exportCaption($this->res_status2);
                    $doc->exportCaption($this->res_referenceNo2);
                    $doc->exportCaption($this->res_paidAgent1);
                    $doc->exportCaption($this->res_paidChannel1);
                    $doc->exportCaption($this->res_maskedPan1);
                    $doc->exportCaption($this->res_paidAgent2);
                    $doc->exportCaption($this->res_paidChannel2);
                    $doc->exportCaption($this->res_maskedPan2);
        ...
        while (!$recordset->EOF && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->log_buyer_asset_rent_id);
                        ...
                        $doc->exportField($this->transaction_datetime1);
                        $doc->exportField($this->payment_scheme1);
                        $doc->exportField($this->transaction_ref1);
                        $doc->exportField($this->channel_response_desc1);
                        $doc->exportField($this->res_status1);
                        $doc->exportField($this->res_referenceNo1);
                        $doc->exportField($this->transaction_datetime2);
                        $doc->exportField($this->payment_scheme2);
                        $doc->exportField($this->transaction_ref2);
                        $doc->exportField($this->channel_response_desc2);
                        $doc->exportField($this->res_status2);
                        $doc->exportField($this->res_referenceNo2);
                        $doc->exportField($this->res_paidAgent1);
                        $doc->exportField($this->res_paidChannel1);
                        $doc->exportField($this->res_maskedPan1);
                        $doc->exportField($this->res_paidAgent2);
                        $doc->exportField($this->res_paidChannel2);
                        $doc->exportField($this->res_maskedPan2);
