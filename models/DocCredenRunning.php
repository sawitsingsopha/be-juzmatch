...
/**
 * Table class for doc_creden_running
 */
class DocCredenRunning extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'doc_creden_running';
        $this->TableName = 'doc_creden_running';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`doc_creden_running`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->running->InputTextType = "text";
        $this->running->Nullable = false; // NOT NULL field
        $this->running->Required = true; // Required field
        $this->running->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['running'] = &$this->running;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`doc_creden_running`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->running->DbValue = $row['running'];
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            ...
            $val = $this->year->OldValue !== null ? $this->year->OldValue : $this->year->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if (is_array($row)) {
            ...
            $val = $this->month->OldValue !== null ? $this->month->OldValue : $this->month->CurrentValue;
        }
        if (!is_numeric($val)) {
            return "0=1"; // Invalid key
        }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("doccredenrunninglist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "doccredenrunningedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "doccredenrunningadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DocCredenRunningView";
            case Config("API_ADD_ACTION"):
                return "DocCredenRunningAdd";
            case Config("API_EDIT_ACTION"):
                return "DocCredenRunningEdit";
            case Config("API_DELETE_ACTION"):
                return "DocCredenRunningDelete";
            case Config("API_LIST_ACTION"):
                return "DocCredenRunningList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("doccredenrunningview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("doccredenrunningview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "doccredenrunningadd?" . $this->getUrlParm($parm);
        } else {
            $url = "doccredenrunningadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("doccredenrunningedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("doccredenrunningadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("doccredenrunningdelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->running->EditValue = $this->running->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->running);
                } else {
                    $doc->exportCaption($this->year);
                    $doc->exportCaption($this->month);
                    $doc->exportCaption($this->running);
