 ...
 * Page class
 */
class BuyerAssetScheduleGrid extends BuyerAssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerAssetScheduleGrid";
    ...
    public $FormName = "fbuyer_asset_schedulegrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'buyer_asset_schedule'
