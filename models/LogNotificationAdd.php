 ...
 * Page class
 */
class LogNotificationAdd extends LogNotification
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LogNotificationAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "lognotificationview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->log_notification_id->OldValue = $this->log_notification_id->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['log_notification_id'] = $this->log_notification_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // cdate
        $this->cdate->setDbValueDef($rsnew, UnFormatDateTime($this->cdate->CurrentValue, $this->cdate->formatPattern()), CurrentDate(), false);

        // cuser
        $this->cuser->setDbValueDef($rsnew, $this->cuser->CurrentValue, 0, false);
