 ...
 * Page class
 */
class AllBuyerConfigAssetScheduleDelete extends AllBuyerConfigAssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AllBuyerConfigAssetScheduleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("allbuyerconfigassetschedulelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("allbuyerconfigassetschedulelist"); // Return to list
                return;
            }
        }
