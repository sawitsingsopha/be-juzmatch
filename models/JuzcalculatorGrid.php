 ...
 * Page class
 */
class JuzcalculatorGrid extends Juzcalculator
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JuzcalculatorGrid";
    ...
    public $FormName = "fjuzcalculatorgrid";
    ...
    {
        $this->income_all->FormValue = ""; // Clear form value
        $this->outcome_all->FormValue = ""; // Clear form value
        $this->rent_price->FormValue = ""; // Clear form value
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_income_all") && $CurrentForm->hasValue("o_income_all") && $this->income_all->CurrentValue != $this->income_all->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_outcome_all") && $CurrentForm->hasValue("o_outcome_all") && $this->outcome_all->CurrentValue != $this->outcome_all->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_rent_price") && $CurrentForm->hasValue("o_rent_price") && $this->rent_price->CurrentValue != $this->rent_price->OldValue) {
            return false;
        }
    ...
    {
        $this->income_all->clearErrorMessage();
        $this->outcome_all->clearErrorMessage();
        $this->rent_price->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_income_all")) {
            $this->income_all->setOldValue($CurrentForm->getValue("o_income_all"));
        }
        ...
        if ($CurrentForm->hasValue("o_outcome_all")) {
            $this->outcome_all->setOldValue($CurrentForm->getValue("o_outcome_all"));
        }
        ...
        if ($CurrentForm->hasValue("o_rent_price")) {
            $this->rent_price->setOldValue($CurrentForm->getValue("o_rent_price"));
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (strval($this->income_all->EditValue) != "" && is_numeric($this->income_all->EditValue)) {
                ...
                $this->income_all->OldValue = $this->income_all->EditValue;
            }
            ...
            if (strval($this->outcome_all->EditValue) != "" && is_numeric($this->outcome_all->EditValue)) {
                ...
                $this->outcome_all->OldValue = $this->outcome_all->EditValue;
            }
            ...
            if (strval($this->rent_price->EditValue) != "" && is_numeric($this->rent_price->EditValue)) {
                ...
                $this->rent_price->OldValue = $this->rent_price->EditValue;
            }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'juzcalculator'
        ...
        // income_all
        $this->income_all->setDbValueDef($rsnew, $this->income_all->CurrentValue, null, false);

        // outcome_all
        $this->outcome_all->setDbValueDef($rsnew, $this->outcome_all->CurrentValue, null, false);

        // rent_price
        $this->rent_price->setDbValueDef($rsnew, $this->rent_price->CurrentValue, null, false);
