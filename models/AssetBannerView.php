 ...
 * Page class
 */
class AssetBannerView extends AssetBanner
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetBannerView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("asset_banner_id") ?? Route("asset_banner_id")) !== null) {
            $this->RecKey["asset_banner_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        $this->asset_banner_id->setVisibility();
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("asset_banner_id") ?? Route("asset_banner_id")) !== null) {
                $this->asset_banner_id->setQueryStringValue($keyValue);
                $this->RecKey["asset_banner_id"] = $this->asset_banner_id->QueryStringValue;
            } elseif (Post("asset_banner_id") !== null) {
                $this->asset_banner_id->setFormValue(Post("asset_banner_id"));
                $this->RecKey["asset_banner_id"] = $this->asset_banner_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->asset_banner_id->setQueryStringValue($keyValue);
                $this->RecKey["asset_banner_id"] = $this->asset_banner_id->QueryStringValue;
            } else {
                $returnUrl = "assetbannerlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "assetbannerlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "assetbannerlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("assetbannerlist"), "", $this->TableVar, true);
        $pageId = "view";
