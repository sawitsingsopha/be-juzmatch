 ...
 * Page class
 */
class SaveLogSearchNonmemberList extends SaveLogSearchNonmember
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SaveLogSearchNonmemberList";
    ...
    public $FormName = "fsave_log_search_nonmemberlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "savelogsearchnonmemberadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "savelogsearchnonmemberdelete";
        $this->MultiUpdateUrl = "savelogsearchnonmemberupdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fsave_log_search_nonmembersrch");
        }
        $filterList = Concat($filterList, $this->save_log_search_nonmember_id->AdvancedSearch->toJson(), ","); // Field save_log_search_nonmember_id
        $filterList = Concat($filterList, $this->category_id->AdvancedSearch->toJson(), ","); // Field category_id
        $filterList = Concat($filterList, $this->min_installment->AdvancedSearch->toJson(), ","); // Field min_installment
        $filterList = Concat($filterList, $this->max_installment->AdvancedSearch->toJson(), ","); // Field max_installment
        $filterList = Concat($filterList, $this->attribute_detail_id->AdvancedSearch->toJson(), ","); // Field attribute_detail_id
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fsave_log_search_nonmembersrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field save_log_search_nonmember_id
        $this->save_log_search_nonmember_id->AdvancedSearch->SearchValue = @$filter["x_save_log_search_nonmember_id"];
        $this->save_log_search_nonmember_id->AdvancedSearch->SearchOperator = @$filter["z_save_log_search_nonmember_id"];
        $this->save_log_search_nonmember_id->AdvancedSearch->SearchCondition = @$filter["v_save_log_search_nonmember_id"];
        $this->save_log_search_nonmember_id->AdvancedSearch->SearchValue2 = @$filter["y_save_log_search_nonmember_id"];
        $this->save_log_search_nonmember_id->AdvancedSearch->SearchOperator2 = @$filter["w_save_log_search_nonmember_id"];
        $this->save_log_search_nonmember_id->AdvancedSearch->save();
        ...
        // Field min_installment
        $this->min_installment->AdvancedSearch->SearchValue = @$filter["x_min_installment"];
        $this->min_installment->AdvancedSearch->SearchOperator = @$filter["z_min_installment"];
        $this->min_installment->AdvancedSearch->SearchCondition = @$filter["v_min_installment"];
        $this->min_installment->AdvancedSearch->SearchValue2 = @$filter["y_min_installment"];
        $this->min_installment->AdvancedSearch->SearchOperator2 = @$filter["w_min_installment"];
        $this->min_installment->AdvancedSearch->save();

        // Field max_installment
        $this->max_installment->AdvancedSearch->SearchValue = @$filter["x_max_installment"];
        $this->max_installment->AdvancedSearch->SearchOperator = @$filter["z_max_installment"];
        $this->max_installment->AdvancedSearch->SearchCondition = @$filter["v_max_installment"];
        $this->max_installment->AdvancedSearch->SearchValue2 = @$filter["y_max_installment"];
        $this->max_installment->AdvancedSearch->SearchOperator2 = @$filter["w_max_installment"];
        $this->max_installment->AdvancedSearch->save();

        // Field attribute_detail_id
        $this->attribute_detail_id->AdvancedSearch->SearchValue = @$filter["x_attribute_detail_id"];
        $this->attribute_detail_id->AdvancedSearch->SearchOperator = @$filter["z_attribute_detail_id"];
        $this->attribute_detail_id->AdvancedSearch->SearchCondition = @$filter["v_attribute_detail_id"];
        $this->attribute_detail_id->AdvancedSearch->SearchValue2 = @$filter["y_attribute_detail_id"];
        $this->attribute_detail_id->AdvancedSearch->SearchOperator2 = @$filter["w_attribute_detail_id"];
        $this->attribute_detail_id->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->save_log_search_nonmember_id, $ctrl); // save_log_search_nonmember_id
            ...
            $this->updateSort($this->attribute_detail_id, $ctrl); // attribute_detail_id
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fsave_log_search_nonmemberlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fsave_log_search_nonmemberlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->save_log_search_nonmember_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("save_log_search_nonmember_id", $this->createColumnOption("save_log_search_nonmember_id"));
            $option->add("category_id", $this->createColumnOption("category_id"));
            $option->add("min_installment", $this->createColumnOption("min_installment"));
            $option->add("max_installment", $this->createColumnOption("max_installment"));
            $option->add("attribute_detail_id", $this->createColumnOption("attribute_detail_id"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fsave_log_search_nonmembersrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fsave_log_search_nonmembersrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fsave_log_search_nonmemberlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->save_log_search_nonmember_id->TooltipValue = "";
            ...
            if (!$this->isExport()) {
                $this->cip->ViewValue = $this->highlightValue($this->cip);
            }
            ...
            if (!$this->isExport()) {
                $this->cuser->ViewValue = $this->highlightValue($this->cuser);
            }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fsave_log_search_nonmemberlist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-highlight active\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-ew-action=\"highlight\" data-form=\"fsave_log_search_nonmembersrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
