 ...
 * Page class
 */
class MasterConfigList extends MasterConfig
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterConfigList";
    ...
    public $FormName = "fmaster_configlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "masterconfigadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "masterconfigdelete";
        $this->MultiUpdateUrl = "masterconfigupdate";
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->price_booking_invertor, $ctrl); // price_booking_invertor
            $this->updateSort($this->price_booking_buyer, $ctrl); // price_booking_buyer
            $this->updateSort($this->down_payment_buyer, $ctrl); // down_payment_buyer
            $this->updateSort($this->code_asset_seller, $ctrl); // code_asset_seller
            $this->updateSort($this->code_asset_buyer, $ctrl); // code_asset_buyer
            $this->updateSort($this->code_asset_juzmatch, $ctrl); // code_asset_juzmatch
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->master_config_id->setSort("");
                $this->price_booking_invertor->setSort("");
                $this->price_booking_buyer->setSort("");
                $this->down_payment_buyer->setSort("");
                $this->code_asset_seller->setSort("");
                $this->code_asset_buyer->setSort("");
                $this->code_asset_juzmatch->setSort("");
                $this->cdate->setSort("");
                $this->cuser->setSort("");
                $this->cip->setSort("");
                $this->udate->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fmaster_configlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fmaster_configlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->master_config_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("price_booking_invertor", $this->createColumnOption("price_booking_invertor"));
            $option->add("price_booking_buyer", $this->createColumnOption("price_booking_buyer"));
            $option->add("down_payment_buyer", $this->createColumnOption("down_payment_buyer"));
            $option->add("code_asset_seller", $this->createColumnOption("code_asset_seller"));
            $option->add("code_asset_buyer", $this->createColumnOption("code_asset_buyer"));
            $option->add("code_asset_juzmatch", $this->createColumnOption("code_asset_juzmatch"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fmaster_configsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmaster_configsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fmaster_configlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fmaster_configlist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
