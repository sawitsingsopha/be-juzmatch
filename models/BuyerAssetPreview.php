 ...
 * Page class
 */
class BuyerAssetPreview extends BuyerAsset
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerAssetPreview";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("buyerassetlist"), "", $this->TableVar, true);
        $pageId = "preview";
