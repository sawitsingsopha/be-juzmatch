 ...
 * Page class
 */
class PeakProductList extends PeakProduct
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakProductList";
    ...
    public $FormName = "fpeak_productlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "peakproductadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "peakproductdelete";
        $this->MultiUpdateUrl = "peakproductupdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fpeak_productsrch");
        }
        ...
        $filterList = Concat($filterList, $this->purchaseValue->AdvancedSearch->toJson(), ","); // Field purchaseValue
        $filterList = Concat($filterList, $this->purchaseVatType->AdvancedSearch->toJson(), ","); // Field purchaseVatType
        $filterList = Concat($filterList, $this->purchaseAccount->AdvancedSearch->toJson(), ","); // Field purchaseAccount
        $filterList = Concat($filterList, $this->sellValue->AdvancedSearch->toJson(), ","); // Field sellValue
        $filterList = Concat($filterList, $this->sellVatType->AdvancedSearch->toJson(), ","); // Field sellVatType
        $filterList = Concat($filterList, $this->sellAccount->AdvancedSearch->toJson(), ","); // Field sellAccount
        $filterList = Concat($filterList, $this->description->AdvancedSearch->toJson(), ","); // Field description
        $filterList = Concat($filterList, $this->carryingBalanceValue->AdvancedSearch->toJson(), ","); // Field carryingBalanceValue
        $filterList = Concat($filterList, $this->carryingBalanceAmount->AdvancedSearch->toJson(), ","); // Field carryingBalanceAmount
        $filterList = Concat($filterList, $this->remainingBalanceAmount->AdvancedSearch->toJson(), ","); // Field remainingBalanceAmount
        $filterList = Concat($filterList, $this->create_date->AdvancedSearch->toJson(), ","); // Field create_date
        $filterList = Concat($filterList, $this->update_date->AdvancedSearch->toJson(), ","); // Field update_date
        $filterList = Concat($filterList, $this->post_message->AdvancedSearch->toJson(), ","); // Field post_message
        $filterList = Concat($filterList, $this->post_try_cnt->AdvancedSearch->toJson(), ","); // Field post_try_cnt
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpeak_productsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field purchaseValue
        $this->purchaseValue->AdvancedSearch->SearchValue = @$filter["x_purchaseValue"];
        $this->purchaseValue->AdvancedSearch->SearchOperator = @$filter["z_purchaseValue"];
        $this->purchaseValue->AdvancedSearch->SearchCondition = @$filter["v_purchaseValue"];
        $this->purchaseValue->AdvancedSearch->SearchValue2 = @$filter["y_purchaseValue"];
        $this->purchaseValue->AdvancedSearch->SearchOperator2 = @$filter["w_purchaseValue"];
        $this->purchaseValue->AdvancedSearch->save();

        // Field purchaseVatType
        $this->purchaseVatType->AdvancedSearch->SearchValue = @$filter["x_purchaseVatType"];
        $this->purchaseVatType->AdvancedSearch->SearchOperator = @$filter["z_purchaseVatType"];
        $this->purchaseVatType->AdvancedSearch->SearchCondition = @$filter["v_purchaseVatType"];
        $this->purchaseVatType->AdvancedSearch->SearchValue2 = @$filter["y_purchaseVatType"];
        $this->purchaseVatType->AdvancedSearch->SearchOperator2 = @$filter["w_purchaseVatType"];
        $this->purchaseVatType->AdvancedSearch->save();

        // Field purchaseAccount
        $this->purchaseAccount->AdvancedSearch->SearchValue = @$filter["x_purchaseAccount"];
        $this->purchaseAccount->AdvancedSearch->SearchOperator = @$filter["z_purchaseAccount"];
        $this->purchaseAccount->AdvancedSearch->SearchCondition = @$filter["v_purchaseAccount"];
        $this->purchaseAccount->AdvancedSearch->SearchValue2 = @$filter["y_purchaseAccount"];
        $this->purchaseAccount->AdvancedSearch->SearchOperator2 = @$filter["w_purchaseAccount"];
        $this->purchaseAccount->AdvancedSearch->save();

        // Field sellValue
        $this->sellValue->AdvancedSearch->SearchValue = @$filter["x_sellValue"];
        $this->sellValue->AdvancedSearch->SearchOperator = @$filter["z_sellValue"];
        $this->sellValue->AdvancedSearch->SearchCondition = @$filter["v_sellValue"];
        $this->sellValue->AdvancedSearch->SearchValue2 = @$filter["y_sellValue"];
        $this->sellValue->AdvancedSearch->SearchOperator2 = @$filter["w_sellValue"];
        $this->sellValue->AdvancedSearch->save();

        // Field sellVatType
        $this->sellVatType->AdvancedSearch->SearchValue = @$filter["x_sellVatType"];
        $this->sellVatType->AdvancedSearch->SearchOperator = @$filter["z_sellVatType"];
        $this->sellVatType->AdvancedSearch->SearchCondition = @$filter["v_sellVatType"];
        $this->sellVatType->AdvancedSearch->SearchValue2 = @$filter["y_sellVatType"];
        $this->sellVatType->AdvancedSearch->SearchOperator2 = @$filter["w_sellVatType"];
        $this->sellVatType->AdvancedSearch->save();

        // Field sellAccount
        $this->sellAccount->AdvancedSearch->SearchValue = @$filter["x_sellAccount"];
        $this->sellAccount->AdvancedSearch->SearchOperator = @$filter["z_sellAccount"];
        $this->sellAccount->AdvancedSearch->SearchCondition = @$filter["v_sellAccount"];
        $this->sellAccount->AdvancedSearch->SearchValue2 = @$filter["y_sellAccount"];
        $this->sellAccount->AdvancedSearch->SearchOperator2 = @$filter["w_sellAccount"];
        $this->sellAccount->AdvancedSearch->save();
        ...
        // Field carryingBalanceValue
        $this->carryingBalanceValue->AdvancedSearch->SearchValue = @$filter["x_carryingBalanceValue"];
        $this->carryingBalanceValue->AdvancedSearch->SearchOperator = @$filter["z_carryingBalanceValue"];
        $this->carryingBalanceValue->AdvancedSearch->SearchCondition = @$filter["v_carryingBalanceValue"];
        $this->carryingBalanceValue->AdvancedSearch->SearchValue2 = @$filter["y_carryingBalanceValue"];
        $this->carryingBalanceValue->AdvancedSearch->SearchOperator2 = @$filter["w_carryingBalanceValue"];
        $this->carryingBalanceValue->AdvancedSearch->save();

        // Field carryingBalanceAmount
        $this->carryingBalanceAmount->AdvancedSearch->SearchValue = @$filter["x_carryingBalanceAmount"];
        $this->carryingBalanceAmount->AdvancedSearch->SearchOperator = @$filter["z_carryingBalanceAmount"];
        $this->carryingBalanceAmount->AdvancedSearch->SearchCondition = @$filter["v_carryingBalanceAmount"];
        $this->carryingBalanceAmount->AdvancedSearch->SearchValue2 = @$filter["y_carryingBalanceAmount"];
        $this->carryingBalanceAmount->AdvancedSearch->SearchOperator2 = @$filter["w_carryingBalanceAmount"];
        $this->carryingBalanceAmount->AdvancedSearch->save();

        // Field remainingBalanceAmount
        $this->remainingBalanceAmount->AdvancedSearch->SearchValue = @$filter["x_remainingBalanceAmount"];
        $this->remainingBalanceAmount->AdvancedSearch->SearchOperator = @$filter["z_remainingBalanceAmount"];
        $this->remainingBalanceAmount->AdvancedSearch->SearchCondition = @$filter["v_remainingBalanceAmount"];
        $this->remainingBalanceAmount->AdvancedSearch->SearchValue2 = @$filter["y_remainingBalanceAmount"];
        $this->remainingBalanceAmount->AdvancedSearch->SearchOperator2 = @$filter["w_remainingBalanceAmount"];
        $this->remainingBalanceAmount->AdvancedSearch->save();
        ...
        // Field post_message
        $this->post_message->AdvancedSearch->SearchValue = @$filter["x_post_message"];
        $this->post_message->AdvancedSearch->SearchOperator = @$filter["z_post_message"];
        $this->post_message->AdvancedSearch->SearchCondition = @$filter["v_post_message"];
        $this->post_message->AdvancedSearch->SearchValue2 = @$filter["y_post_message"];
        $this->post_message->AdvancedSearch->SearchOperator2 = @$filter["w_post_message"];
        $this->post_message->AdvancedSearch->save();

        // Field post_try_cnt
        $this->post_try_cnt->AdvancedSearch->SearchValue = @$filter["x_post_try_cnt"];
        $this->post_try_cnt->AdvancedSearch->SearchOperator = @$filter["z_post_try_cnt"];
        $this->post_try_cnt->AdvancedSearch->SearchCondition = @$filter["v_post_try_cnt"];
        $this->post_try_cnt->AdvancedSearch->SearchValue2 = @$filter["y_post_try_cnt"];
        $this->post_try_cnt->AdvancedSearch->SearchOperator2 = @$filter["w_post_try_cnt"];
        $this->post_try_cnt->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->productid;
        $searchFlds[] = &$this->name;
        $searchFlds[] = &$this->code;
        $searchFlds[] = &$this->purchaseAccount;
        $searchFlds[] = &$this->sellAccount;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->productid, $ctrl); // productid
            $this->updateSort($this->name, $ctrl); // name
            $this->updateSort($this->code, $ctrl); // code
            $this->updateSort($this->type, $ctrl); // type
            $this->updateSort($this->purchaseValue, $ctrl); // purchaseValue
            $this->updateSort($this->purchaseVatType, $ctrl); // purchaseVatType
            $this->updateSort($this->purchaseAccount, $ctrl); // purchaseAccount
            $this->updateSort($this->sellValue, $ctrl); // sellValue
            $this->updateSort($this->sellVatType, $ctrl); // sellVatType
            $this->updateSort($this->sellAccount, $ctrl); // sellAccount
            $this->updateSort($this->carryingBalanceValue, $ctrl); // carryingBalanceValue
            $this->updateSort($this->carryingBalanceAmount, $ctrl); // carryingBalanceAmount
            $this->updateSort($this->remainingBalanceAmount, $ctrl); // remainingBalanceAmount
            $this->updateSort($this->create_date, $ctrl); // create_date
            $this->updateSort($this->update_date, $ctrl); // update_date
            $this->updateSort($this->post_message, $ctrl); // post_message
            $this->updateSort($this->post_try_cnt, $ctrl); // post_try_cnt
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->code->setSort("");
                $this->type->setSort("");
                $this->purchaseValue->setSort("");
                $this->purchaseVatType->setSort("");
                $this->purchaseAccount->setSort("");
                $this->sellValue->setSort("");
                $this->sellVatType->setSort("");
                $this->sellAccount->setSort("");
                $this->description->setSort("");
                $this->carryingBalanceValue->setSort("");
                $this->carryingBalanceAmount->setSort("");
                $this->remainingBalanceAmount->setSort("");
                $this->create_date->setSort("");
                $this->update_date->setSort("");
                $this->post_message->setSort("");
                $this->post_try_cnt->setSort("");
            }
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpeak_productlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpeak_productlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("productid", $this->createColumnOption("productid"));
            ...
            $option->add("purchaseValue", $this->createColumnOption("purchaseValue"));
            $option->add("purchaseVatType", $this->createColumnOption("purchaseVatType"));
            $option->add("purchaseAccount", $this->createColumnOption("purchaseAccount"));
            $option->add("sellValue", $this->createColumnOption("sellValue"));
            $option->add("sellVatType", $this->createColumnOption("sellVatType"));
            $option->add("sellAccount", $this->createColumnOption("sellAccount"));
            $option->add("carryingBalanceValue", $this->createColumnOption("carryingBalanceValue"));
            $option->add("carryingBalanceAmount", $this->createColumnOption("carryingBalanceAmount"));
            $option->add("remainingBalanceAmount", $this->createColumnOption("remainingBalanceAmount"));
            $option->add("create_date", $this->createColumnOption("create_date"));
            $option->add("update_date", $this->createColumnOption("update_date"));
            $option->add("post_message", $this->createColumnOption("post_message"));
            $option->add("post_try_cnt", $this->createColumnOption("post_try_cnt"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpeak_productsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpeak_productsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fpeak_productlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function newRow()
    {
        ...
        $row['code'] = null;
        $row['type'] = null;
        $row['purchaseValue'] = null;
        $row['purchaseVatType'] = null;
        $row['purchaseAccount'] = null;
        $row['sellValue'] = null;
        $row['sellVatType'] = null;
        $row['sellAccount'] = null;
        $row['description'] = null;
        $row['carryingBalanceValue'] = null;
        $row['carryingBalanceAmount'] = null;
        $row['remainingBalanceAmount'] = null;
        $row['create_date'] = null;
        $row['update_date'] = null;
        $row['post_message'] = null;
        $row['post_try_cnt'] = null;
        return $row;
    }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fpeak_productlist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fpeak_productsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
