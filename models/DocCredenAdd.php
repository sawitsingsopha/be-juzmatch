 ...
 * Page class
 */
class DocCredenAdd extends DocCreden
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocCredenAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "doccredenview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->send_email->CurrentValue = null;
        $this->send_email->OldValue = $this->send_email->CurrentValue;
        $this->redirect_url->CurrentValue = null;
        $this->redirect_url->OldValue = $this->redirect_url->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['send_email'] = $this->send_email->CurrentValue;
        $row['redirect_url'] = $this->redirect_url->CurrentValue;
        ...
        $row['doc_url'] = $this->doc_url->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // document_id
        $this->document_id->setDbValueDef($rsnew, $this->document_id->CurrentValue, null, false);

        // doc_temp_id
        $this->doc_temp_id->setDbValueDef($rsnew, $this->doc_temp_id->CurrentValue, null, false);

        // txid
        $this->txid->setDbValueDef($rsnew, $this->txid->CurrentValue, null, false);

        // subject
        $this->subject->setDbValueDef($rsnew, $this->subject->CurrentValue, null, false);

        // send_email
        $this->send_email->setDbValueDef($rsnew, $this->send_email->CurrentValue, null, false);

        // redirect_url
        $this->redirect_url->setDbValueDef($rsnew, $this->redirect_url->CurrentValue, null, false);
