 ...
 * Page class
 */
class AssetInterestedList extends AssetInterested
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetInterestedList";
    ...
    public $FormName = "fasset_interestedlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "assetinterestedadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "assetinteresteddelete";
        $this->MultiUpdateUrl = "assetinterestedupdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fasset_interestedsrch");
        }
        $filterList = Concat($filterList, $this->asset_interested_id->AdvancedSearch->toJson(), ","); // Field asset_interested_id
        $filterList = Concat($filterList, $this->asset_id->AdvancedSearch->toJson(), ","); // Field asset_id
        $filterList = Concat($filterList, $this->master_asset_interested_id->AdvancedSearch->toJson(), ","); // Field master_asset_interested_id
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fasset_interestedsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field asset_interested_id
        $this->asset_interested_id->AdvancedSearch->SearchValue = @$filter["x_asset_interested_id"];
        $this->asset_interested_id->AdvancedSearch->SearchOperator = @$filter["z_asset_interested_id"];
        $this->asset_interested_id->AdvancedSearch->SearchCondition = @$filter["v_asset_interested_id"];
        $this->asset_interested_id->AdvancedSearch->SearchValue2 = @$filter["y_asset_interested_id"];
        $this->asset_interested_id->AdvancedSearch->SearchOperator2 = @$filter["w_asset_interested_id"];
        $this->asset_interested_id->AdvancedSearch->save();
        ...
        // Field master_asset_interested_id
        $this->master_asset_interested_id->AdvancedSearch->SearchValue = @$filter["x_master_asset_interested_id"];
        $this->master_asset_interested_id->AdvancedSearch->SearchOperator = @$filter["z_master_asset_interested_id"];
        $this->master_asset_interested_id->AdvancedSearch->SearchCondition = @$filter["v_master_asset_interested_id"];
        $this->master_asset_interested_id->AdvancedSearch->SearchValue2 = @$filter["y_master_asset_interested_id"];
        $this->master_asset_interested_id->AdvancedSearch->SearchOperator2 = @$filter["w_master_asset_interested_id"];
        $this->master_asset_interested_id->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->asset_interested_id, $default, false); // asset_interested_id
        $this->buildSearchSql($where, $this->asset_id, $default, false); // asset_id
        $this->buildSearchSql($where, $this->master_asset_interested_id, $default, false); // master_asset_interested_id
        ...
        if (!$default && $this->Command == "search") {
            $this->asset_interested_id->AdvancedSearch->save(); // asset_interested_id
            $this->asset_id->AdvancedSearch->save(); // asset_id
            $this->master_asset_interested_id->AdvancedSearch->save(); // master_asset_interested_id
    ...
    {
        if ($this->asset_interested_id->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->asset_id->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->master_asset_interested_id->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    {
        $this->asset_interested_id->AdvancedSearch->unsetSession();
        $this->asset_id->AdvancedSearch->unsetSession();
        $this->master_asset_interested_id->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->asset_interested_id->AdvancedSearch->load();
        $this->asset_id->AdvancedSearch->load();
        $this->master_asset_interested_id->AdvancedSearch->load();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->asset_interested_id, $ctrl); // asset_interested_id
            $this->updateSort($this->asset_id, $ctrl); // asset_id
            $this->updateSort($this->master_asset_interested_id, $ctrl); // master_asset_interested_id
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->asset_interested_id->setSort("");
                $this->asset_id->setSort("");
                $this->master_asset_interested_id->setSort("");
                $this->cdate->setSort("");
                $this->cuser->setSort("");
                $this->cip->setSort("");
                $this->udate->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fasset_interestedlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fasset_interestedlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->asset_interested_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("asset_interested_id", $this->createColumnOption("asset_interested_id"));
            $option->add("asset_id", $this->createColumnOption("asset_id"));
            $option->add("master_asset_interested_id", $this->createColumnOption("master_asset_interested_id"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fasset_interestedsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fasset_interestedsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fasset_interestedlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function loadSearchValues()
    {
        ...
        // asset_interested_id
        if ($this->asset_interested_id->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->asset_interested_id->AdvancedSearch->SearchValue != "" || $this->asset_interested_id->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->master_asset_interested_id->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->master_asset_interested_id->AdvancedSearch->SearchValue != "" || $this->master_asset_interested_id->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->asset_interested_id->EditValue = HtmlEncode($this->asset_interested_id->AdvancedSearch->SearchValue);
            $this->asset_interested_id->PlaceHolder = RemoveHtml($this->asset_interested_id->caption());
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fasset_interestedlist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fasset_interestedsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        $item->Body = "<a class=\"btn btn-default ew-highlight active\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-ew-action=\"highlight\" data-form=\"fasset_interestedsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
