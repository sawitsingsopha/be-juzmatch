 ...
 * Page class
 */
class AssetScheduleGrid extends AssetSchedule
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetScheduleGrid";
    ...
    public $FormName = "fasset_schedulegrid";
    ...
    {
        $this->receive_per_installment_invertor->FormValue = ""; // Clear form value
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->asset_schedule_id->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_receive_per_installment_invertor") && $CurrentForm->hasValue("o_receive_per_installment_invertor") && $this->receive_per_installment_invertor->CurrentValue != $this->receive_per_installment_invertor->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->receive_per_installment_invertor->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_receive_per_installment_invertor")) {
            $this->receive_per_installment_invertor->setOldValue($CurrentForm->getValue("o_receive_per_installment_invertor"));
        }
        ...
        if ($CurrentForm->hasValue("o_uip")) {
            $this->uip->setOldValue($CurrentForm->getValue("o_uip"));
        }
        ...
        if (!$this->asset_schedule_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (strval($this->receive_per_installment_invertor->EditValue) != "" && is_numeric($this->receive_per_installment_invertor->EditValue)) {
                ...
                $this->receive_per_installment_invertor->OldValue = $this->receive_per_installment_invertor->EditValue;
            }
