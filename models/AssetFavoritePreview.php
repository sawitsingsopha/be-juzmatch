 ...
 * Page class
 */
class AssetFavoritePreview extends AssetFavorite
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetFavoritePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "member") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=member&" . GetForeignKeyUrl("fk_member_id", $this->member_id->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("assetfavoritelist"), "", $this->TableVar, true);
        $pageId = "preview";
