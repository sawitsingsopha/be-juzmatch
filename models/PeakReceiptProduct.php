...
/**
 * Table class for peak_receipt_product
 */
class PeakReceiptProduct extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'peak_receipt_product';
        $this->TableName = 'peak_receipt_product';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`peak_receipt_product`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // peak_receipt_id
        $this->peak_receipt_id = new DbField(
            'peak_receipt_product',
            'peak_receipt_product',
            'x_peak_receipt_id',
            'peak_receipt_id',
        ...
        $this->peak_receipt_id->InputTextType = "text";
        $this->peak_receipt_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['peak_receipt_id'] = &$this->peak_receipt_id;

        // products_id
        $this->products_id = new DbField(
            'peak_receipt_product',
            'peak_receipt_product',
            'x_products_id',
            'products_id',
        ...
        $this->products_id->InputTextType = "text";
        $this->Fields['products_id'] = &$this->products_id;
        ...
        // producttemplate
        $this->producttemplate = new DbField(
            'peak_receipt_product',
            'peak_receipt_product',
            'x_producttemplate',
            'producttemplate',
        ...
        $this->producttemplate->InputTextType = "text";
        $this->Fields['producttemplate'] = &$this->producttemplate;
        ...
        $this->accountSubId->InputTextType = "text";
        $this->Fields['accountSubId'] = &$this->accountSubId;

        // accountSubCode
        $this->accountSubCode = new DbField(
            'peak_receipt_product',
            'peak_receipt_product',
            'x_accountSubCode',
            'accountSubCode',
        ...
        $this->accountSubCode->InputTextType = "text";
        $this->Fields['accountSubCode'] = &$this->accountSubCode;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`peak_receipt_product`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->peak_receipt_id->DbValue = $row['peak_receipt_id'];
        $this->products_id->DbValue = $row['products_id'];
        $this->productid->DbValue = $row['productid'];
        $this->productcode->DbValue = $row['productcode'];
        $this->producttemplate->DbValue = $row['producttemplate'];
        $this->description->DbValue = $row['description'];
        $this->accountcode->DbValue = $row['accountcode'];
        $this->accountSubId->DbValue = $row['accountSubId'];
        $this->accountSubCode->DbValue = $row['accountSubCode'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("peakreceiptproductlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "peakreceiptproductedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "peakreceiptproductadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PeakReceiptProductView";
            case Config("API_ADD_ACTION"):
                return "PeakReceiptProductAdd";
            case Config("API_EDIT_ACTION"):
                return "PeakReceiptProductEdit";
            case Config("API_DELETE_ACTION"):
                return "PeakReceiptProductDelete";
            case Config("API_LIST_ACTION"):
                return "PeakReceiptProductList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("peakreceiptproductview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("peakreceiptproductview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "peakreceiptproductadd?" . $this->getUrlParm($parm);
        } else {
            $url = "peakreceiptproductadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("peakreceiptproductedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("peakreceiptproductadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("peakreceiptproductdelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->peak_receipt_id->EditValue = $this->peak_receipt_id->CurrentValue;
        ...
        $this->products_id->EditValue = $this->products_id->CurrentValue;
        ...
        $this->producttemplate->EditValue = $this->producttemplate->CurrentValue;
        ...
        $this->accountSubId->EditValue = $this->accountSubId->CurrentValue;
        ...
        $this->accountSubCode->EditValue = $this->accountSubCode->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->peak_receipt_id);
                    $doc->exportCaption($this->products_id);
                    $doc->exportCaption($this->productid);
                    $doc->exportCaption($this->productcode);
                    $doc->exportCaption($this->producttemplate);
                    $doc->exportCaption($this->description);
                    $doc->exportCaption($this->accountcode);
                    $doc->exportCaption($this->accountSubId);
                    $doc->exportCaption($this->accountSubCode);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->peak_receipt_id);
                        $doc->exportField($this->products_id);
                        $doc->exportField($this->productid);
                        $doc->exportField($this->productcode);
                        $doc->exportField($this->producttemplate);
                        $doc->exportField($this->description);
                        $doc->exportField($this->accountcode);
                        $doc->exportField($this->accountSubId);
                        $doc->exportField($this->accountSubCode);
