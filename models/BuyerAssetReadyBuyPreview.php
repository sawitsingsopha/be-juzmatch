 ...
 * Page class
 */
class BuyerAssetReadyBuyPreview extends BuyerAssetReadyBuy
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerAssetReadyBuyPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "buyer_asset") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=buyer_asset&" . GetForeignKeyUrl("fk_asset_id", $this->asset_id->QueryStringValue) . "&" . GetForeignKeyUrl("fk_member_id", $this->member_id->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("buyerassetreadybuylist"), "", $this->TableVar, true);
        $pageId = "preview";
