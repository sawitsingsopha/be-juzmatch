 ...
 * Page class
 */
class PeakProductEdit extends PeakProduct
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeakProductEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // purchaseValue
            $this->purchaseValue->setDbValueDef($rsnew, $this->purchaseValue->CurrentValue, null, $this->purchaseValue->ReadOnly);

            // purchaseVatType
            $this->purchaseVatType->setDbValueDef($rsnew, $this->purchaseVatType->CurrentValue, null, $this->purchaseVatType->ReadOnly);

            // purchaseAccount
            $this->purchaseAccount->setDbValueDef($rsnew, $this->purchaseAccount->CurrentValue, null, $this->purchaseAccount->ReadOnly);

            // sellValue
            $this->sellValue->setDbValueDef($rsnew, $this->sellValue->CurrentValue, null, $this->sellValue->ReadOnly);

            // sellVatType
            $this->sellVatType->setDbValueDef($rsnew, $this->sellVatType->CurrentValue, null, $this->sellVatType->ReadOnly);

            // sellAccount
            $this->sellAccount->setDbValueDef($rsnew, $this->sellAccount->CurrentValue, null, $this->sellAccount->ReadOnly);

            // description
            $this->description->setDbValueDef($rsnew, $this->description->CurrentValue, null, $this->description->ReadOnly);

            // carryingBalanceValue
            $this->carryingBalanceValue->setDbValueDef($rsnew, $this->carryingBalanceValue->CurrentValue, null, $this->carryingBalanceValue->ReadOnly);

            // carryingBalanceAmount
            $this->carryingBalanceAmount->setDbValueDef($rsnew, $this->carryingBalanceAmount->CurrentValue, null, $this->carryingBalanceAmount->ReadOnly);

            // remainingBalanceAmount
            $this->remainingBalanceAmount->setDbValueDef($rsnew, $this->remainingBalanceAmount->CurrentValue, null, $this->remainingBalanceAmount->ReadOnly);
            ...
            // update_date
            $this->update_date->setDbValueDef($rsnew, UnFormatDateTime($this->update_date->CurrentValue, $this->update_date->formatPattern()), null, $this->update_date->ReadOnly);

            // post_message
            $this->post_message->setDbValueDef($rsnew, $this->post_message->CurrentValue, null, $this->post_message->ReadOnly);

            // post_try_cnt
            $this->post_try_cnt->setDbValueDef($rsnew, $this->post_try_cnt->CurrentValue, null, $this->post_try_cnt->ReadOnly);
