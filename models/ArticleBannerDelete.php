 ...
 * Page class
 */
class ArticleBannerDelete extends ArticleBanner
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArticleBannerDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("articlebannerlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("articlebannerlist"); // Return to list
                return;
            }
        }
