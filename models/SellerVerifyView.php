 ...
 * Page class
 */
class SellerVerifyView extends SellerVerify
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SellerVerifyView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("seller_verify_id") ?? Route("seller_verify_id")) !== null) {
            $this->RecKey["seller_verify_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        $this->seller_verify_id->setVisibility();
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("seller_verify_id") ?? Route("seller_verify_id")) !== null) {
                ...
                $this->RecKey["seller_verify_id"] = $this->seller_verify_id->QueryStringValue;
            } elseif (Post("seller_verify_id") !== null) {
                $this->seller_verify_id->setFormValue(Post("seller_verify_id"));
                $this->RecKey["seller_verify_id"] = $this->seller_verify_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->seller_verify_id->setQueryStringValue($keyValue);
                $this->RecKey["seller_verify_id"] = $this->seller_verify_id->QueryStringValue;
            } else {
                $returnUrl = "sellerverifylist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "sellerverifylist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "sellerverifylist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
