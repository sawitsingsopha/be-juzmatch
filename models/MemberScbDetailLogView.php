 ...
 * Page class
 */
class MemberScbDetailLogView extends MemberScbDetailLog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MemberScbDetailLogView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("member_scb_detail_log_id") ?? Route("member_scb_detail_log_id")) !== null) {
            $this->RecKey["member_scb_detail_log_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("member_scb_detail_log_id") ?? Route("member_scb_detail_log_id")) !== null) {
                ...
                $this->RecKey["member_scb_detail_log_id"] = $this->member_scb_detail_log_id->QueryStringValue;
            } elseif (Post("member_scb_detail_log_id") !== null) {
                $this->member_scb_detail_log_id->setFormValue(Post("member_scb_detail_log_id"));
                $this->RecKey["member_scb_detail_log_id"] = $this->member_scb_detail_log_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->member_scb_detail_log_id->setQueryStringValue($keyValue);
                $this->RecKey["member_scb_detail_log_id"] = $this->member_scb_detail_log_id->QueryStringValue;
            } else {
                $returnUrl = "memberscbdetailloglist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "memberscbdetailloglist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "memberscbdetailloglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
