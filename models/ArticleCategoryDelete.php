 ...
 * Page class
 */
class ArticleCategoryDelete extends ArticleCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArticleCategoryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("articlecategorylist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("articlecategorylist"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['article_category_id'];
