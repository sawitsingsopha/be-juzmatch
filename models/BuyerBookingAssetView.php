 ...
 * Page class
 */
class BuyerBookingAssetView extends BuyerBookingAsset
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuyerBookingAssetView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("buyer_booking_asset_id") ?? Route("buyer_booking_asset_id")) !== null) {
                ...
                $returnUrl = "buyerbookingassetlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "buyerbookingassetlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "buyerbookingassetlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("buyerbookingassetlist"), "", $this->TableVar, true);
        $pageId = "view";
