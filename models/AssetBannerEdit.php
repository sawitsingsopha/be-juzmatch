 ...
 * Page class
 */
class AssetBannerEdit extends AssetBanner
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AssetBannerEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("asset_banner_id") ?? Key(0) ?? Route(2)) !== null) {
                $this->asset_banner_id->setQueryStringValue($keyValue);
                $this->asset_banner_id->setOldValue($this->asset_banner_id->QueryStringValue);
            } elseif (Post("asset_banner_id") !== null) {
                $this->asset_banner_id->setFormValue(Post("asset_banner_id"));
                $this->asset_banner_id->setOldValue($this->asset_banner_id->FormValue);
            } else {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("assetbannerlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "assetbannerlist") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->asset_banner_id->IsDetailKey) {
    ...
    public function renderRow()
    {
        ...
        // asset_banner_id
        $this->asset_banner_id->RowCssClass = "row";
