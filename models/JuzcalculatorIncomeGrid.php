 ...
 * Page class
 */
class JuzcalculatorIncomeGrid extends JuzcalculatorIncome
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JuzcalculatorIncomeGrid";
    ...
    public $FormName = "fjuzcalculator_incomegrid";
    ...
    {
        $this->income->FormValue = ""; // Clear form value
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->juzcalculator_income_id->CurrentValue;
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_income_title") && $CurrentForm->hasValue("o_income_title") && $this->income_title->CurrentValue != $this->income_title->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_income") && $CurrentForm->hasValue("o_income") && $this->income->CurrentValue != $this->income->OldValue) {
            return false;
        }
        return true;
    }
    ...
    {
        $this->income_title->clearErrorMessage();
        $this->income->clearErrorMessage();
    ...
    {
        $this->juzcalculator_income_id->CurrentValue = null;
        $this->juzcalculator_income_id->OldValue = $this->juzcalculator_income_id->CurrentValue;
        $this->juzcalculator_id->CurrentValue = null;
        $this->juzcalculator_id->OldValue = $this->juzcalculator_id->CurrentValue;
        $this->income_title->CurrentValue = null;
        $this->income_title->OldValue = $this->income_title->CurrentValue;
        $this->income->CurrentValue = null;
        $this->income->OldValue = $this->income->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_income_title")) {
            $this->income_title->setOldValue($CurrentForm->getValue("o_income_title"));
        }
        ...
        if (!$this->income->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->income->setFormValue($val, true, $validate);
            }
        }
        if ($CurrentForm->hasValue("o_income")) {
            $this->income->setOldValue($CurrentForm->getValue("o_income"));
        }
        ...
        // Check field name 'juzcalculator_income_id' first before field var 'x_juzcalculator_income_id'
        $val = $CurrentForm->hasValue("juzcalculator_income_id") ? $CurrentForm->getValue("juzcalculator_income_id") : $CurrentForm->getValue("x_juzcalculator_income_id");
        if (!$this->juzcalculator_income_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->juzcalculator_income_id->setFormValue($val);
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->juzcalculator_income_id->CurrentValue = $this->juzcalculator_income_id->FormValue;
        }
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['juzcalculator_income_id'] = $this->juzcalculator_income_id->CurrentValue;
        $row['juzcalculator_id'] = $this->juzcalculator_id->CurrentValue;
        $row['income_title'] = $this->income_title->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->income_title->EditCustomAttributes = "";
            ...
            if (strval($this->income->EditValue) != "" && is_numeric($this->income->EditValue)) {
                $this->income->EditValue = FormatNumber($this->income->EditValue, null);
                $this->income->OldValue = $this->income->EditValue;
            }
    ...
    protected function validateForm()
    {
        ...
        if (!CheckNumber($this->income->FormValue)) {
            $this->income->addErrorMessage($this->income->getErrorMessage(false));
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['juzcalculator_income_id'];
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // income_title
            $this->income_title->setDbValueDef($rsnew, $this->income_title->CurrentValue, null, $this->income_title->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // income_title
        $this->income_title->setDbValueDef($rsnew, $this->income_title->CurrentValue, null, false);
