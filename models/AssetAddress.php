...
/**
 * Table class for asset_address
 */
class AssetAddress extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'asset_address';
        $this->TableName = 'asset_address';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`asset_address`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`asset_address`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("assetaddresslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "assetaddressview") {
            return $Language->phrase("View");
        } elseif ($pageName == "assetaddressedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "assetaddressadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AssetAddressView";
            case Config("API_ADD_ACTION"):
                return "AssetAddressAdd";
            case Config("API_EDIT_ACTION"):
                return "AssetAddressEdit";
            case Config("API_DELETE_ACTION"):
                return "AssetAddressDelete";
            case Config("API_LIST_ACTION"):
                return "AssetAddressList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("assetaddressview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("assetaddressview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "assetaddressadd?" . $this->getUrlParm($parm);
        } else {
            $url = "assetaddressadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("assetaddressedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("assetaddressadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("assetaddressdelete", $this->getUrlParm());
    }
