...
/**
 * Table class for juzcalculator_income
 */
class JuzcalculatorIncome extends DbTable
{
    protected $SqlFrom = "";
    ...
    // Fields
    public $juzcalculator_income_id;
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'juzcalculator_income';
        $this->TableName = 'juzcalculator_income';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`juzcalculator_income`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->juzcalculator_income_id = new DbField(
            'juzcalculator_income',
            'juzcalculator_income',
            'x_juzcalculator_income_id',
            'juzcalculator_income_id',
            '`juzcalculator_income_id`',
            '`juzcalculator_income_id`',
            3,
        ...
        $this->juzcalculator_income_id->InputTextType = "text";
        $this->juzcalculator_income_id->IsAutoIncrement = true; // Autoincrement field
        $this->juzcalculator_income_id->IsPrimaryKey = true; // Primary key field
        $this->juzcalculator_income_id->Sortable = false; // Allow sort
        $this->juzcalculator_income_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['juzcalculator_income_id'] = &$this->juzcalculator_income_id;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`juzcalculator_income`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->juzcalculator_income_id->setDbValue($conn->lastInsertId());
            $rs['juzcalculator_income_id'] = $this->juzcalculator_income_id->DbValue;
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success && $this->AuditTrailOnEdit && $rsold) {
            $rsaudit = $rs;
            $fldname = 'juzcalculator_income_id';
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('juzcalculator_income_id', $rs)) {
                AddFilter($where, QuotedName('juzcalculator_income_id', $this->Dbid) . '=' . QuotedValue($rs['juzcalculator_income_id'], $this->juzcalculator_income_id->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->juzcalculator_income_id->DbValue = $row['juzcalculator_income_id'];
    ...
    {
        return "`juzcalculator_income_id` = @juzcalculator_income_id@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->juzcalculator_income_id->CurrentValue : $this->juzcalculator_income_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->juzcalculator_income_id->CurrentValue = $keys[0];
            } else {
                $this->juzcalculator_income_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('juzcalculator_income_id', $row) ? $row['juzcalculator_income_id'] : null;
        } else {
            $val = $this->juzcalculator_income_id->OldValue !== null ? $this->juzcalculator_income_id->OldValue : $this->juzcalculator_income_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@juzcalculator_income_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("juzcalculatorincomelist");
    }
    ...
    {
        global $Language;
        if ($pageName == "juzcalculatorincomeview") {
            return $Language->phrase("View");
        } elseif ($pageName == "juzcalculatorincomeedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "juzcalculatorincomeadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JuzcalculatorIncomeView";
            case Config("API_ADD_ACTION"):
                return "JuzcalculatorIncomeAdd";
            case Config("API_EDIT_ACTION"):
                return "JuzcalculatorIncomeEdit";
            case Config("API_DELETE_ACTION"):
                return "JuzcalculatorIncomeDelete";
            case Config("API_LIST_ACTION"):
                return "JuzcalculatorIncomeList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("juzcalculatorincomeview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("juzcalculatorincomeview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "juzcalculatorincomeadd?" . $this->getUrlParm($parm);
        } else {
            $url = "juzcalculatorincomeadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("juzcalculatorincomeedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("juzcalculatorincomeadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("juzcalculatorincomedelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "\"juzcalculator_income_id\":" . JsonEncode($this->juzcalculator_income_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->juzcalculator_income_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->juzcalculator_income_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("juzcalculator_income_id") ?? Route("juzcalculator_income_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->juzcalculator_income_id->CurrentValue = $key;
            } else {
                $this->juzcalculator_income_id->OldValue = $key;
            }
    ...
    public function renderListRow()
    {
        ...
        // juzcalculator_income_id
        $this->juzcalculator_income_id->ViewValue = $this->juzcalculator_income_id->CurrentValue;
        $this->juzcalculator_income_id->ViewCustomAttributes = "";
        ...
        // juzcalculator_income_id
        $this->juzcalculator_income_id->LinkCustomAttributes = "";
        $this->juzcalculator_income_id->HrefValue = "";
        $this->juzcalculator_income_id->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // juzcalculator_income_id
        $this->juzcalculator_income_id->setupEditAttributes();
        $this->juzcalculator_income_id->EditCustomAttributes = "";
        $this->juzcalculator_income_id->EditValue = $this->juzcalculator_income_id->CurrentValue;
        $this->juzcalculator_income_id->ViewCustomAttributes = "";
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        $key .= $rs['juzcalculator_income_id'];
    ...
    public function writeAuditTrailOnEdit(&$rsold, &$rsnew)
    {
        ...
        $key .= $rsold['juzcalculator_income_id'];
