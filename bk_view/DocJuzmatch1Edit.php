...
<div class="row <?=$class_hs_btn?>"><!-- buttons .row -->
    ...
    <a class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" onclick="postdoc(1,<?=$Page->id->CurrentValue?>)" type="button">ส่งไป Creden eSign</a>
    </div><!-- /buttons offset -->
    </div><!-- /buttons .row -->
...
<a class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" onclick="canceldoc(1,<?=$Page->id->CurrentValue?>)">ยกเลิกเอกสารนี้</a>
    </div><!-- /buttons offset -->
</div>
<?php
}
