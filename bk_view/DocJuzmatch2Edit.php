...
<input type="hidden" name="fa_x_file_loan" id= "fa_x_file_loan" value="<?= (Post("fa_x_file_loan") == "0") ? "0" : "1" ?>">
...
<div class="row <?=$class_hs_btn?>"><!-- buttons .row -->
    ...
    <a class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" onclick="postdoc(2,<?=$Page->id->CurrentValue?>)" type="button">ส่งไป Creden eSign</a>
    </div><!-- /buttons offset -->
    </div><!-- /buttons .row -->
...
<a class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" onclick="canceldoc(2,<?=$Page->id->CurrentValue?>)">ยกเลิกเอกสารนี้</a>
    </div><!-- /buttons offset -->
</div>
<?php
}
