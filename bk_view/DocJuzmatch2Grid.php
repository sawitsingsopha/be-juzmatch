...
<?php } ?>
<?php if ($Grid->file_loan->Visible) { // file_loan ?>
        <th data-name="file_loan" class="<?= $Grid->file_loan->headerCellClass() ?>"><div id="elh_doc_juzmatch2_file_loan" class="doc_juzmatch2_file_loan"><?= $Grid->renderFieldHeader($Grid->file_loan) ?></div></th>
<?php } ?>
...
<?php } ?>
    ...
    <?php } ?>
    <?php if ($Grid->file_loan->Visible) { // file_loan ?>
        <td data-name="file_loan"<?= $Grid->file_loan->cellAttributes() ?>>
<?php if ($Grid->RowAction == "insert") { // Add record ?>
<?php if (!$Grid->isConfirm()) { ?>
<span id="el<?= $Grid->RowCount ?>_doc_juzmatch2_file_loan" class="el_doc_juzmatch2_file_loan">
<div id="fd_x<?= $Grid->RowIndex ?>_file_loan" class="fileinput-button ew-file-drop-zone">
    <input type="file" class="form-control ew-file-input" title="<?= $Grid->file_loan->title() ?>" data-table="doc_juzmatch2" data-field="x_file_loan" name="x<?= $Grid->RowIndex ?>_file_loan" id="x<?= $Grid->RowIndex ?>_file_loan" lang="<?= CurrentLanguageID() ?>"<?= $Grid->file_loan->editAttributes() ?><?= ($Grid->file_loan->ReadOnly || $Grid->file_loan->Disabled) ? " disabled" : "" ?>>
    <div class="text-muted ew-file-text"><?= $Language->phrase("ChooseFile") ?></div>
</div>
<div class="invalid-feedback"><?= $Grid->file_loan->getErrorMessage() ?></div>
<input type="hidden" name="fn_x<?= $Grid->RowIndex ?>_file_loan" id= "fn_x<?= $Grid->RowIndex ?>_file_loan" value="<?= $Grid->file_loan->Upload->FileName ?>">
<input type="hidden" name="fa_x<?= $Grid->RowIndex ?>_file_loan" id= "fa_x<?= $Grid->RowIndex ?>_file_loan" value="0">
<input type="hidden" name="fs_x<?= $Grid->RowIndex ?>_file_loan" id= "fs_x<?= $Grid->RowIndex ?>_file_loan" value="250">
<input type="hidden" name="fx_x<?= $Grid->RowIndex ?>_file_loan" id= "fx_x<?= $Grid->RowIndex ?>_file_loan" value="<?= $Grid->file_loan->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x<?= $Grid->RowIndex ?>_file_loan" id= "fm_x<?= $Grid->RowIndex ?>_file_loan" value="<?= $Grid->file_loan->UploadMaxFileSize ?>">
<table id="ft_x<?= $Grid->RowIndex ?>_file_loan" class="table table-sm float-start ew-upload-table"><tbody class="files"></tbody></table>
</span>
<?php } else { ?>
<span id="el<?= $Grid->RowCount ?>_doc_juzmatch2_file_loan" class="el_doc_juzmatch2_file_loan">
<div id="fd_x<?= $Grid->RowIndex ?>_file_loan">
    <input type="file" class="form-control ew-file-input d-none" title="<?= $Grid->file_loan->title() ?>" data-table="doc_juzmatch2" data-field="x_file_loan" name="x<?= $Grid->RowIndex ?>_file_loan" id="x<?= $Grid->RowIndex ?>_file_loan" lang="<?= CurrentLanguageID() ?>"<?= $Grid->file_loan->editAttributes() ?>>
</div>
<div class="invalid-feedback"><?= $Grid->file_loan->getErrorMessage() ?></div>
<input type="hidden" name="fn_x<?= $Grid->RowIndex ?>_file_loan" id= "fn_x<?= $Grid->RowIndex ?>_file_loan" value="<?= $Grid->file_loan->Upload->FileName ?>">
<input type="hidden" name="fa_x<?= $Grid->RowIndex ?>_file_loan" id= "fa_x<?= $Grid->RowIndex ?>_file_loan" value="0">
...
<?php } ?>
<input type="hidden" data-table="doc_juzmatch2" data-field="x_file_loan" data-hidden="1" name="o<?= $Grid->RowIndex ?>_file_loan" id="o<?= $Grid->RowIndex ?>_file_loan" value="<?= HtmlEncode($Grid->file_loan->OldValue) ?>">
<?php } elseif ($Grid->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?= $Grid->RowCount ?>_doc_juzmatch2_file_loan" class="el_doc_juzmatch2_file_loan">
<span<?= $Grid->file_loan->viewAttributes() ?>>
<?= GetFileViewTag($Grid->file_loan, $Grid->file_loan->getViewValue(), false) ?>
</span>
</span>
...
<div class="invalid-feedback"><?= $Grid->file_loan->getErrorMessage() ?></div>
<input type="hidden" name="fn_x<?= $Grid->RowIndex ?>_file_loan" id= "fn_x<?= $Grid->RowIndex ?>_file_loan" value="<?= $Grid->file_loan->Upload->FileName ?>">
<input type="hidden" name="fa_x<?= $Grid->RowIndex ?>_file_loan" id= "fa_x<?= $Grid->RowIndex ?>_file_loan" value="<?= (Post("fa_x<?= $Grid->RowIndex ?>_file_loan") == "0") ? "0" : "1" ?>">
<input type="hidden" name="fs_x<?= $Grid->RowIndex ?>_file_loan" id= "fs_x<?= $Grid->RowIndex ?>_file_loan" value="250">
<input type="hidden" name="fx_x<?= $Grid->RowIndex ?>_file_loan" id= "fx_x<?= $Grid->RowIndex ?>_file_loan" value="<?= $Grid->file_loan->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x<?= $Grid->RowIndex ?>_file_loan" id= "fm_x<?= $Grid->RowIndex ?>_file_loan" value="<?= $Grid->file_loan->UploadMaxFileSize ?>">
<table id="ft_x<?= $Grid->RowIndex ?>_file_loan" class="table table-sm float-start ew-upload-table"><tbody class="files"></tbody></table>
...
<input type="hidden" data-table="doc_juzmatch2" data-field="x_company_seal_email" data-hidden="1" name="o<?= $Grid->RowIndex ?>_company_seal_email" id="o<?= $Grid->RowIndex ?>_company_seal_email" value="<?= HtmlEncode($Grid->company_seal_email->OldValue) ?>">
    ...
    <?php } ?>
    <?php if ($Grid->file_loan->Visible) { // file_loan ?>
        <td data-name="file_loan">
<?php if (!$Grid->isConfirm()) { ?>
<span id="el$rowindex$_doc_juzmatch2_file_loan" class="el_doc_juzmatch2_file_loan">
<div id="fd_x<?= $Grid->RowIndex ?>_file_loan" class="fileinput-button ew-file-drop-zone">
    <input type="file" class="form-control ew-file-input" title="<?= $Grid->file_loan->title() ?>" data-table="doc_juzmatch2" data-field="x_file_loan" name="x<?= $Grid->RowIndex ?>_file_loan" id="x<?= $Grid->RowIndex ?>_file_loan" lang="<?= CurrentLanguageID() ?>"<?= $Grid->file_loan->editAttributes() ?><?= ($Grid->file_loan->ReadOnly || $Grid->file_loan->Disabled) ? " disabled" : "" ?>>
    <div class="text-muted ew-file-text"><?= $Language->phrase("ChooseFile") ?></div>
</div>
