...
<?php if ($Page->file_loan->Visible) { // file_loan ?>
    <?php if ($Page->SortUrl($Page->file_loan) == "") { ?>
        <th class="<?= $Page->file_loan->headerCellClass() ?>"><?= $Page->file_loan->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->file_loan->headerCellClass() ?>"><div role="button" data-sort="<?= HtmlEncode($Page->file_loan->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->file_loan->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->file_loan->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->file_loan->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
...
<?php if ($Page->file_loan->Visible) { // file_loan ?>
        <!-- file_loan -->
        <td<?= $Page->file_loan->cellAttributes() ?>>
